...
{       
	   ...
	   // redirect to main page after login
		...
		if($_SESSION['usrId']==4 || $_SESSION['usrId']==5)
			$redirection_page='allReport.php';
		elseif($_SESSION['usrId']==6)
			$redirection_page='allCalllog.php';
		elseif($_SESSION['usrId']==7)
			$redirection_page='uploadWhitelist.php'; 
		else 
			$redirection_page="selectservice.php?usrId=".$row['id'];
