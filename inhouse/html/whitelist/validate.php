...
{       
        ...
        $updLastLogin = mysql_query("update master_db.ivr_web_user_master set last_login='$thisTime' where id='$row[id]'");
        mysql_close($dbConn);
		// redirect to main page after login
		$redirection_page='whitelistinterface.php?usrId='.$row['id'];
