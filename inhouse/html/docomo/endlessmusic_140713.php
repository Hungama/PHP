...
$arraywhitelist=array(9042545391,8446023664,9873710296,8109332603,8976730731,919042545391,918446023664,919873710296,918109332603,918976730731,918125850940,8125850940);

if($mode=='USSD' && in_array($msisdn,$arraywhitelist))
{
...
$transId=date('YmdHis');
$url="http://182.156.191.80:80911/API/CCG?MSISDN=$msisdn&productID=GSMENDLESSDAILY2&pName=Endlessmusic&reqMode=USSD&reqType=SUBSCRIPTION&ismID=16&transID=$transId&pPrice=200&pVal=2&CpId=hug&CpName=Hungama&CpPwd=hug@8910";
