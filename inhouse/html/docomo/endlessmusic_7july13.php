...
//8976730731
/********************USSD test start**********************/ 
if($mode=='USSD' && ($msisdn=='8109332603' || $msisdn=='918109332603' || $msisdn=='9873710296' || $msisdn=='918976730731' || $msisdn=='8976730731'))
{
...
//$url="http://182.156.191.79:8091/API/CCG?MSISDN=$msisdn&productID=GSMREDFM10&pName=Endless music&reqMode=USSD&reqType=SUBSCRIPTION&ismID=16&transID=$transId&pPrice=1000&pVal=10&CpId=hug&CpName=Hungama&CpPwd=hug@8910";
...
//header('Location: http://182.156.191.80:8091/API/CCG?MSISDN=8109332603&productID=GSMENDLESSDAILY2&pName=Endlessmusic&reqMode=USSD&reqType=SUBSCRIPTION&ismID=16&transID=20130628153710&pPrice=200&pVal=2&CpId=hug&CpName=Hungama&CpPwd=hug@8910');
?>
<!--script>
	...
	else
	{
		switch($servicename)
		{
			...
			case 'docomo_devia': 
				...
				$s_id='1027';
				$dbname="docomo_hungama";
				$subscriptionTable="tbl_dev_subscription";
				$subscriptionProcedure="DEV_SUB";
				$unSubscriptionProcedure="DEV_UNSUB";
				$unSubscriptionTable="tbl_dev_unsub";
				$lang='07';
				$operator = "TATM";
				break;
			case 'docomo_mnd': 
			...
			case 'docomo_bpl': 
				...
				$s_id='1002';
				$dbname="docomo_bpl";
				$subscriptionTable="tbl_bpl_subscription";
				$subscriptionProcedure="BPL_SUB";
				$unSubscriptionProcedure="BPL_UNSUB";
				$unSubscriptionTable="tbl_bpl_unsub";
				$lang='07';
				$operator = "TATM";
				break;
