...
if (!is_numeric("$planid"))
{
	...
	fwrite($file,$msisdn . "#" . $mode . "#" . $reqtype . "#" . $planid . "#" . $subchannel . "#" . date('H:i:s') . "#" . $rcode."#".$url . "\r\n" );
	fclose($file);
	exit;
}
...
$msisdn=checkmsisdn(trim($msisdn),$abc);
	...
	else
	{
		...
		if($reqtype == 1)
		{
			...
			fwrite($file1,$msisdn . "#" . $mode ."#".$aftId."#".$reqtype."#".$planid."#".$lang."#".$s_id."#".$subchannel."#Vcode:".$vcode."#MM:".$mm."#songC:". $songCode."#" . date('H:i:s') . "#" . $rcode."#".$url . "\r\n" );
			fclose($file1);
			...
			if($result == 0)
			{
				...
				$log_file_path="logs/docomo/subscription/".$servicename."/subscription_".$curdate.".txt";
				$file=fopen($log_file_path,"a");
				fwrite($file,$msisdn."#".$mode."#".$aftId."#".$reqtype."#".$planid."#".$lang."#".$subchannel."#Vcode:".$vcode."#MM:".$mm."#songC:".$songCode."#". $insertOBDQuery."#Conn:".$con."#". date('H:i:s')."#".$rcode."#".$url. "\r\n" );
			...
			if($result == 1)
			{
				...
				$log_file_path="logs/docomo/subscription/".$servicename."/subscription_".$curdate.".txt";
				$file=fopen($log_file_path,"a");
				fwrite($file,$msisdn . "#" . $mode . "#" .$aftId."#". $reqtype ."#".$planid."#".$lang. "#" . $subchannel."#Vcode:".$vcode."#MM:".$mm."#songC:".$songCode . "#" . date('H:i:s') . "#" . $rcode."#".$url . "\r\n" );
				fclose($file);
				mysql_close($con);
				exit;
			}
			if($result == 2)
			{
				...
				$log_file_path="logs/docomo/subscription/".$servicename."/subscription_".$curdate.".txt";
				$file=fopen($log_file_path,"a");
				fwrite($file,$msisdn . "#" . $mode . "#" .$aftId."#". $reqtype ."#".$planid."#".$lang. "#" . $subchannel."#Vcode:".$vcode."#MM:".$mm."#songC:".$songCode ."#".$insertOBDQuery. "#" . date('H:i:s') . "#" . $rcode."#".$url . "\r\n" );
				fclose($file);
				mysql_close($con);
				exit;
			}
		...
		if($reqtype == 2)
		{
			...
			$file1=fopen($log_file_path1,"a+");
			fwrite($file1,$msisdn . "#" . $mode . "#" .$aftId."#". $reqtype ."#".$planid."#".$lang."#".$subchannel."#Vcode:".$vcode."#MM:".$mm."#songC:".$songCode . "#" . date('H:i:s') . "#" . $rcode."#".$url . "\r\n" );
			fclose($file1);
			/*echo "100";
			exit;*/
		...
		if($reqtype == 3)
		{
			...
			if($result == 0)
			{
				...
				if($s_id == '1001') {
					...
					fwrite($file,$msisdn."#".$mode."#".$aftId."#".$reqtype."#".$planid."#".$lang."#".$subchannel."#Conn:".$con."#". date('H:i:s')."#".$rcode."#".$url. "\r\n" );
				}
				fclose($file); 
				mysql_close($con);
				exit;
			...
			if($result == 1)
			{
				...
				if($s_id == '1001') {
					...
					fwrite($file,$msisdn . "#" . $mode . "#" .$aftId."#". $reqtype ."#".$planid."#".$lang. "#" . $subchannel."#" . date('H:i:s') . "#" . $rcode."#".$url . "\r\n" );
				}
				fclose($file);
				mysql_close($con);
				exit;
