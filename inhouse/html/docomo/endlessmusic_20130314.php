...
$msisdn=checkmsisdn(trim($msisdn),$abc);
	...
	else
	{
		...
		if($reqtype == 2)
		{
			...
			$file1=fopen($log_file_path1,"a+");
			fwrite($file1,$msisdn . "#" . $mode . "#" .$aftId."#". $reqtype . "#" . $planid . "#" . $subchannel."#Vcode:".$vcode."#MM:".$mm."#songC:".$songCode . "#" . date('H:i:s') . "#" . $rcode . "\r\n" );
			fclose($file1);
			/*echo "100";
			exit;*/
		...
		if($reqtype == 3)
		{
			...
			if($result == 0)
			{
				...
				if($s_id == '1001') {
					...
					fwrite($file,$msisdn."#".$mode."#".$aftId."#".$reqtype."#".$planid."#".$subchannel."#Conn:".$con."#". date('H:i:s')."#".$rcode. "\r\n" );
				}
				fclose($file); 
				mysql_close($con);
				exit;
			...
			if($result == 1)
			{
				...
				if($s_id == '1001') {
					...
					fwrite($file,$msisdn . "#" . $mode . "#" .$aftId."#". $reqtype . "#" . $planid . "#" . $subchannel."#" . date('H:i:s') . "#" . $rcode . "\r\n" );
				}
				fclose($file);
				mysql_close($con);
				exit;
