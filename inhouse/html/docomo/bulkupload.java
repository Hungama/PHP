...
public class bulkupload extends Thread {
	...
	public	String DSN="docomo_radio";
	public	String USR="weburl";
	public	String PWD="weburl";
	public	String IP="119.82.69.210";
...
//===================================================================
	public void run()
	{
		try
		  ...
		  String selectFile="select file_name, added_on, service_type, channel, price_point, upload_for,batch_id,service_id from docomo_radio.bulk_upload_history where status=0 and service_id in(1202,1203,1208) order by added_on desc";
			...
			try
				{
						...
						if(fileStatus==0)
						{
							String update_bulk_history="update docomo_radio.bulk_upload_history set status=1 where batch_id="+BatchId+" and service_id="+ServiceId;
						...
						{
							case 1001:
								SubsProcedureName="Docomo_radio.RADIO_SUB";
								Lang="99";
								Dnis="59090";
								SubscriptionTable="Docomo_radio.tbl_radio_subscription";
								UnubscriptionTable="Docomo_radio.tbl_radio_unsub";
								UnSubscriptionProcedure="Docomo_radio.RADIO_UNSUB";
								break;
							case 1202:
								SubsProcedureName="reliance_hungama.JBOX_SUB";
								Lang="01";
								Dnis="54646";
								SubscriptionTable="reliance_hungama.tbl_jbox_subscription";
								UnSubscriptionProcedure="reliance_hungama.JBOX_UNSUB";
								UnubscriptionTable="reliance_hungama.tbl_jbox_unsub";
							break;
							case 1203:
								SubsProcedureName="reliance_hungama.MTV_SUB";
								Lang="01";
								Dnis="54646";
							...
							break;
							case 1208:
								SubsProcedureName="reliance_cricket.CRICKET_SUB";
								Lang="01";
								Dnis="54433";
												...
												if(cnt.equalsIgnoreCase("0"))
												{
													...
													if(rs1 .next())
													{
														...
														try
														{
															...
															String call="call "+SubsProcedureName+" ('"+strLine+"','"+Lang+"','bulk','"+Dnis+"','"+Amount+"',"+ServiceId+","+PricePoint+")" ;
															System.out.println(call);
															CallableStatement stmtcall = con.prepareCall(call);
															stmtcall.execute();
															System.out.println("100");
