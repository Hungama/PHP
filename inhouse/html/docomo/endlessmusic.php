...
if (isset($_REQUEST['CCGID'])) {
    $CCGID = $_REQUEST['CCGID'];
	} else {
    $CCGID = $_REQUEST['TPCGID'];
}


/********************USSD test start**********************/ 
//if($mode=='USSD' && ($msisdn=='8109332603' || $msisdn=='918109332603' || $msisdn=='9873710296' || $msisdn=='918976730731' || $msisdn=='8976730731' || $msisdn=='8125850940' || $msisdn=='918125850940'))
if($mode=='USSD')
{
$logDir="/var/www/html/docomo/logs/docomo/dc/";
$logFile_dump="ccgdump_ussd_".date('Ymd');
...
$url="http://182.156.191.80:8091/API/CCG?MSISDN=91$msisdn&productID=$productID&pName=ENDLESSMUSIC&reqMode=USSD&reqType=SUBSCRIPTION&ismID=16&transID=$transId&pPrice=$pPrice&pVal=$pVal&CpId=hug&CpName=Hungama&CpPwd=hug@8910";
$logurl="Response:100#url#".$url."#".$call."#".date("Y-m-d H:i:s")."\n";
