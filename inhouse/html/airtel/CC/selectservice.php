...
if($_SESSION['usrId'])
{
	...
	$query = mysql_query($get_service_name, $dbConnAirtel);
	include_once("main_header.php");
        
	$action_page='main.php';
        $user_id_array = array('96','102','105','106','107','109','110','111');
       
       // if($_SESSION[usrId]==96 || $_SESSION[usrId]==102 ){
         if(in_array($_SESSION[usrId],$user_id_array)){
            $action_page='main_tc.php';
        }
        else{
            echo "<center>You are not authorised</center>";
            exit;
        }
	$flag=0;
?>
