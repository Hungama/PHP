...
if(isset($_SESSION['authid']))
{
	//include("config/dbConnect.php");
          include_once("/var/www/html/kmis/services/hungamacare/config/dbConnectAirtel.php");
		   $user_id_array = array('96','97','98','99','100','101','109','110');
      
 if(in_array($_SESSION[usrId],$user_id_array))
        {
		if($_SESSION[usrId]== 110)       
		 header("location:bulk_upload_tc.php?service_info=1522") ;
		 else
		 header("location:bulk_upload_tc.php?service_info=1501") ;
          exit;
        }
        else if ($_SESSION[usrId] == 102 || $_SESSION[usrId] == 105 || $_SESSION[usrId] == 106) {
        header("location:bulk_upload_tc.php?service_info=1517") ;
        exit;
    }
