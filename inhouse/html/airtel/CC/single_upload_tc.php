...
//    $log_path = "/var/www/html/kmis/services/hungamacare/log/tc_log/log_" . date('dmy') . ".log";
    $log_path = "/var/www/html/airtel/CC/logs/SingleUploadLog/log_" . date('dmy') . ".log";

		$service_info=trim($_REQUEST['service_info']);
	if($service_info==15222 || $service_info==1522)
	{
	$service_info_tmp=1522;
	}
	else
	{
	$service_info_tmp=$service_info;
	}
    ...
    <html>
        ...
        <body leftmargin="0" topmargin="0" link="#000000" alink="#000000" bgcolor="#ffffff" text="#000000" marginheight="0" marginwidth="0" vlink="#000000">
                ...
                <TABLE width="30%" align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1" class="txt">
                    <TBODY>
                        ...
                        <TR height="30" id='price12'>
                            ...
                            <TD bgcolor="#FFFFFF">&nbsp;&nbsp;	 
                                <INPUT name="serviceid" id="serviceid" type="hidden"  value="<?php echo $service_info_tmp; ?>">
                        ...
                        <TR height="30">
                            ...
                            <TD bgcolor="#FFFFFF">&nbsp;&nbsp;
                                ...
                                <?php } else if ($_REQUEST['service_info'] == 1515) { ?>
                                    <b>Airtel SARNAM </b>
                                <?php }
									else if ($_REQUEST['service_info'] == 1522 || $_REQUEST['service_info']==15222) {?>
                                            <b>Airtel Manoranjana pack</b>
                                     <?php   } 
									 else { ?>
                                    <b>Airtel SE </b>
                                <?php } ?>
                        ...
                        <TR height="30" id='price12'>
							...
							<?php 
							$get_plan_info = "select plan_id,iamount,iValidty from master_db.tbl_plan_bank where sname=" . $service_info_tmp;
							 ?>
                            <TD bgcolor="#FFFFFF">&nbsp;&nbsp;<select name="price" id='price' class="in" id="price">
                                    ...
                                    $plan_result_query = mysql_query($get_plan_info, $dbConnAirtel);
                                    while ($plan_record = mysql_fetch_array($plan_result_query)) {
                                        if ($plan_record[1] >= 60 || $plan_record[0]==63) {
            ...
            if ($_POST['Submit'] == "Submit" && $_POST['msisdn'] != "") {
                ...
                $url = "http://10.2.73.156/airtel/airtel.php?msisdn=" . $_POST['msisdn'] . "&mode=telecalling&reqtype=1&planid=" . $_POST['price'] . "&subchannel=telecalling&rcode=100,101,102&serviceid=" . $_POST['serviceid'];
                ...
                if ($data == '100') {
                    echo "<center>Request for " . $_POST['msisdn'] . " Accepted Successfully .  An SMS to user will be sent for his/her confirmation for service subscription</center> ";
                }else if ($data == '102') {
