...
//        $logPath = "/var/www/html/kmis/services/hungamacare/ccInterface/log_" . date("Ymd") . ".txt";
         $logPath = "/var/www/html/airtel/CC/logs/MainLog/log_" . date("Ymd") . ".txt";
        ...
        elseif ($_POST['service_info'] == 15071)
            $service_info = 1507;
        elseif ($_POST['service_info'] == 15221)
            $service_info = 1522;
        ...
        $logData = $_POST['msisdn'] . "#" . $_POST['service_info'] . "#" . $logServiceName  . "#" . date('his') . "\n";
        error_log($logData, 3, $logPath);

        $q = "select plan_id from master_db.tbl_plan_bank where S_id='" . $service_info . "' and sname='" . $_REQUEST['service_info'] . "'";
        ...
        if($mRecord[0]!='')
            echo "<center>Already Subscribe to Entertainment Unlimited</center>";
        else 
            echo "<center>Not Subscribe to Entertainment Unlimited</center>";
        exit;
        ...
        $query = mysql_query($mainQuery, $dbConnAirtel) or die(mysql_error());
            ...
            ?></TD>
                        ...
                        <center>
                            ...
                            <center><br/>
                                    ...
                                    $queryunSubscription = mysql_query($deactivationQuery1, $dbConnAirtel) or die(mysql_error());
                    ...
                    echo $SUB_TYPE;
                            ...
                            ?></TD>
                                            ...
                                            elseif ($_GET['service_info'] == 1522 || $_GET['service_info'] == 15221)
