  ...
  width: 15%
    ...
    <?php } ?>
        ...
        echo "selected";
                                        ...
                                        <td colspan="12"><strong>Select Date &nbsp;&nbsp;&nbsp;</strong>
...
//if(0)
        ?>
                                ...
                                <tr>
                                    ...
                                    <th colspan="10">Call Sec Used</th>
                                ...
                                <tr>
                                    ...
                                    <td colspan="10"><?php echo $status['CallMinuteUsed']; ?></td>
    ...
    if ($totalrecord > 0) {
        ?>
                                    <tr><th colspan="13">Total no of <?= $totalrecord; ?> records found of date <?= $displaydate; ?>.</th></tr>
                                    <tr>
