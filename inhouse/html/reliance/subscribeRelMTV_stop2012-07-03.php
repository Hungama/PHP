...
if ($msisdn == "") {
	...
	$renewDate = date("Y-m-d H:i:s",mktime(0,0,0,date("m"),date("d")+30,date("Y")));
	if($rows1[0] <=0) {
		$insertMTVrel = "INSERT INTO ".$subscriptionTable." (ANI,SUB_DATE,RENEW_DATE,DEF_LANG,STATUS,MODE_OF_SUB,DNIS,circle,plan_id,USER_BAL,SUB_TYPE) VALUES ('".$msisdn."','".$currDateTime."','".$renewDate."','".$lang."','5', '".$mode."','".$sc."','".$circleValue."','".$planid."','".$row1."', '".$mode."')";
