...
else
{
	...
	if($reqtype == 1)
	{
		...
		if($rows1[0] <=0)
		{
			if($planid=='63' || $planid=='64' || $planid=='65')
			{
				$qry="call reliance_starclub.JBOX_PURCHASE_CELEBRITY_TICKET('".$msisdn."','".$langValue."','".$mode."','".$sc."','".$amount."','1',".$s_id.",".$planid.")";
			}
			else
			 $qry="call ". $subscriptionProcedure." ('".$msisdn."','".$langValue."','".$mode."','".$sc."','".$amount."',".$s_id.",".$planid.")";
