...
//Call Patch data
//TotalFreeTimeConsumed (Sum of Total minutes consumed till the same date) 
$freeTimeConsumed=mysql_query("select sum(duration) from hul_hungama.tbl_GLC_CallPatch_transaction",$con);
list($TotalFreeTimeConsumed) = mysql_fetch_array($freeTimeConsumed);

//MaximumFreecallTimeused (Maximum Free Call Time Used )
$maxFreeTimeConsumed=mysql_query("select max(duration) from hul_hungama.tbl_GLC_CallPatch_transaction",$con);
list($MaximumFreecallTimeused) = mysql_fetch_array($maxFreeTimeConsumed);
 
//TotalUUFreeCall (Unique callers who made call patch till date )
$TotalUUFreeCallQuery=mysql_query("select count(distinct ANI) from hul_hungama.tbl_GLC_CallPatch_transaction",$con);
list($TotalUUFreeCall) = mysql_fetch_array($TotalUUFreeCallQuery);
?>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="centerContent">
                                <div dir="ltr" class="circle-stats">
                                 ...
                                 <div class="circular-item tipB" title="Most heard category mous <?php echo $textmsg." ( Total Count- ".$counter.")";?>">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="sparkStats">
                                ...
                                <ul class="list-unstyled">
								  ...
								  <li><span class=""></span>Total Free Time Consumed : <span class="number"><?php echo number_format($TotalFreeTimeConsumed); ?></span></li>
								  <li><span class=""></span>Maximum Free Call Time Used : <span class="number"><?php echo number_format($MaximumFreecallTimeused); ?></span></li>
								  <li><span class=""></span>Total unique users of Free Call Service : <span class="number"><?php echo number_format($TotalUUFreeCall); ?></span></li>
