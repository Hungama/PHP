...
from hul_hungama.tbl_hul_pushobd_sub nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!=''",$con);
$totalUniqueVisit=0;
...
$getalldistinctDate=mysql_query("select distinct(date(date_time)) as disdate from hul_hungama.tbl_hul_pushobd_sub nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!=''",$con);
$p1=0;
...
from hul_hungama.tbl_hul_pushobd_sub nolock  where date(date_time)='".$dataNewVisitDate['disdate']."' and ANI!=''",$con);
$totalUniqueVisit1=0;
