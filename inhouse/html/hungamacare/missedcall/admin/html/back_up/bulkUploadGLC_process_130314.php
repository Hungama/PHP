...
//capsuleid
echo $sql_obdinfo = "INSERT INTO master_db.tbl_GLCBulkobdHistory (uploadedby,ipaddress,odb_filename,filesize,servicetype,capsuleid)
...
//start rewrite file here for data inload process
    $status = 0;
    $lines = file('bulkupload/' . $createobdfilename);
...
//open file to rewrite
    ...
    $newfile = '/var/www/html/hungamacare/missedcall/admin/html/newfile/' . $createobdfilename;
