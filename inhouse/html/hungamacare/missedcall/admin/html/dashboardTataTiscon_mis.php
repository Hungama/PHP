...
require_once("alldataTataTiscon_mis.php");
...
$getDashbordChart_missedCallHourWise="select sum(Value) as total, type as hour
from $mistable nolock  
where date between '".$StartDate."' and '".$EndDate."' and type like 'Missedcalls%' and service='".$service."'
group by hour(date),type order by hour(date) ASC";

$query_missedCallHourWiseChart = mysql_query($getDashbordChart_missedCallHourWise,$con_218);
...
$getHour=explode('_',$data_missedCallHourWise['hour']);
$hour=$getHour[1];
       ...
       <!--Body content-->
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
              ...
              <!--h3>Dashboard</h3--> 
<div class="col-lg-8">					
<form id="rangepicker" action="dashboardTataTiscon_mis.php" method="post">					
