...
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$counter, '0');
...
$objPHPExcel->getActiveSheet()->SetCellValue('R'.$counter, $data_rows['TotalUniqueOBDs']);
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$counter, '0');
