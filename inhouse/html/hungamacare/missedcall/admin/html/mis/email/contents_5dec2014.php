...
$objPHPExcel->getActiveSheet()->SetCellValue('G'.$counter, $mydata['TotalUniqueOBDs']);
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$counter, $mydata['TotalMinutesConsumed']);
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$counter, $mydata['AverageDuration_OBD']);
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$counter, $mydata['PeakCallingHour']);
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$counter, $mydata['Hindi']);
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$counter, $mydata['Bengali']);
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$counter, $mydata['Tamil']);
$objPHPExcel->getActiveSheet()->SetCellValue('N'.$counter, $mydata['NotSel']);
//mitr code
...
$objPHPExcel->getActiveSheet()->SetCellValue('W'.$counter, $data_rows['NotSel']);
}
$counter++;
}  
