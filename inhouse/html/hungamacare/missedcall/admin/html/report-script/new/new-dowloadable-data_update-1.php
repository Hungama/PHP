...
from Hungama_ENT_MCDOWELL.tbl_mcdowell_pushobd_liveapp where ANI!='' and service='MCW_LIVEAPP' 
and date(date_time) between '2015-01-20' and '2015-01-21' group by circle";
...
where date(date_time)between '2015-01-20' and '2015-01-21' group by circle";
...
date(last_dedicated_date_time) between '2015-01-20' and '2015-01-21'   group by circle "; 
