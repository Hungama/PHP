...
// get missed call_ func  T_M_C_B
 /* $query="select sum(Value) as value,circle from misdata.dailymis nolock  where date between 
'$date' and '$date1' and service='EnterpriseMcDwOBD'
...
values('$date1' ,'$service','$circle','$type','$totalCall','')";
...
//total number of dedication T_N_D
 ...
 where date(date_time) between '2015-01-27' and '2015-01-27' group by circle";
...
$type = 'T_N_D';
$insert_data = "insert into Hungama_Tatasky.tbl_dailymis_downloadable(Date,Service,Circle,Type,Value,Revenue)
values('2015-01-26' ,'$service','$circle','$type','$totalCall','')";
$queryIns = mysql_query($insert_data, $con);
}
} 
