...
/*  $query="select 'CALLS_TF' as type,count(1) as value,circle,date(date_time) as date
from Hungama_ENT_MCDOWELL.tbl_mcdowell_pushobd_liveapp_Bkp where ANI!='' and service='MCW_LIVEAPP' 
and date(date_time) between '2014-07-07' and '2015-01-14' group by circle";
...
// get unique missed call func T_Q_S
 $query="select 'UU_TF' as type,count(distinct(ANI)) as value,circle,date(date_time) as date
from Hungama_ENT_MCDOWELL.tbl_mcdowell_pushobd_liveapp_Bkp where ANI!='' and service='MCW_LIVEAPP' 
and date(date_time) between '2014-07-07' and '2015-01-14' group by circle";
...
$type = 'T_Q_S';
$insert_data = "insert into Hungama_Tatasky.tbl_dailymis_downloadable(Date,Service,Circle,Type,Value,Revenue)
values('2015-01-14','$service','$circle','$type','$totalCall','')";
$queryIns = mysql_query($insert_data, $con);
}
} 
/*
...
$query="select count(ani)as value,circle from  Hungama_ENT_MCDOWELL.tbl_mcdowell_pushobd_liveapp_Bkp 
where date(date_time)between '2014-11-11' and '$date' group by circle";
...
$query="select count(ani)as value,circle from  Hungama_ENT_MCDOWELL.tbl_mcdowell_pushobd_SongDedicate_backup27Dec14
 where date(date_time) between '2014-11-12' and '2015-01-15' group by circle";
...
date(entrydate) between '2014-11-12' and '2015-11-21'  group by circle";
...
$type = 'T_N_S';
$insert_data = "insert into Hungama_Tatasky.tbl_dailymis_downloadable(Date,Service,Circle,Type,Value,Revenue)
values('2015-11-21' ,'$service','$circle','$type','$totalCall','')";
$queryIns = mysql_query($insert_data, $con);
}
} 
/*
