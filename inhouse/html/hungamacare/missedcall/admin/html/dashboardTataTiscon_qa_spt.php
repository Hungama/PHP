...
{
document.getElementById('ajaxspan').style.display='inline';
if(type==1)
{
                             ...
                             <ul class="bigBtnIcon">
								...
								<li>
                                    <a href="#" title="Average duration of listening" class="pattern tipB">
                                        ...
                                        <span class="notification"><?php echo $avgDuration;?></span>
                                    </a>
                                </li>
                                <li>
...
<div class="row">
 ...
 <option value="0">Please Select Chart Type</option>
  ...
  <span id="ajaxspan" style="display:none"><img src="ajax-loader.gif"/></span>
</div>
 </div>
</div>
                <div class="row">
