...
<?php echo $MAP_SET_NEW; ?>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" action="bulkUploadGLC_process.php" role="form" name="form-obd" id="form-obd" enctype="multipart/form-data" method="post" onSubmit="return checkfield()">   
    ...
    ================================================== -->
                ...
                <script type="text/javascript">
                    ...
                    //                });    
                    function checkfield() { 
                        var obd_form_mob_file=document.forms["form-obd"]["obd_form_mob_file"].value;
