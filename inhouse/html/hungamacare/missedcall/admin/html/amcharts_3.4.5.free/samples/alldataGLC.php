...
$getDashbord_TargettdOBD=mysql_query("select  distinct ANI from hul_hungama.tbl_hulobd_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and service='HUL'",$con);
...
$getDashbord_OBD=mysql_query("select count(ANI) from hul_hungama.tbl_hulobd_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and service='HUL_PROMOTION'",$con);
//$totalOBD_attended_Promotional=mysql_num_rows($getDashbord_OBD);
list($totalOBD_attended_Promotional) = mysql_fetch_array($getDashbord_OBD); 

$getDashbord_OBD_content=mysql_query("select count(ANI) from hul_hungama.tbl_hulobd_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and service='HUL'",$con);
//$totalOBD_attended_Content=mysql_num_rows($getDashbord_OBD_content);
...
$chartDateUnique=array();
$chartCountUnique=array();
$chartCountMissed=array();
...
$chartDateUnique[]=$datemonth;
$chartCountUnique[]=$total_missed_call;
$chartCountMissed[]=$total_unique_call;
