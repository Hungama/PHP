...
abstract class elFinderVolumeDriver {
	...
	protected $options = array(
		...
		// thumbnails size (px)
		'tmbSize'         => 48,
		// thumbnails crop (true - crop, false - scale image to fit img-thumbnail size)
		'tmbCrop'         => true,
	...
	/**
	 * Create img-thumbnail for required file and return its name of false on failed
	 *
	 * @return string|false
	 * @author Dmitry (dio) Levashov
	 **/
	...
	/**
	 * Return img-thumbnail file name for required file
	 *
	 * @param  array  $stat  file stat
	 * @return string
	 * @author Dmitry (dio) Levashov
	...
	protected function createTmb($path, $stat) {
    	...
    	/* If image smaller or equal img-thumbnail size - just fitting to img-thumbnail square */
    	if ($s[0] <= $tmbSize && $s[1]  <= $tmbSize) {
	    	...
	    	if ($this->options['tmbCrop']) {
        		...
        		/* Resize and crop if image bigger than img-thumbnail */
