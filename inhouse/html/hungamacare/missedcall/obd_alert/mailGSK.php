...
<html>
    ...
    <body>
      ...
      //  require '/var/www/html/hungamacare/missedcall/obd_alert/contents_GSK.php';
...
//Set the subject line
        $mail->Subject = ' Enterprise - GSK (Africa) - OBD Vs Missed Call Alert- ' . $prevdate;
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
        $htmlfilename = 'EnterpriseAfricaGSK_PAN.html';
