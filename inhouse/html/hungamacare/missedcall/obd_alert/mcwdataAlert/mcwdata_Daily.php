...
fwrite($fp,'Msisdn'.','.'Circle'.','.'Duration'.','.'ActualDuration'.','.'DateTime'.','.'Dial-DID'."\r\n");
  $getwinner_query="select ani,circle,duration,actual_duration,date_time,dial_did from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_promotion_details nolock where date(date_time)='".$PrevDate."' and status=2";
