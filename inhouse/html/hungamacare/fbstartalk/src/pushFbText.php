		...
		while($row = mysql_fetch_array($result)){
			...
			if ($daysLeft <= $day_b4event){
				if ($daysLeft>=$timeslot1){
					...
					// 					$text1=str_replace("<celeb>",$celebName,$text1);
					// 					$text1=str_replace("<operator>",$operator,$text1);
					// 					$text1=str_replace("<appname>",$fb_appname,$text1);
					// 					$text1=str_replace("<shortcode>",$shortcode,$text1);
					// 					$text1=str_replace("<date>",$eventEndDate,$text1);
					// 					$text1=str_replace("<time>",$eventEndTime,$text1);
					...
					// 					$text2=str_replace("<celeb>",$celebName,$text2);
					// 					$text2=str_replace("<operator>",$operator,$text2);
					// 					$text2=str_replace("<appname>",$fb_appname,$text2);
					// 					$text2=str_replace("<shortcode>",$shortcode,$text2);
					// 					$text2=str_replace("<date>",$eventEndDate,$text2);
					// 					$text2=str_replace("<day>",$daysLeft,$text2);
					// 					$text2=str_replace("<time>",$eventEndTime,$text2);

					// 					if ($daysLeft==1){
					// 						$text2=str_replace("days","day",$text2);
					// 					}
					...
					// 					$text3=str_replace("<celeb>",$celebName,$text3);
					// 					$text3=str_replace("<operator>",$operator,$text3);
					// 					$text3=str_replace("<appname>",$fb_appname,$text3);
					// 					$text3=str_replace("<shortcode>",$shortcode,$text3);
					// 					$text3=str_replace("<date>",$eventEndDate,$text3);
					// 					$text3=str_replace("<time>",$eventEndTime,$text3);
