...
from Hungama_ENT_MCDOWELL.tbl_mcdowell_pushobd_liveapp nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!='' and service='MCW_LIVEAPP' group by date(date_time) order by Month(date_time),day ASC";
