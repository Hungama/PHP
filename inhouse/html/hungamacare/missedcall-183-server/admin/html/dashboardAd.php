 ...
 */
 $getDashbordChart_data="select sum(totalcount) as totalcount,day(report_date) as day,Month(report_date) as month
from Inhouse_IVR.tbl_advertisment_Dashboard nolock  where date(report_date)
 between '".$StartDate."' and '".$EndDate."'  group by date(report_date) order by Month(report_date),day ASC";
...
//echo $day."#".$month."#".$total_missed_call
?>
...
$('#rangepickerA').daterangepicker(
  ...
  <div class="search">
		 ...
		 <div id="chartContainer" style="height: 300px;width:100%;margin-top:15px; margin-bottom:15px;">
		</div>
