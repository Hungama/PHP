...
$getDashbord_OBDPulse_content=mysql_query("select ceil(sum(duration)/30) as toalpulse from Hungama_Tatasky.tbl_tataobd_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!=''",$con);
list($totalOBD_attendedPulse_Content) = mysql_fetch_array($getDashbord_OBDPulse_content); 
//Total Pulse Consumed end here

/**************New Visists vs Returning Customers section start here stopped********************/
/*
...
/***************new logic for %of new visits starte here (Loading impact due to this snippts)************************/
/*
...
/***************new logic for %of new visits start here ************************/
/*
...
*/
/***************new logic for %of new visits end here ************************/
