...
$cond="duration<='".$sDur."' ";
//Hungama_ENT_MCDOWELL.tbl_mcdowell_pushobd_liveapp
...
*/
$getDashbord_OBDBounceRate=mysql_query("select count(*) as total,date(date_time) as OBDDate,(select count(*) from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_details 
where date(date_time)=OBDDate and service='MCW_LIVEAPP' and status=2 and duration<=5 group by date(date_time))as bounceANICount 
from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_details 
where date(date_time) between '".$StartDate."' and '".$EndDate."'  
and service='MCW_LIVEAPP' and status=2 group by date(date_time)");
...
$getDashbord_OBDStats=mysql_query("select ANI from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and service='MCW_LIVEAPP' and status=2 and $cond ",$con);
...
$getDashbord_TargettdOBD=mysql_query("select  distinct ANI from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and service='MCW_LIVEAPP' and status=2 and ANI!=''",$con);
...
$getDashbord_MaxMin=mysql_query("select ceil(max(duration)/60) as maxDuration from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and status=2 and service in ('MCW_LIVEAPP')",$con);
list($maxDuration1) = mysql_fetch_array($getDashbord_MaxMin); 
$maxDuration=$maxDuration1;

$getDashbord_OBD=mysql_query("select count(ANI) from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_details nolock where date(date_time) between '".$StartDate."' and '".$EndDate."' and service='MCW_PROMOTION' and status=2 and ANI!='' ",$con);
list($totalOBD_attended_Promotional) = mysql_fetch_array($getDashbord_OBD); 


$getDashbord_OBD_content=mysql_query("select ceil(sum(duration)/60) as toalsec from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and service='MCW_LIVEAPP' and status=2 and ANI!=''",$con);
...
from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock where date(date_time)=date(now()) and service='MCW_LIVEAPP' and ANI!=''",$con);
$totalnewvisist=mysql_num_rows($getDashbord_totalnewvisist);

$getDashbord_totalReturning=mysql_query("select  ANI,count(*) as total from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock where 
...
$getDashbord_data="select count(*) as total, count(distinct(ANI)) as total_unique from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock 
...
//New Visits
$getDailyVisits_data="select ANI from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock  where date(date_time)=date(now()) and ANI!='' and service='MCW_LIVEAPP' ";
...
$allnewvsuniquevisit=mysql_query("select distinct(ANI) as dani,(select count(1) from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp where ANI=dani) as total
from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!='' and service='MCW_LIVEAPP' ",$con);
$totalUniqueVisit=0;
...
$getalldistinctDate=mysql_query("select distinct(date(date_time)) as disdate from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!='' and service='MCW_LIVEAPP'",$con);
$p1=0;
while($dataNewVisitDate= mysql_fetch_array($getalldistinctDate))
{
$allnewvsuniquevisit1=mysql_query("select distinct(ANI) as dani,date(date_time) as dtime,(select count(1) from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp where ANI=dani  and date(date_time)<=dtime) as total
from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock  where date(date_time)='".$dataNewVisitDate['disdate']."' and ANI!='' and service='MCW_LIVEAPP' ",$con);
$totalUniqueVisit1=0;
...
$allnewvsuniquevisittoday=mysql_query("select distinct(ANI) as dani,(select count(1) from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp where ANI=dani) as total
from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock  where date(date_time)=date(now())  and ANI!='' and service='MCW_LIVEAPP'",$con);
...
from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!='' and service='MCW_LIVEAPP' group by ANI";
...
from Hungama_ENT_MCDOWELL_Test.tbl_mcdowell_pushobd_liveapp nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!='' and service='MCW_LIVEAPP' group by date(date_time) order by day(date_time) ASC";
...
from Hungama_ENT_MCDOWELL.tbl_mcdowell_success_fail_details nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and service='MCW_LIVEAPP' and status=2  group by circle order by circle";
