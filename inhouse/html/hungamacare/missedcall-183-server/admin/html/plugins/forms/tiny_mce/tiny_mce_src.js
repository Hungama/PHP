		...
		getPos : function(n, ro) {
			...
			if (n) {
				...
				if (n.getBoundingClientRect) {
					...
					// Add scroll offsets from documentElement or body since IE with the wrong panel model will use d.body and so do WebKit
...
tinymce.create('tinymce.ui.Toolbar:tinymce.ui.Container', {
	renderHTML : function() {
		...
		for (i=0; i<cl.length; i++) {
			// Get current control, prev control, next control and if the control is a list panel or not
			co = cl[i];
			pr = cl[i - 1];
			nx = cl[i + 1];
			...
			// Add toolbar end before list panel and after the previous button
			...
			// Add toolbar start after list panel and before the next button
			// This is to fix the o2k7 editor skins
			if (nx && co.ListBox) {
