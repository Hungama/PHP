...
from Inhouse_IVR.tbl_missedcall_smslist nolock  where cpgid='".$cpgid."' group by date(added_on)";
...
{
$day=$data['day'];
$chartMissedCallarray[$day]=$data['total'];
$chartUniqueCallarray[$day]=$data['total_unique'];
}
                            ...
                            <ul class="bigBtnIcon">
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="notification">1000</span>
                                    </a>
                                </li>
                                <!--li>
                                    <a href="#">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sparkStats">
                            ...
                            <ul class="list-unstyled">
                                <li><span class="sparkLine1 "></span> Total customers missed call: <span class="number">509</span></li>
                                <li>
