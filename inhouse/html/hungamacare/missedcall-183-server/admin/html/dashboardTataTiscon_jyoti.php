...
require_once("alldataTataTiscon_jyoti.php");
            ...
            <div id="content" class="clearfix">
                <div class="contentwrapper"><!--Content wrapper-->
                    ...
                    <div class="heading">
                        ...
                        <!--h3>Dashboard</h3--> 
                        <div class="col-lg-8">					
                            <form id="rangepicker" action="dashboardTataTiscon.php" method="post">					
                    ...
                    ?>" id="rangeA" name="rangeA"  style="font-size: 1.0em;" size="25"/>
                        ...
                        <script type="text/javascript">
                            ...
                            {
                                document.getElementById('chart_load_img').style.display='inline';                               
                                if(type==1)
                                {
                                ...
                                document.getElementById('chart_load_img').style.display='none';
                            }
                        </script>
                                ...
                                <ul class="bigBtnIcon">
                                    ...
                                    <li>
                                        <a href="#" title="Average duration of listening" class="pattern tipB">
                                           ...
                                           $avgMiunteDuration = (int) ($avgDuration / 60);
                                           $avgSecondDuration = $avgDuration % 60;
                                           echo $avgMiunteDuration . ":" . $avgSecondDuration;
                    ?></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="Maximum duration of listening " class="pattern tipB">
                                            ...
                                            <span class="notification"><?php
                                                $maxMinuteDuration = (int) ($maxDuration / 60);
                                                $maxSecondDuration = $maxDuration % 60;
                                                echo $maxMinuteDuration . ":" . $maxSecondDuration;
                                                //echo $maxDuration; 
                    ?></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" title="No. of OBD Pushed" class="pattern tipB">
                                            ...
                                            <span class="notification"><?php echo $totalOBD_targettd; ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <span id="chart_load_img" style="display:none"><img src="http://192.168.100.212/hungamacare/missedcall/admin/html/ajax-loader.gif"/></span>
                    ...
                    ?> </span></li-->
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <li><span class="sparkLine_adsChart"></span> Total Ad Impression: <span class="number"><?php echo $totalAdCount; ?></span></li>
                            ...
                            <div class="panel panel-default gradient">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="vital-stats">
                                        ...
                                        <ul class="list-unstyled">
                                            <li>
                                                <span class="icon24 icomoon-icon-arrow-up-2 green"></span> 0-10 Mins
                                            ...
                                            <li>
                                                <span class="icon24 icomoon-icon-arrow-down-2 red"></span> 36-60 Mins
                                            ...
                                            <li>
                                                ...
                                                <span class="pull-right strong"><?php echo $dur5; ?></span>
                                                <div class="progress progress-striped ">
                   ...
                   var data = [
                        ...
                        if (divElement.hasClass('pieStats')) {
                            $(function () {
                                var data = [
<?php
foreach ($alloperatorCount as $cpname => $cpTotalcount) {
    ?>
