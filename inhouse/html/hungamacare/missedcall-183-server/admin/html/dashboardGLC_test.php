       ...
       <!--Body content-->
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
              ...
              <!--h3>Dashboard</h3--> 
<div class="col-lg-8">					
<form id="rangepicker" action="dashboardGLC.php" method="post">					
...
<form id="rangepicker" action="dashboardGLC1.php" method="post">					
  <div id="rangepickerA">
  <b>Date Range</b> <i class="icon-calendar icon-large"></i>
    <input type="text" value="<?php if(!$_POST) { echo date("m/d/y", strtotime('-30 day')); ?> - <?php echo date("m/d/y");} else { echo date("m/d/y",strtotime($StartDate))." - ".date("m/d/y",strtotime($EndDate));}?>" id="rangeA" name="rangeA"  style="font-size: 1.0em;" size="20"/>	
</div>
<button class="btn btn-info btn-xs" href="#">Go</button>
</form>
</div>
	  ...
	  $('#rangeA').val(start.toString('MM/dd/yy') + ' - ' + end.toString('MM/dd/yy'));
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="centerContent">
                             <ul class="bigBtnIcon">
                                <li>
                                    <a href="#" title="Missed Calls" class="tipB">
                                ...
                                <li>
                                    <a href="#" title="Unique Visits" class="tipB">
                                        <span class="icon icomoon-icon-support"></span>
                                        <span class="txt">Unique Visits</span>
                                        <span class="notification blue"><?php echo $total_unique_user;?></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="AVG Missed Calls" class="pattern tipB">
                                        <span class="icon icomoon-icon-bubbles-2"></span>
                                        <span class="txt">AVG Missed</span>
                                ...
                                <li>
                                    <a href="#" title="OBD's Attended- Promotional" class="pattern tipB">
                                        ...
                                        <span class="txt">Promotional OBD</span>
                                        <span class="notification"><?php echo $totalOBD_attended_Promotional;?></span>
                                    </a>
                                </li>
								   <li>
                                    <a href="#" title="OBD's Attended- Content" class="pattern tipB">
                                        <span class="icon icomoon-icon-basket"></span>
                                        <span class="txt">Content OBD</span>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="centerContent">
                            <div dir="ltr" class="circle-stats">
                                ...
                                <div class="circular-item tipB" title="Most Heard content category">
                                    <span class="icon icomoon-icon-fire"></span>
                                    <input type="text" value="62" class="redCircle" />
                                </div>

                                <div class="circular-item tipB" title="Max min spent by unique user">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="reminder">
                            <h4>Avg Content Consumption per min
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    ...
                                    <span class="number"></span> 
                                    <span class="txt">New Released </span>
                                     <a class="btn btn-warning">3</a>
                                </li>
                                <li class="clearfix">
                                    <div class="icon">
                                    ...
                                    <span class="number"></span> 
                                    <span class="txt">All time hits </span>
                                     <a class="btn btn-warning">7</a>
                                </li>
                                <li class="clearfix">
                                    <div class="icon">
