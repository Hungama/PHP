...
$getDashbord_totalsmssent=mysql_query("select msisdn from Inhouse_IVR.tbl_missedcall_smslist where cpgid='".$cpgid."'",$con);
...
from Inhouse_IVR.tbl_missedcall_smslist nolock where cpgid='".$cpgid."'",$con);
$totalnewvisist=mysql_num_rows($getDashbord_totalnewvisist);

$getDashbord_totalReturning=mysql_query("select msisdn,count(*) as total from Inhouse_IVR.tbl_missedcall_smslist nolock where cpgid='".$cpgid."' 
 group by msisdn HAVING total > 1",$con);
...
from Inhouse_IVR.tbl_missedcall_smslist nolock  where cpgid='".$cpgid."' group by msisdn";
