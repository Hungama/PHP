...
from Inhouse_IVR.tbl_missedcall_cpginfo where cpgid='".$mycpgid."'";
...
<html xmlns="http://www.w3.org/1999/xhtml">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal seperator" role="form" action="userAction.php" method="post">
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="username">CampaignId:</label>
                                <div class="col-lg-10">
                                    <input class="form-control" id="name" name="fname" type="text" disabled="disabled" value="<?php echo $cpgid;?>" />
                                </div>
                            </div><!-- End .form-group  -->
                              <div class="form-group">
                                <label class="col-lg-2 control-label" for="username">Campaign Name:</label>
                                <div class="col-lg-10">
                                    <input class="form-control" id="name" name="lname" type="text" value="<?php echo $cpgname;?>" />
                                </div>
                            </div><!-- End .form-group  -->
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="username">Mobile No:</label>
                                <div class="col-lg-10">
                                    <input class="form-control" id="email" name="email" type="text" disabled="disabled" value="<?php echo $mobileno;?>" />
                                </div>
                            </div><!-- End .form-group  -->
						<div class="form-group">
                                <label class="col-lg-2 control-label" for="username">Missed Call SMS:</label>
                                <div class="col-lg-10">
                                    <input class="form-control" id="name" type="text" name="city" value="<?php echo $missed_call_text;?>" />
                                </div>
                            </div><!-- End .form-group  -->
							<div class="form-group">
                                <label class="col-lg-2 control-label" for="username">Created on:</label>
                                <div class="col-lg-10">
                                    <input class="form-control" id="name" type="text" name="cname" value="<?php echo date('j-M \'y g:i a', strtotime($created_on));?>" />
                                </div>
                            </div><!-- End .form-group  -->
							<?php
	if($status==0) 
	...
	$btnmsg='<span class="icomoon-icon-play-3"></span>';
	$value=1;
	...
	$btnmsg='<span class=" icomoon-icon-pause-2"></span>';
	$value=0;
	$fileStatus1='Active';
	}
	?>
							...
							<div class="form-group">
                                <label class="col-lg-2 control-label" for="username">Action:</label>
                                <div class="col-lg-10">
  <a href="javascript:void(0)" onclick="javascript:stopcampaign('<?php echo $cpgid;?>','<?php echo $value;?>')" class="btn btn-primary" style="float:left"> 
	<?php echo $btnmsg;?>
	</a>
                                </div>
                            </div><!-- End .form-group  -->
