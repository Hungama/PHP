...
foreach ($charttop5dataarray as $circle=>$value) {
    if(count($circle_info[strtoupper($circle)]) <= 1) { 
    $MAP_SET_NEW .= "["."'".$circle_info[strtoupper($circle)]."',".($value>0 ? round($value,0):0)."],\r\n";
	$i++;
    } else{
        
        for($count=0;$count<count($ISO[strtoupper($circle)]);$count++) {
    		$MAP_SET_NEW .= "["."'".$circle_info[strtoupper($circle)][$count]."',".($value>0 ? round($value,0):0)."],\r\n";
                $i++;
        }
...
<div class="col-lg-7">					
<form id="rangepicker" action="dashboard_qa.php" method="post">					
...
<div class="search">
               ...
               <span><b>Campaign Name:</b> <?php echo $campainpgname; ?> <br/> <span style="text-align:right"><?php echo $missed_mobileno;?></span></span>
                    ...
                    <ul class="breadcrumb">
						...
						<a href="campaign.php?cpgid=<?php echo $cpgid;?>" class="tip" title="Campaign info">
						<?php echo 'Campaign Id : '.$cpgid;?>
						</a>
						</li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                       ...
                       <ul class="chartShortcuts">
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="head">Unique Visits</span>
                ...
                <div class="row">
                            ...
                            <div class="panel-body">
								...
								?>
                                    <!--ul class="list-unstyled">
                                        ...
                                        <li>
                                            <span class="icon24 icomoon-icon-arrow-up-2 green"></span> <?php echo $cir2;?>% Clicks
                                        ...
                                        <li>
                                            <span class="icon24 icomoon-icon-arrow-down-2 red"></span> <?php echo $cir3;?>% Clicks
                                            <span class="pull-right strong"><?php echo $cir3_count.$cir3_name;?></span>
                                            <div class="progress progress-striped ">
								...
								<!-- India Map -->
								<p><div id="chart_div" style="width:420px"></div></p>
                                </div>
                    ...
                    <!--div class="col-lg-4">
                        ...
                        <div class="reminder">
							...
							<img src="images/banner_550x480.gif" width="410" height="268" border="0"/>
                            <ul>
                                <li class="clearfix">
                                    <div class="icon">
