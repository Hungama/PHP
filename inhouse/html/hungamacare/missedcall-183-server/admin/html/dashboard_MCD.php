...
require_once("alldataMCD.php");


$getDashbordChart_missedCallNewChart="select count(*) as total, day(date_time) as day,Month(date_time) as month
from $tblMissedCall nolock  where date(date_time) between '".$StartDate."' and '".$EndDate."' and ANI!='' and service='MCW_LIVEAPP' group by date(date_time) order by Month(date_time),day ASC";
       ...
       <!--Body content-->
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
              ...
              <!--h3>Dashboard</h3--> 
<div class="col-lg-8">					
<form id="rangepicker" action="dashboard_MCD.php" method="post">					
                       ...
                       <ul class="chartShortcuts">
                                    <li>
                                        <a href="#">
                                            ...
                                            <span style="font-size:18px;color:#ed7a53;font-weight:700;"><?php echo $total_user;?></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <span class="head">Total Unique Visitor</span>
                                            <span style="font-size:18px;color:#ed7a53;font-weight:700;"><?php echo $total_unique_user;?></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <span class="head">Today's New Visitor(s)</span>
                                            <span style="font-size:18px;color:#ed7a53;font-weight:700;"><?php echo $totalNewUniqueVisitToday;?></span>
                                        </a>
                                    </li>
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="sparkStats">
                            ...
                            <ul class="list-unstyled">
								...
								<li><span class="sparkLine_AvgMissedCallPerDayCall"></span> Average Missed Calls Per Day: <span class="number"><?php echo $avgmissedperday;?></span></li>
