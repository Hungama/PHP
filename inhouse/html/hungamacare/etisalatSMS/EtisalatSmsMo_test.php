			...
			if(isAllowedExtension($file['name'])) {
				...
				*/
				...
				if(move_uploaded_file($_FILES['upfile']['tmp_name'], $path)) {
					$insert_query = "INSERT INTO etislat_hsep.tbl_sms_history_etisalat (servicename, serviceId, filename, date_time, status, circle, added_by,plainid,flagvalue) values ('".$service."', '2121', '".$dbfileName."', NOW(), 0, '".$circleCode."', '".$_SESSION['loginId']."','".$planid."','".$matchday."')";
