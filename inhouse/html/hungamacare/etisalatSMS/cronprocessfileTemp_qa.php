...
$checkfiletoprocess=mysql_query("select batchid,servicename,serviceId, filename, date_time,status,circle,plainid,flagvalue from etislat_hsep.tbl_sms_history_etisalat where batchid=7269");
...
//yyyy-mm-dd 2014/11/01#01-2014-11
$explodedDate=explode('/',$data[0]);
$smsmessage=str_replace("\"", "", trim($data[2]));
$smsmessage=str_replace("’", "'", $smsmessage);
