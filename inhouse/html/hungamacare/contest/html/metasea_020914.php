...
foreach ($contentid_array as $key => $value) {
    ...
    foreach ($array['files']['file'] as $val) {
        $details = array_values($val);echo "<br/><br/><br/>";print_r($details);
//        $img = $details[3]['path'][1];
//        if ($details[4] >= 128) {
//            $pos = strpos($img, 'display');
//            if ($pos === false) {
//                
//            } else {
//                if ($i <= 3) {
//                    //  print_r($val); echo "<br/><br/><br/>Details:";
//                    //print_r($details[3]['path'][1]);
//                    //echo "<br/><br/><br/>";
//                    if ($i == 1) {
//                        echo $qry = "update uninor_summer_contest.question_bank_wapcontest set image1='" . $img . "' where content_id='" . $value . "'";
//                        $result = mysql_query($qry);
//                    } else if ($i == 2) {
//                        echo $qry = "update uninor_summer_contest.question_bank_wapcontest set image2='" . $img . "' where content_id='" . $value . "'";
//                        $result = mysql_query($qry);
//                    } else if ($i == 3) {
//                        echo $qry = "update uninor_summer_contest.question_bank_wapcontest set image3='" . $img . "' where content_id='" . $value . "'";
//                        $result = mysql_query($qry);
//                    }
//                    echo "<br/><br/><br/>";
//                }
