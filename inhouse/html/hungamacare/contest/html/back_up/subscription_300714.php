...
if ($textDetails['ques_played'] == 5) {
    $msg = "Your free questions are over! Enter the contest now & be the Lucky one to win Exciting<b> COUPLE HOLIDAY TRIP</b>.<a href='subscription.php'>Click here to Subscribe </a>@ just Rs.5/day";
}
...
<!--                <span class="blueTxt1">Superb!</span> -->
                ...
                <div class="cntstQno">
                    ...
                    if (isset($_SESSION['CREATED'])) {
                        if ((time() - $_SESSION['CREATED'] > 1800) && $textDetails['ques_played'] == 5) {
                            ...
                            $msg = "Welcome back to Khelo India Jeeto India! You have earned " . $score . " points, Enter the contest now & be the Lucky one to win Exciting <b>COUPLE HOLIDAY TRIP & DAILY RECHARGES</b>. <a href='subscription.php'>Click here to Subscribe </a>@ just Rs.5/day";
            ...
            <div align="center"><a href="subscription.php"><img src="images/banner.jpg" width="310" height="143" alt="" /></a></div>
