...
//$quesDetails = explode('?', $details);
//print_r($quesDetails);
$msisdn = '8587800665';
//echo "first";
//print_r($_REQUEST);
//if ($visitStatus == '') {
//    header("Location: http://192.168.100.212/hungamacare/contest/API/contestApi.php?msisdn=" . $msisdn);
//} else {
//    
//}
if ($type == 'rply') {
...
if ($msg == 'NotOk') {
    header("Location:http://192.168.100.212/hungamacare/contest/html/topup.php");
    //http_redirect("topup.php");
}
$_SESSION['time'] = date(YmdHis);
//print_r($data);
//[details] => Q. RTE Act Govt. of India ke anusar bachchon ko kis cheez ka adhikaar hai?1 Education , Internet , 3 Entertainment, 4 Employment. Reply BNB 1,2,3 ya 4
?>
...
<!--                <span class="blueTxt1">Superb!</span> -->
            ...
            <div class="topContDtls mb10">
                <div class="cntstNo">
                    <?php
                    $scoreQuery = "select score,ques_played from Hungama_BNB.tbl_contest_subscription  where ANI='" . $msisdn . "' ";
                ...
                <div class="cntstQno">
                    <?php
//                    $playedQuesQuery = "select count(*) as playedQues from Hungama_BNB.question_played where ANI='" . $msisdn . "'";
//                    $playedQuesResult = mysql_query($playedQuesQuery);
//                    $playedQuesDetails = mysql_fetch_array($playedQuesResult);
//                    $playedQues = $playedQuesDetails['playedQues'];
            ...
            <div class="pt" align="center"><iframe width="310" height="233" src="//www.youtube.com/embed/ivZ3JmecdyE" frameborder="0" allowfullscreen></iframe></div>
...
<!--                        &nbsp; <a href="#"><img src="images/nxtBtn.jpg" width="54" height="22" alt="" /></a>-->
            ...
            <div class="badgesArea">
                <div class="badges fnt14"><a href="http://192.168.100.212/hungamacare/contest/html/badges.php">Badges</a></div>
                <div class="ldrBord fnt14"><a href="http://192.168.100.212/hungamacare/contest/html/Leaderboard.php">Leaderboard</a></div>
                <div class="cl"></div>
            </div>
            <div align="center"><a href="#"><img src="images/nxtBtn.jpg" width="54" height="22" alt="" /></a></div>
