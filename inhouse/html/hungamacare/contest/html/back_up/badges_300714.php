...
//       if ($textDetails['ques_played'] == 5 && $badgesnum > 0 && $textDetails['ques_available'] == 0) {
            if ($textDetails['ques_played'] <= 5) {
                $flag = 0;
                $msg = "To view your Badge enter the contest now! <a href='subscription.php'>Click here to Subscribe</a> @ just Rs.5/day";
            } else {
                $msg = "Your Current badge... " . $badgeinfoDetails['badge_name'];
            }
