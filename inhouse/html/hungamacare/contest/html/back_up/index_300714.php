...
if ($textDetails['ques_played'] == 0) {
    $msg = "Welcome to <b>Khelo  India Jeeto India!</b> Enjoy the splash of Monsoon with your loved ones on Monsoon Magic contest. Just play 5 free questions now & stand a chance to gives you a chance to win<b> COUPLE HOLIDAY TRIP, DAILY RECHARGES</b> and much more...";
} else if (($textDetails['ques_available'] == '7' || $textDetails['ques_available'] == '5' || $textDetails['ques_available'] == '3') && $textDetails['ques_played'] == 5) {
    $msg = "Congratulations!!! You have entered the contest successfully, get " . $textDetails['ques_available'] . " questions....Keep playing Monsoon Magic Contest & be the Lucky one to win Exciting <b>COUPLE HOLIDAY TRIP & DAILY RECHARGES.</b> ";
}
...
<!--                <span class="blueTxt1">Superb!</span> -->
            ...
            <?php if (Modernizr . video) { ?>
                ...
                <div class="pt" align="center">    <a href="http://aks3dlre.vodafonemusic.in/s3/r/ms2/2430482/5/815/Palat_-_Tera_Hero_Idhar_Hai.mp4?__gda__=1407317991_9cc4a13098d8aef34aa7ca6ddc284fad"><img src="images/movie_image.jpg" width="150" height="150" alt="" /></a>        </div>
            <?php } else { ?>
