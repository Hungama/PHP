...
<body>
	...
	<div class="cont">
        ...
        <div class="topContDtls mb10">
            <div class="cntstNo">P - 001</div>
            <div class="cntstNm">Jhankar Beats Contest</div>
            <div class="cntstQno">Q - 001</div>
            <div class="cl"></div>
        </div>
        ...
        <div class="quesArea fnt14">watch the video carefully to answer the question.</div>
		 <div class="quesArea">
       	  <div class="vdoNm"><strong>Video:</strong> Jai Ho...</div>
          	<div class="mt7"><strong>Question:</strong> dumm text dummy text dumm text dummy text dumm text dummy text</div>
          	<div class="mt7"><input name="" type="radio" value="" /> &nbsp; 1. Ans</div>
          	<div class="mt7"><input name="" type="radio" value="" /> &nbsp; 2. Ans</div>
          	<div class="mt7"><input name="" type="radio" value="" /> &nbsp; 3. Ans</div>
          	<div class="mt7"><input name="" type="radio" value="" /> &nbsp; 4. Ans</div>
        	<div class="mt7"><a href="#"><img src="images/bckBtn.jpg" width="54" height="22" alt="" /></a> &nbsp; <a href="#"><img src="images/nxtBtn.jpg" width="54" height="22" alt="" /></a></div>
        </div>
        <div class="badgesArea">
        	<div class="badges fnt14"><a href="#">Badges</a></div>
            <div class="ldrBord fnt14"><a href="#">Leaderboard</a></div>
            <div class="cl"></div>
      	</div>
