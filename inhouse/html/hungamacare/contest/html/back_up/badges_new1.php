...
<!--            <div class="srch"><input name="" type="text" /> <img src="images/srchBtn.gif" width="38" height="31" alt="" class="vrtMid" /><br class="cl" /></div>-->
            ...
            <div class="BdgesArea">
                ...
                <div class="pt10">
					...
					$badArrayLength=count($badge_array);
					$noofloop=$badArrayLength/3;
//					echo $noofloop;
					$m=1;
					for($k=1;$k<=$noofloop;$k++)
					{
					
						if($k==1)
						$startindex=$m;
						else
						$startindex=$k+$noofloop;
					...
					<div align="center">
				<?php
				echo $startindex."#".$endindex."<br>";
				for($j=$startindex;$j<=$endindex;$j++)
					{?>
					<div class="Bdges" align="center">
                        <div><img src="images/badges_1.png" width="85" height="85" /></div>
