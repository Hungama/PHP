...
$allDetails = explode('#', $data);//print_r($allDetails);
$msg = $allDetails[0];
...
<!--                <span class="blueTxt1">Superb!</span> -->
            ...
            <?php if (Modernizr . video) { ?>
                ...
                <div class="pt" align="center">    <a href="http://aks3dlre.vodafonemusic.in/s3/r/ms2/2430482/5/815/Palat_-_Tera_Hero_Idhar_Hai.mp4?__gda__=1407317991_9cc4a13098d8aef34aa7ca6ddc284fad"><img src="<?php echo $image1 ?>" width="150" height="150" alt="" /></a>        </div>
            <?php } else { ?>
