...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="header">
            ...
            <div class="welcUser mt47" align="right">Hi +91<?php echo $msisdn; ?> &nbsp;&nbsp; <a href="myProfile.php?navipage=Leaderboard"><img src="images/user-icon.gif" width="21" height="23" alt="" /></a> &nbsp;&nbsp; 
                <a href="index.php?navipage=Leaderboard"><img src="images/home-icon.gif" width="21" height="23" alt="" /></a> &nbsp;&nbsp; </div>
            <div class="cl"></div>
        </div>
...
<!--        <div class="srch"><input name="" type="text" /> <img src="images/srchBtn.gif" width="38" height="31" alt="" class="vrtMid" /><br class="cl" /></div>-->
            ...
            if ($textDetails['ques_played'] == 5 && $textDetails['ques_available'] == 0) {
                $msg = "To know where you stand enter the contest now!<br><a href='subscription.php?navipage=Leaderboard'> Click here to Subscribe</a> </br>@ just Rs.5/day";
            } else {
...
////////////////////////////////// end code for text in contest site @jyoti.porwal ///////////////////////////////////////////////////////////
            ...
            <div class="badgesArea">
                <div class="badges fnt14"><a href="badges.php?navipage=Leaderboard">Badges</a></div>
                <div class="ldrBord fnt14"><a href="Leaderboard.php?navipage=Leaderboard">Leaderboard</a></div>
                <div class="cl"></div>
            </div>
            ...
            <div class="mt25" align="center"><a href="subscription.php?navipage=Leaderboard"><img src="images/monsoon.jpg" width="310" height="143" alt="" /></a></div>
            ...
            <div class="footer">
                <div class="footerLnks">
                    <div class="footerLnks"> <a href="termsncondition.php?navipage=Leaderboard">T &amp;Cs</a> | <a href="faqs.php?navipage=Leaderboard">FAQs</a></div>
