...
<!--            <div class="confMessage fnt13"><span class="redTxt">Sorry!</span> We are unable to top up your account right now. You will be informed about your top-up via SMS</div>-->
            ...
            <div class="topContDtls">
                <div class="cntstNo">
                    ...
                    ?>
                    <img src="images/score_50x50.PNG"  width="20" height="20"/>
                    <?php echo $score;
                    ?>
                </div>
                ...
                <div class="cntstQno">
                    ...
                    ?>
                    <img src="images/question_50x50.PNG"  width="20" height="20"/>
                    <?php echo $playedQues;
                    ?>
                </div>
                <div class="cl"></div>
...
////////////////////////////////// end code for text in contest site @jyoti.porwal ///////////////////////////////////////////////////////////
            ...
            <div class="mt25" align="center"><a href="subscription.php?navipage=My Profile"><img src="images/monsoon.jpg" width="310" height="143" alt="" /></a></div>
