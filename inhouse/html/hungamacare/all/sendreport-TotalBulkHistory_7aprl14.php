...
$message .= "<tr style='".$style."'><td><strong>".$result['batch_id']."</strong> </td><td>" .$result['added_on']."</td><td>".$upfor."</td><td>".$result['status']."</td><td>".$result['service_id']."</td><td>".$TC."</td><td>".$SC."</td><td>".$FC."</td><td>".$IR."</td><td style='font-weight:bold'>MTS</td></tr>";
	...
	mail('manu.sharma@hungama.com', $subject, $message, $headers);
	 ...
	 else if($operator=='MTS')
	 {
		...
		mail('gagandeep.singh@hungama.com', $subject, $message, $headers);
			...
			if(mail($cc_dev, $subject, $message, $headers))
			{
			$logdata="*************Email Send Successfully For MTS Service*************"."#".date("H:i:s")."\r\n";;
			error_log($logdata,3,$path_log);
			}
			else
			{
	...
	else if($operator=='Uninor')
	 {
		 foreach($emailArray as $email)
			...
			if(mail($cc_dev, $subject, $message, $headers))
			{
			$logdata="*************Email Send Successfully For Uninor Service*************"."#".date("H:i:s")."\r\n";;
			error_log($logdata,3,$path_log);
			}
			else
			{
