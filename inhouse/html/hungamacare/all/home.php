		  ...
		  <div class="select-bar">
			...
			<tr class="bg">
				...
				<td class="first"><strong>Please select Operator<span style="color:red">&nbsp;*</span></strong></td>
					...
					<tr class="bg">
						<td class="first"><strong>Please select Price Point<span style="color:red">&nbsp;*</span></strong></td>
						<td class="last">
                       <select name="obd_form_pricepoint" id="obd_form_pricepoint" onchange="getPlannfo(this.value)">
						</select>
					...
					<tr class="bg">
                       ...
                       <select name="msisdn" id="msisdn">
						...
						<!--option value="9873710297">9873710297</option-->
						</select>
