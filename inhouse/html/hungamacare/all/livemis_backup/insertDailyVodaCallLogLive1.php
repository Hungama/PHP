...
union
select 'CALLS_TF',circle, count(id),'1307' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55841) and operator in('vodm') group by circle
union
select 'CALLS_TF',circle, count(id),'1310' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55935) and operator in('vodm') group by circle"; 
...
union
select 'MOU_TF',circle, sum(duration_in_sec)/60,'1307' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55841) and operator in('vodm') group by circle
union
select 'MOU_TF',circle, sum(duration_in_sec)/60,'1310' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55935) and operator in('vodm') group by circle";
...
union
select 'PULSE_TF',circle, sum(ceiling(duration_in_sec/60)),'1307' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55841) and operator in('vodm') group by circle
union
select 'PULSE_TF',circle, sum(ceiling(duration_in_sec/60)),'1310' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55935) and operator in('vodm') group by circle";
...
union
select 'UU_TF',circle, count(distinct msisdn),'1303' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(546461) and operator in('vodm') group by circle
union
select 'UU_TF',circle, count(distinct msisdn),'1307' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55841) and operator in('vodm') group by circle
union
select 'UU_TF',circle, count(distinct msisdn),'1310' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55935) and operator in('vodm') group by circle";
...
union
select 'SEC_TF',circle,sum(duration_in_sec),'1307' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55841) and operator in('vodm') group by circle
union
select 'SEC_TF',circle,sum(duration_in_sec),'1310' as service_name,date(call_date) from master_db.tbl_voda_calllog where date(call_date)='$view_date1' and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]') and dnis in(55935) and operator in('vodm') group by circle";
