...
$VodaMTVFilePath="/var/www/html/kmis/mis/activeBase/voda.txt";

$getActiveBaseQ7="select * from master_db.tbl_voda_calllog where date (call_date) between  '2013-05-01' and '2013-05-31'";  
