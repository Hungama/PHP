...
//$sql_getservicelist = mysql_query("select service_id,operator,service_name,description from master_db.tbl_service_master where operator='".$str."' and length(service_id)=4 and status=1");
$sql_getservicelist = mysql_query("select service_id,operator,service_name,description from master_db.tbl_service_master where service_id like '$str%' and length(service_id)=4 and status=1");
