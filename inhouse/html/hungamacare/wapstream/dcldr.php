...
$logPath = "/var/www/html/hungamacare/wapstream/log/testingfile.txt";

$log_str_new = '$msg=' . $msg . '-----$code=' . $code . '-----$MSISDN1=' . $MSISDN1 . '-----$msisdn=' . $msisdn . '------$productId=' . $productId . '------$amount=' . $amount . '------$time=' . $time . '------$content_id=' . $content_id;
