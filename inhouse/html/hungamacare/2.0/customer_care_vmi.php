	...
	<?php if($service_info=='1208') { ?>
		...
		if (($subStatus == 1 || $subStatus == 5 || $subStatus == 2) && !in_array($_REQUEST['usrId'],$blacklistID)) { 
			if($_SESSION['usrId']!=265) { ?>
				...
				<a href="javascript:void(0);" onclick="do_Act_Deactivate(<?php echo $msisdn;?>,<?php echo $service_info;?>,'<?php echo $subsrv;?>','da','customer_care_vmi')" style="text-decoration:none">
...
<?php
        } else
        {
			...
			echo "<div class='alert alert-block'>No records found for this number</div> ";
        }
...
<FONT COLOR="#0033FF" size='2px'>
	...
	<!--a href="javascript:void(0);" onclick="openWindow1('viewchargingDetails',<?php echo $msisdn;?>,<?php echo $service_info;?>)">
		...
		<a href="javascript:void(0);" onclick="openWindow3('viewsMousDetail',<?php echo $msisdn;?>,<?php echo $service_info;?>)">
		<span class="label label-important"><FONT COLOR="#0033FF" size='2px'><B>Click here to view MOUS history</B></FONT></span></a><?php } ?>
	<?php }?>
<?php */}?>
...
<?php
} else
        {
            //echo "<div align='center'><B>No history found</B></div>";
			 echo "<div class='alert alert-block'>No history found</div> ";
        }
    }
//if section end here	
