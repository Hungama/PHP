...
?>
		...
		<div class="alert alert-block"><B><FONT COLOR="#FF0000">Subscription Status</FONT></B></span>
		</div><center><br/>
		...
		if (($subStatus == 1 || $subStatus == 5 || $subStatus == 2) && !in_array($_REQUEST['usrId'],$blacklistID)) { 
			if($_SESSION['usrId']!=265) { ?>
				<!--a href="customer_care.php?msisdn=<?php echo $msisdn;?>&act=da&service_info=<?php echo $service_info;?>&subsrv=<?php echo $subsrv;?>"><b><u>Deactivate</u></b></a-->
								<a href="javascript:void(0);" onclick="do_Act_Deactivate(<?php echo $msisdn;?>,<?php echo $service_info;?>,'<?php echo $subsrv;?>','da','customer_care_tatadocomo')" style="text-decoration:none">
