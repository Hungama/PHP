...
//navigation language array for religion
            ...
            /* AircelMC Service code end here */ elseif ($service == "54646") {
                ...
                <div id="mainmenu_cat_div_eu">
                    <table width="100%" class="table table-condensed table-bordered" id="example">
                        <thead> <tr>
                                <td><span class="label">&nbsp;&nbsp;&nbsp;1&nbsp;&nbsp;&nbsp;</span>&nbsp;<a href="#" onclick="showContent_54646('mw_54646','<?php echo $circle; ?>','<?php echo $lang; ?>','<?php echo $operator; ?>');">Music World</a></td>
                                <td>
                                    <span class="label">&nbsp;&nbsp;&nbsp;2&nbsp;&nbsp;&nbsp;</span>&nbsp;<a href="javascript:void(0);" onclick="showContent_data('lg_54646','<?php echo $circle; ?>','<?php echo $lang; ?>','<?php echo $operator; ?>')">Love Guru</a>
                                </td>
...
//$catData_dayspl = array('hindu_0'.$lang=>'Day SPL','temple-'.$lang=>'Temples','myth_stories-'.$lang=>'Mythological Stories');
        ...
        case '7': $circle = strtolower(trim($_GET['circle']));
                        ...
                        for ($j = 0; $j <= count($acDataValue); $j++) {
                            ...
                            if ($acDataValue[$j]) {
                                ...
                                <td><span class="label">&nbsp;&nbsp;&nbsp;<?php echo $j + 1; ?>&nbsp;&nbsp;&nbsp;</span>
                                    ...
                                    if (1) {
                                        ?>
                                        <a href='#' onclick="showContent_54646('<?php echo $lang; ?>','<?php echo $circle; ?>','54646','<?php echo $operator; ?>');">
                                        <?php echo $album; ?></a><?php
                } else {
            ...
            <ul class="breadcrumb">  
                <li>  
                    <a href="javascript:void(0)" onchange="showMainMenu_54646('','<?php echo $circle; ?>','<?php echo $service; ?>','<?php echo $operator; ?>');">Root</a> <span class="divider">/</span>  
                </li>  
                <li class="active">Audio Cinema</li> 
            </ul>
            <div id="tabs4-pane" class="tab-pane">
