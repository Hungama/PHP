...
switch ($case) {
    ...
    case 'AMCMU':
        echo $langmc = $_REQUEST['langmc'];
        echo $mccatname = $_REQUEST['mccatname'];
        exit;
        echo $splzoneFileNamePath = "http://10.130.14.106:8080/hungama/config/config/mtsm/spconf/" . $splzoneFileName . ".cfg";
        $lines1 = file($splzoneFileNamePath);
        $mtsmuFullDataValue = array();
        foreach ($lines1 as $line_num => $MTSMUData2) {
            $mtsmuFullDataValue[] = $MTSMUData2;
    ...
    case '54646':
        ...
        $query = "select * from master_db.tbl_subcategory_master where catID=substr('" . $data_value . "',3,2)";
        $result = mysql_query($query, $dbConn);
        $data = mysql_fetch_row($result);
        $catName = $data[0];
        $catName = $splzoneFileName . ".cfg";
        ...
        <ul class="breadcrumb">
            <li>  
                ...
                <a href="javascript:void(0)" onclick="showContent_54646('54646','<?php echo $circle; ?>','<?php echo $lang; ?>','<?php echo $operator; ?>');">Music World</a><span class="divider">/</span>
            <?php echo $data[0]; //showMainMenu_54646(lang,circle,service,operator,navlang)?>
    ...
    case 'special_zone':
        ...
        $data_value = trim($_GET['data_value']);
        $todaytime = date(jm);
        //$ACfilePath = "192.168.100.226:8082/hungama/config/54646config_V2/" . $operator . "/specialzone/".$lang."00_".$todaytime.".cfg";exit;
        $ACfilePath = "http://192.168.100.226:8082/hungama/config/54646config_V2/relm/specialzone/0100_0703.cfg";
        $lines = file($ACfilePath);
        $iscount = count($lines);
        $acDataValue = array();
        foreach ($lines as $line_num => $ACData) {
        ...
        <ul class="breadcrumb">
            <li>  
                ...
                <a href="javascript:void(0)" onclick="showContent_54646('cw_54646','<?php echo $circle; ?>','<?php echo $lang; ?>','<?php echo $operator; ?>');">Celebrity World</a><span class="divider">/</span>
            <?php echo "Interview"; ?>
        ...
        $data_value = trim($_GET['data_value']);
        //$ACfilePath = "http://192.168.100.226:8082/hungama/config/54646config_V2/" . $operator . "/CelebrityWorld/StarInterview-" . $lang . ".cfg";
       // http://192.168.100.226:8082/hungama/config/54646config_V2/unim/audiosongconfig/0121-clip.cfg
        $ACfilePath = "http://192.168.100.226:8082/hungama/config/54646config_V2/" . $operator . "/audiosongconfig/" . $data_value . "-clip.cfg";
        $lines = file($ACfilePath);
        $iscount = count($lines);
        ...
        <ul class="breadcrumb">
            <li>  
                <a href="javascript:void(0)" onclick="showMainMenu_54646('<?php echo $lang; ?>','<?php echo $circle; ?>','54646','<?php echo $operator; ?>');">Root</a> <span class="divider">/</span> 
                <a href="javascript:void(0)" onclick="showContent_54646('ac_54646','<?php echo $circle; ?>','<?php echo $lang; ?>','<?php echo $operator; ?>');">Audio Cinema</a><span class="divider">/</span>
            <?php echo $data[0]; ?>
