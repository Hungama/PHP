...
$operator_info = array('tatc' => 'Indicom', 'relm' => 'relm', 'relc' => 'Reliance', 'tatm' => 'Tata GSM', 'unim' => 'Uninor', 'airc' => 'airc');
...
//}
                        ...
                        <option value="<?php echo '54646'; ?>"><?php echo '54646'; ?></option>
                    </select></a>
                <a id="ttip_operator" name="ttip_operator" rel="tooltip" data-placement="bottom" data-original-title="Select Operator" style="display:none">
                    <select name="operator" id="operator" class="span2">
                        <option value="">Select Operator</option>
                        <?php foreach ($operator_info as $operator_id => $operator_val) { ?>
                            <option value=<?php echo $operator_id ?>><?php echo $operator_val; ?></option>
                        <?php } ?>
