...
function showContent_54646(service,circle,lang,operator,catname) { 
    ...
    if(service == 'ac_54646'){
        var url="Content.Live_langValue.php?circle="+circle+"&case=8&lang="+lang+"&service="+service+"&operator="+operator+"&catname="+catname;
    } 
    else if(service == 'cw_54646'){
        var url="Content.Live_langValue.php?circle="+circle+"&case=9&lang="+lang+"&service="+service+"&operator="+operator+"&catname="+catname;
    }
    else{
...
//    var url="Content.Live_showContent.php?circle="+circle+"&cat=54646&lang="+lang+"&service="+service+"&operator="+operator+"&data_value="+data_value+"&catname="+catname;
    var url="Content.Live_showContent.php?circle="+circle+"&cat="+service+"&lang="+lang+"&service="+service+"&operator="+operator+"&data_value="+data_value+"&catname="+catname;
    myAjax.open("GET",url,true);
    myAjax.send();
    var xhrTimeout=setTimeout("ajaxTimeout();",10000);
}
...
//function showLoveGuruMenu_54646(lang,circle,service,operator,navlang) { 
//    document.getElementById("ACdiv1").innerHTML='';
//    document.getElementById("ac2Div").style.display = 'none';
//    document.getElementById("ACdiv2").style.display = 'none';
//    document.getElementById("ac3Div").style.display = 'none';
