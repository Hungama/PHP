...
function setCircleData(circleCode) { 
	...
	var url="langValue_db.php?circle="+circleCode+"&case=1&service="+service;
	//alert(url);
...
function showMainMenu(lang,circle,service) { 
	...
	var url="langValue_db.php?circle="+circle+"&case=2&lang="+lang+"&service="+service;
	//alert(url);
	xmlhttp.open("GET",url,true);
	xmlhttp.send();	
}
...
$('#grid').hide();
	...
	var url="langValue_db.php?circle="+circle+"&case=3&lang="+lang+"&service="+service+"&catname="+catname;
	//alert(url);
	xmlhttp.open("GET",url,true);
	xmlhttp.send();	
}
...
$('#grid').hide(); document.getElementById('ac1Div').style.display = 'none';
	...
	var url="langValue_db.php?circle="+circle+"&case=4&lang="+lang+"&service="+service+"&clip="+clipValue+"&catname="+catname;
	//alert(url);
	xmlhttp.open("GET",url,true);
	xmlhttp.send();	
}
...
//document.getElementById('tabs4_othr').style.display = 'block';
	...
	var url="langValue_db.php?circle="+circle+"&case=4&lang="+lang+"&service="+cat+"&mucatname="+mucatname+"&startfrom="+startfrom;
	//alert(url);
	xmlhttp.open("GET",url,true);
	xmlhttp.send();	
}
...
document.getElementById("showinfo").innerHTML='<img src="assets/img/loading-circle-48x48.gif" border="0"/>';
	...
	var url="langValue_db.php?circle="+circle+"&case=5&lang="+lang+"&service="+service;
	//alert(url);
	xmlhttp.open("GET",url,true);
	xmlhttp.send();	
}
...
document.getElementById("showinfo").innerHTML='<img src="assets/img/loading-circle-48x48.gif" border="0"/>';
	...
	var url="langValue_db.php?lang="+lang+"&religion="+religion+"&case=6&circle="+circle;
	//alert(url);
	xmlhttp.open("GET",url,true);
	xmlhttp.send();	
}
