...
switch($case) {
	case 'bg': if($service == 'bg') { $flag=0;
				  ...
				  <div>
						<div class="well well-small"><B><FONT COLOR="#FF0000"><h3>Bollywood Gossip List</h3></FONT></B></div>
<div class="well well-small">					
				  ...
				  <table align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1"  width="100%" class="table table-bordered table-condensed">		
					  <tr>
						<td style="padding-left: 5px;" bgcolor="#ffffff" height="35" width="10%" align='center'><b>DTMF</b></td>
...
<ul class="breadcrumb">  
  ...
  <li class="active"><?= $clipValue;?></li> 
		...
		<div align='left'class="tab-content">
					<!--div class="well well-small">	<h3>Audio Cinema</h3></div-->
					<div class="well well-small">
						<span class="label label-important"><b>Circle</b></span>&nbsp;&nbsp;<?php echo $circle_info[$circle];?>&nbsp;&nbsp;
						<span class="label label-info"><b>Language</b></span>&nbsp;&nbsp;<?php echo $languageData[$lang];?>&nbsp;&nbsp;
				  ...
				  <table align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1"  width="100%" class="table table-bordered table-condensed">		
					  <tr align='center'>
						<td style="padding-left: 5px;" bgcolor="#ffffff" height="35" width="10%"><b>DTMF</b></td>
...
<ul class="breadcrumb">  
  ...
  <!--li class="active"><?//= $catName;?></li--> 
			...
			<div align='left' class="tab-content">
					<!--div class="well well-small"><h3>Music Unlimited</h3></div-->
					<div class="well well-small">
					<span class="label label-important"><b>Circle</b></span>&nbsp;&nbsp;<?php echo $circle_info[$circle];?> &nbsp;&nbsp;
					<span class="label label-info"><b>Language</b></span>&nbsp;&nbsp;<?php echo $languageData[$lang];?>&nbsp;&nbsp;
	...
	$query = "select SongUniqueCode,ContentName,AlbumName,language,Genre,MT_ID,PT_ID,TT_ID from master_db.master_content where SongUniqueCode='".trim(substr($muFullDataValue[$i],4))."'";
						$result = mysql_query($query);
						...
						<?php if(!empty($data['MT_ID'])){?>	<span class="label label-important"><b>Mono</b></span>&nbsp;&nbsp;<?php echo $data['MT_ID'];}?>
						<?php if(!empty($data['PT_ID'])){?>&nbsp;&nbsp;<span class="label label-info"><b>Poly</b></span>&nbsp;&nbsp;<?php echo $data['PT_ID'];}?>
						<?php if(!empty($data['TT_ID'])){?>&nbsp;&nbsp;<span class="label label-success"><b>Tru </b></span>&nbsp;&nbsp;<?php echo $data['TT_ID'];}?>
							</td>
	...
	break;
	case 'devo': $clipValue = $_REQUEST['clip']; 
				...
				<div align='left' class="tab-content">
					<div class="well well-small"><h3><?php echo ucwords($_GET['rel']);?></h3></div>
					<div class="well well-small">
					<span class="label label-important"><b>Circle</b></span>&nbsp;&nbsp;<?php echo $circle_info[$circle];?>&nbsp;&nbsp;
					<span class="label label-info"><b>Language</b></span>&nbsp;&nbsp;<?php echo $languageData[$lang];?>&nbsp;&nbsp;
					<span class="label label-success"><b>ClipValue</b></span>&nbsp;&nbsp;<?php echo $clipValue;?>
				...
				<table align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1"  width="100%" class="table table-bordered table-condensed">		
					...
					//$query = "select AlbumName,ContentName from master_db.master_content where SongUniqueCode='".trim(substr($relFullDataValue[$i],4))."'";
$query = "select SongUniqueCode,ContentName,AlbumName,language,Genre,MT_ID,PT_ID,TT_ID from master_db.master_content where SongUniqueCode='".trim(substr($relFullDataValue[$i],4))."'";					
					$result = mysql_query($query);
					$data = mysql_fetch_array($result);  //print_r($data);	?>
					<tr>
						<td style="padding-left: 5px;" bgcolor="#ffffff" height="35" align='center'><?php echo $j;?></td>
...
<ul class="breadcrumb">  
  ...
  <li>  
    <a href="#">Spl Zone</a> <span class="divider">></span>  
  </li> 
  ...
  <li class="active">  
    <?= $catName;?>
			...
			<div align='left' class="tab-content">
					<!--div class="well well-small"><h3>Music Unlimited-Spl Zone</h3></div-->
					<div class="well well-small">
