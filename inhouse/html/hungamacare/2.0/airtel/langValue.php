...
switch($case) {
	...
	case '2': $circle=strtolower(trim($_GET['circle']));
			  $service=strtolower(trim($_GET['service'])); 		
			  $lang = trim($_GET['lang']);	
			  if($service == "eu") { if($circle == 'pub') $circle ='pun'; ?>			  
				 <div align='left' class="tab-content">
						<div class="alert">
		
			Displaying For Airtel Eu For <strong><?php echo $circle_info[strtoupper($circle)];?></strong> For <strong><?php echo $languageData[$lang];?></strong> Navigation Language
					</div>
				</div>
				  <div id="mainmenu_cat_div_eu">
				  <table width="100%" class="table table-condensed table-bordered" id="example">
					 <thead> <tr>
						<td><a href="#" onclick="showContent('ac','<?php echo $circle;?>','<?php echo $lang;?>');">Audio Cinema</a></td>
						<td>
						<a href="javascript:void(0);" onclick="showContent_data('bg','<?php echo $circle;?>','<?php echo $lang;?>')">Bollywood Gossip</a>
						</td>
						<td><a href="#" onclick="showContent('mu','<?php echo $circle;?>','<?php echo $lang;?>');">Music Unlimited</a></td>
					  </tr>
                     </thead>					  
				  </table>
				  </div>
			  ...
			  if($service =='ac') { 
				 ...
				 //echo $ACfilePath;
				  $lines = file($ACfilePath);
					...
					<ul class="breadcrumb">  
  <li>  
    <a href="javascript:void(0)" onclick="showMainMenu('<?= $lang?>','<?= $circle?>','eu')">Root</a> <span class="divider">/</span>  
  </li>  
			   ...
			   <!--- table box end here-->
				...
				<!--table align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1"  width="80%" class="table table-condensed table-bordered">
				 <thead>	<tr align='center'>
						<th style="padding-left: 5px;" bgcolor="#ffffff" height="35" width='20%' align='center'>DTMF12</th>
						<th style="padding-left: 5px;" bgcolor="#ffffff" height="35" align='center'>Category Name</th>
					</tr>
					 </thead-->
					<ul class="breadcrumb">  
  <li>  
   ...
   <li class="active">Music Unlimited</li> 
		     ...
		     <table class="table table-bordered">
					...
					//   http://10.2.73.156:8080/hungama/config/AMUconfig/splzone/mod/01_spzone.cfg
					$todaytime=date(jm);
...
{
//$mainsplzonefilePath="http://10.2.73.156:8080/hungama/config/AMUconfig/splzone/spconf/".$lang."00_".$spzoneCfile[1].".cfg";
$mainsplzonefilePath=$lang."00_".$spzoneCfile[1];
}
}

//echo $mainsplzonefilePath;
 		/*		$lines_splzone = file($SPLZONEFilePath); 
				$muSPLZONeDataValue = array();
				foreach ($lines_splzone as $muSPLZONeData) {
					echo $muSPLZONeData."<br>";
				}	   
			*/		   
...
<li>  
 ...
 <li class="active"><?= $catname;?></li> 
					...
					<table align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1"  width="80%" class="table table-condensed table-bordered">
						...
						<?php $k=1; for($i=0; $i<count($acClipDataValue); $i++) { if($acClipDataValue[$i]) { ?>
						<tr>
		...
		<!--a href="showContent.php?clip=<?php echo trim($acClipDataValue[$i]);?>&circle=<?php echo $circle;?>&lang=<?php echo $lang;?>&cat=ac"><?php echo $acClipDataValue[$i];?>-->
...
<a href="#" onclick="showMUCateData('mu','<?php echo $circle;?>','<?php echo $lang;?>','Other Categories','<?= $startfrom+1 ?>');"><?php echo 'Other Categories';?></a>
</td-->
								<?php }
								//echo "<td>&nbsp;</td>";
								   }
...
<li>  
 ...
 ?>
				...
				<table align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1"  width="80%" class="table table-condensed table-bordered">
					...
					<!--a href="showContent.php?cat=mu&clip=<?php echo trim($muCatValue[$j]);?>&circle=<?php echo $circle;?>&lang=<?php echo $lang;?>"><?php echo $album;?></a-->
...
<a href="javascript:void(0);" onclick="showDevoContent_main('devo','<?php echo $circle;?>','<?php echo $lang;?>','<?php echo $catData?>','<?php echo $religion;?>')">
<?php
