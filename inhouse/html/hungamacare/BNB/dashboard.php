                ...
                <div class="tab-pane active" id="pills-basic">
                    <div class="tabbable">
                        <ul class="nav nav-pills">
						 ...
						 <li><a href="#ivr" data-toggle="tab" data-act="ivr" onclick="javascript:viewSMSKeyboardhistory('ivr')">IVR</a></li>
						 <li><a href="#dash" data-toggle="tab" data-act="dash" onclick="javascript:viewSMSKeyboardhistory('dash')">Dashboard </a></li>
						</ul>
...
<!--IVR section start here-->
					 <div id="ivr" class="tab-pane">
					 <table class="table table-bordered table-condensed">
					 <tr><td><h2>IVR- Coming Soon</h2> </td> </tr>
					</table>
					   <div id="grid-ivr"></div>				
					 </div>		

<!--IVR section end here-->

<!--Dashboard section start here-->
					<div id="dash" class="tab-pane">
					 <table class="table table-bordered table-condensed">
					 <tr><td><h2>Dashboard- Coming Soon</h2> </td> </tr>
					</table>
