...
echo "file uploading start here 1";
...
echo "file uploading start here 2";
        if (!empty($aFile)) {
...
echo "file uploading start here 3";
...
function checkForErrorFileUploaded($oFile)
{
	...
	if (PEAR::isError($oFile)) {
	    phpAds_PageHeader(1);
	phpAds_Die($GLOBALS['strErrorOccurred'], htmlspecialchars($oFile->getMessage()). "<br>Please make sure you selected a valid file1.");
	}
