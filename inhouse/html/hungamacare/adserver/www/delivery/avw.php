...
###CODE EMBED
$getcircle=$_GET['circle'];
$mwidth=$_GET['mwidth'];
$mheight=$_GET['mheight'];
if(!empty($getcircle))
{
$precondition ="and d.location IN ('".$getcircle."') ";
}
else{
...
if(!empty($mwidth))
{
$precondition =" and d. width='".$mwidth."'";
}
else{
...
{
MAX_commonRegisterGlobalsArray(array('context', 'source', 'target', 'withText', 'withtext', 'ct0', 'what', 'loc', 'referer', 'zoneid', 'campaignid', 'bannerid', 'clientid', 'charset', 'circle'));
global $circle,$context, $source, $target, $withText, $withtext, $ct0, $what, $loc, $referer, $zoneid, $campaignid, $bannerid, $clientid, $charset;
...
$circle = (isset($circle) && (!empty($circle)) && (!strpos($circle, chr(32))) ? $circle : 'UTF-8' );
