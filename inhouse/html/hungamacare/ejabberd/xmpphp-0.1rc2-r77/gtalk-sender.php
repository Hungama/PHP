...
//check for verification of mobile number end here
  ...
  switch($keyword)
			...
			case '1':
						...
						{
						$push_message='Hi '.$sname[0].', Welcome to Uninor Music Unlimited My Tunes Chat.'.PHP_EOL;
						$push_message.='Results:'.PHP_EOL;
						$push_message.=$message.PHP_EOL;
						$push_message.='Reply with Song No. 1 - 5 for setting the My Tunes. You can also call 52222 to hear Unlimited Music and set Unlimited My Tunes.';
						}
						...
						{
						//$push_message='Hi mr '.$sname[0].',Pls send Ur Mobile number to set '.$response_message[1];
						$push_message='To set this song '.$response_message[1].' as My Tunes, reply with your Uninor mobile number';
						...
						{
						$push_message='Hi '.$sname[0].',Pls reply with valid option ';
						}
						}
			break;
		case '2':
		...
		$updatecurrentstatusinfo = file_get_contents($updatemessagestatus);
		$push_message='We have received your request to set '.$settunefor.' as your My Tunes.';
...
$push_message.='Mobile number must be 10 characters length.';
