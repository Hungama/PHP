...
$conn = new XMPPHP_XMPP('chat.facebook.com', 5222, 'uninormu@gmail.com', 'hungama1234', 'xmpphp', 'facebook.com', $printlog=True, $loglevel=XMPPHP_Log::LEVEL_INFO);
//
try {
    $conn->connect();
    $conn->processUntil('session_start');
    $conn->presence();
   $conn->message('satay.csjm@gmail.com', 'Welcome in test FB chat.');
  /* while(1)
   {
