...
$password = "PRNdxaUltYWZm4l5pqkPlCZRzRg=";      // A server generated Password you received from WhatsApp. This can NOT be manually created
...
$result=$w->sendMessage($target, "Sent from WhatsApi at " . time());
print_r($result);
/**
