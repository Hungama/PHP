...
$filepath="http://119.82.69.212/hungamacare/whatsapp/WhatsAPI-master/WhatsAPI-master/src/php/Gift/1157474.jpg";
//$result=$w->sendMessageImage($target, "http://repos.hungama.com/wallpaper/display%20image/130x130%20jpeg/1157474.jpg", "hero.jpg", 84712, $icon);
//$result=$w->SendMessageImage($target, $filepath );
$result=$w->SendMessageImage($target, '1157474.jpg' );
print_r($result);
}
