...
document.getElementById('alert_placeholder').style.display='inline';
  var catname=document.forms[type]["form_song_categoryname"].value;
   ...
   var obd_form_circle=document.forms[type]["obd_form_circle"].value;
    var form_songname_1=document.forms[type]["form_songname_1"].value;
	 var form_truetoneid_1=document.forms[type]["form_truetoneid_1"].value;
  ...
  else if (form_songname_1==null || form_songname_1=="")
  {
  bootstrap_alert.warning('Please eneter Song Name.');
  return false;
  }
    else if (form_truetoneid_1==null || form_truetoneid_1=="0")
  {
  bootstrap_alert.warning('Please select application.');
  return false;
  }
  $('#loading').show();
showhideMessageBox();
...
<body onload="javascript:viewUploadhistory('ussd2')">
...
<div class="tab-pane active" id="pills-basic">
					 ...
					 <li><a href="#menu" data-toggle="tab" data-act="menu" onclick="javascript:viewUploadMenuhistory('menu')">Menu </a></li>
...
<tr>
 ...
 <div id="menu" class="tab-pane">
		...
		<option value="">Select USSD String</option>
		<option value="*546*9*1#">*546*9*1#</option>
		<option value="*546*9*2#">*546*9*2#</option>
		<option value="*546*9*3#">*546*9*3#</option>
		<option value="*546*9*4#">*546*9*4#</option>
		<option value="*546*9*5#">*546*9*5#</option>
		<option value="*546*9*6#">*546*9*6#</option>
		<option value="*546*9*7#">*546*9*7#</option>
		<option value="*546*9*8#">*546*9*8#</option>
		<option value="*546*9*9#">*546*9*9#</option>
		</select>
		</td></tr>
...
?>                    </select>
      ...
      <td align="left">Song Name: <input type="text" class="text" name="form_songname_1" id="form_songname_1" value=""/></td>
		<td align="left">Application&nbsp;
		<select class="form_truetoneid_1" name='form_truetoneid_1' id="form_truetoneid_1">
		<option value="0">Select application</option>
		<?php
		$get_appname_query=mysql_query("select distinct application from master_db.tbl_circle_cli_mapping_unim order by application ASC");
		while($data=mysql_fetch_array($get_appname_query))
		{
		?>
		 <option value="<?php echo $data['application'];?>"><?php echo $data['application'];?></option>
		 <?php
		 }?>
		</select>
		<!--input type="text" class="text" name="form_truetoneid_1" id="form_truetoneid_1" value=""/-->
		
		<!--a href="Javascript:void(0)" onclick="showmore('setmenu2')">Add More</a-->
		</td>
         </tr>
		 
		<!--tr id="setmenu2" style="display:none"><td>2<input type="hidden" name="form_songname_2_id" id="form_songname_2_id" value="2"/></td>
        <td  align="left">Song Name: <input type="text" class="text" name="form_songname_2" id="form_songname_2" value=""/></td>
		<td  align="left">Prompt ID: <input type="text" class="text" name="form_truetoneid_2" id="form_truetoneid_2" value=""/>
		<a href="Javascript:void(0)" onclick="showmore('setmenu3')">Add More</a>
		</td>
		</tr>
		
		<tr id="setmenu3" style="display:none"><td>3<input type="hidden" name="form_songname_3_id" id="form_songname_3_id" value="3"/></td>
      <td align="left">Song Name: <input type="text" class="text" name="form_songname_3" id="form_songname_3" value=""/></td>
		<td align="left">Prompt ID: <input type="text" class="text" name="form_truetoneid_3" id="form_truetoneid_3" value=""/></td>
        </tr-->
				
		<tr>
 		<td colspan="3">
				<input type="hidden" name="post_for" id="post_for" value="MENU"/>
				<button class="btn btn-primary" style="float:right">Submit</button>
				</td>
                </tr>
...
$('#loading').hide();
	...
	$.fn.GetUploadMenuHistory = function(type) {
//$('#loading').show();
		$.ajax({
	...
	$.fn.GetUploadOBDHistory = function(type) {
		$.ajax({
