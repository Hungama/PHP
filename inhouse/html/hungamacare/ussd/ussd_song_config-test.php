...
<div class="tab-pane active" id="pills-basic">
							<div class="tabbable">
							  ...
							  <li><a href="#obd" data-toggle="tab" data-act="OBD" onclick="viewUploadhOBD('ussd')">Upload OBD</a></li>
						   </ul>
 ...
 <div id="grid-active">
								    ...
								    <div id="obd" class="tab-pane obd">
                                 	<form id="form-obd" name="form-obd" method="post" enctype="multipart/form-data">
									<table class="table table-bordered table-condensed">
		<tr><td>OBD Name</td><td colspan="2"><input type="text" name="obd_name" id="obd_name" value=""/></td></tr>
		<tr><td>Description</td>
      <td align="left"><input type="text" class="text" name="obd_description" id="obd_description" value=""/></td>
		  </tr>
		<tr><td>Browse File To Upload</td>
      <td align="left">
...
document.getElementById('alert_placeholder').style.display='none';
 var formData = new FormData($("form#form-obd")[0]);
     $.ajax({
        url: 'ussd_obd_upload_process.php',
        type: 'POST',
        data: formData,
        async: false,
	...
	//document.getElementById('form-obd').reset();
	//viewUploadhistory('ussd');
	        },
        cache: false,
        contentType: false,
