...
<div class="tab-pane active" id="pills-basic">
							<div class="tabbable">
							  ...
							  <li class="active"><a href="#active" data-toggle="tab" data-act="activation" onclick="javascript:viewUploadhistory('ussd')">USSD</a></li>
						   </ul>
...
<fieldset>
                  <div class="control-group">
					...
					<!--input type="text" name="schedule_start_time" id="schedule_start_time" value="<?php echo date("H/i/s");?> - <?php echo date("H/i/s");?>" /-->
                     </div>
                    </div>
                  </div>
                 </fieldset>
