...
<form name="frm" method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>" onSubmit="return checkfield()" enctype="multipart/form-data">
		...
		<tr class="bg">
			<td class="first" bgcolor="#FFFFFF"><B>Browse File To Upload <FONT COLOR="#FF0000">[.txt file]</B><span style="color:red">&nbsp;*</span><br/>&nbsp;&nbsp;&nbsp;(text file must contain one 10 digit msisdn per line)</FONT></td>
			<td class="last" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<INPUT name="upfile" id='upfile' type="file" class="in"></td>
		  </tr>
					<tr class="bg">
