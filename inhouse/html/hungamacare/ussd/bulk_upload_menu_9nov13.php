...
document.getElementById('alert_placeholder').style.display='inline';
  ...
  return false;
    ...
    else if (form_truetoneid_1==null || form_truetoneid_1=="")
  {
  bootstrap_alert.warning('Please eneter Prompt ID.');
  return false;
  }
  $('#loading').show();
showhideMessageBox();
...
?>                    </select>
      ...
      <td align="left">Song Name: <input type="text" class="text" name="form_songname_1" id="form_songname_1" value=""/></td>
		<td align="left">Prompt ID: <input type="text" class="text" name="form_truetoneid_1" id="form_truetoneid_1" value=""/>
