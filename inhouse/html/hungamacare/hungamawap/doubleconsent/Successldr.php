...
$saveLiveMisWAPLogs = "http://119.82.69.212/kmis/services/hungamacare/2.0/wap/saveLiveWAPlogs.php?zone_id=".$zoneid."&msisdn=".$msisdn."&msg=".urlencode($RESULT)."&afid=".$afid."&circle=".$circle."&service=WAPUninorLDR1&type=ccgresponse";
