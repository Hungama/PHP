...
$configs = array(
            array( "base_url" => "http://172.16.6.6:13000",
                   "status_passwd" => "changemetoo",
                   "admin_passwd" => "changemenow",
                   "name" => "Kannel Gateway 1"
                 ),
           array( "base_url" => "http://172.16.6.1:13000",
                   "status_passwd" => "changemetoo",
                   "admin_passwd" => "changemenow",
                   "name" => "Kannel Gateway 2"
                 ),
		   array( "base_url" => "http://172.16.6.4:13000",
                   "status_passwd" => "changemetoo",
                   "admin_passwd" => "changemenow",
                   "name" => "Kannel Gateway 3"
                 ),
				
				 /*  array( "base_url" => "http://192.168.1.172:13000",
                   "status_passwd" => "changemetoo",
                   "admin_passwd" => "changemenow",
                   "name" => "Kannel Gateway 4"
                 ),
...
<tr><td valign=top>
  <h3>Mobile2Win Kannel Status Monitor</h3>
...
<tr><td valign=top align=right class=text>
    ...
    <?php
        ...
        foreach ($configs as $inst => $config) {
            ...
            $sum += $mt_q[$inst];
			if ($mt_q[$inst] > $CONST_QUEUE_ERROR) {
            echo "<span class=red> ($inst) ".nf($mt_q[$inst])." msgs<br />\n";
			//echo "<span class=red>".nf($sum)." msgs</span>";
			 } else {
            //echo nf($sum)." msgs";
