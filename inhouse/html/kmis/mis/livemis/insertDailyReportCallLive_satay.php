...
$file_process_status = 'insertDailyReportCallLive_satay process file- Start#datetime#' . date("Y-m-d H:i:s") . "\r\n";
...
$view_date1='2013-10-30';
echo $DateFormat[0] = '2013-10-30 16:00:00';
if($_GET['time']) {
	echo $DateFormat[0] = $_GET['time'];
}

$service_array = array('TataDocomoMX','MTVTataDoCoMo','TataDoCoMo54646','TataDoCoMoFMJ','Reliance54646','MTVReliance','RelianceCM','MTVUninor','Uninor54646', 'RedFMUninor','TataIndicom54646','TataDoCoMoMXcdma','MTVTataIndicom','TataDoCoMoFMJcdma','RIATataDoCoMocdma','RIATataDoCoMo','RiaUninor','TataDocomoMXVMI', 'Aircel54646','RIATataDoCoMovmi','RedFMTataDoCoMo','UninorRT','REDFMTataDoCoMocdma','REDFMTataDoCoMovmi','UninorAstro','AAUninor','UninorSU','UninorComedy','UninorContest');
...
$call_tf_query="select 'CALLS_TF',circle, count(id),'1001' as service_name,date(call_date) from mis_db.tbl_radio_calllog 
where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) 
and dnis like '59090%' and operator in ('TATM') group by circle 
UNION
...
UNION
select 'CALLS_TF',circle, count(id),'1009' as service_name,date(call_date) from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis=5464626 and operator ='tatm' group by circle
UNION
select 'CALLS_TF',circle, count(id),'1003' as service_name,date(call_date) from mis_db.tbl_mtv_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis like '546461%' and operator='tatm' group by circle
UNION
select 'CALLS_TF',circle, count(id),'1005' as service_name,date(call_date) from mis_db.tbl_starclub_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis in ('56666')  and operator='tatm' group by circle
UNION
select 'CALLS_TF',circle, count(id),'1010' as service_name,date(call_date) from mis_db.tbl_starclub_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis=55935 and operator ='tatm' group by circle
UNION
...
$call_t_query="select 'CALLS_T',circle, count(id),'1002' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and (dnis = '54646' or dnis like '546464%' or dnis like '546465%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%') and dnis not in('5464669','5464668') and operator ='tatm' group by circle
UNION
select 'CALLS_T',circle, count(id),'1009' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis in('5464669','5464668') and operator ='tatm' group by circle,dnis
UNION
select 'CALLS_T',circle, count(id),'1602' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and (dnis like '54646' or dnis like '546464%' or dnis like '546465%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%') and dnis not in('5464669','5464668') and operator in('TATC') group by circle,dnis
UNION
select 'CALLS_T',circle, count(id),'1609' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis in('5464669','5464668') and operator in('TATC') group by circle,dnis
UNION
...
UNION
select 'CALLS_T',circle, count(id),'1208' as service_name,date(call_date),dnis from mis_db.tbl_cricket_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis in(54433,544337,5443322,5443333,544334,5443344) and operator in('relm','relc') group by circle,dnis
UNION
select 'CALLS_T',circle, count(id),'1202' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and (dnis like '54646' or dnis like '546464%' or dnis like '546465%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%') and operator in('relm','relc') group by circle,dnis
UNION
select 'CALLS_T',circle, count(id),'1402' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and  (dnis = '54646' or dnis like '546464%' or dnis like '546465%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%') and operator ='unim' group by circle,dnis
UNION
select 'CALLS_T',circle, count(id),'1409' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis= '5464669' and operator ='unim' group by circle,dnis
UNION
select 'CALLS_T',circle, count(id),'1902' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)=date('$DateFormat[0]' - INTERVAL 60 MINUTE) and call_time between time('$DateFormat[0]' - INTERVAL 60 MINUTE) and time('$DateFormat[0]' - INTERVAL 1 second) and dnis like '54646%' and operator in('airc') group by circle,dnis"; 
...
if ($numRows12 > 0)
{
	while($call_t = mysql_fetch_array($call_t_result))
	{
		...
		$insert_call_t_data1="insert into misdata.livemis(Date,Service,Circle,Type,Value,Revenue) values('$DateFormat[0]','$service_name', '".$circle_info[strtoupper($call_t[1])]."','$call_type','$call_t[2]',0)";
...
if ($numRows12 > 0)
{
	while($pulse_t = mysql_fetch_array($pulse_t_result1))
	{
		...
		$insert_pulse_t_data1="insert into misdata.livemis(Date,Service,Circle,Type,Value,Revenue) values('$DateFormat[0]','$service_name', '".$circle_info[strtoupper($pulse_t[1])]."','$pulse_type','$pulse_t[2]',0)";
...
$file_process_status = 'insertDailyReportCallLive_satay process file- End#datetime#' . date("Y-m-d H:i:s") . "\r\n";
error_log($file_process_status, 3, $processlog);
echo "generated";
// end 
