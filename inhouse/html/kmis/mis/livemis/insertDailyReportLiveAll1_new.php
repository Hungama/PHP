...
and service_id in(1001,1002,1003,1009,1202,1203,1208,1402,1403,1410,1601,1602,1603,1605,1607,1609,1801,1409,1809,1010,1610,1810,1416,1408,1418,1423) 
...
in (1001,1002,1003,1009,1202,1203,1208,1402,1403,1410,1601,1602,1603,1605,1607,1609,1801,1409,1809,1010,1610,1810,1416,1408,1418,1423) 
...
where date_time between DATE_SUB('$DateFormat[0]', INTERVAL 1 HOUR) and '$DateFormat[0]' 
and service_id IN (1402,1403,1410,1409,1416,1408,1418,1423) group by circle,event_type,plan_id,status";
...
where date_time between DATE_SUB('$DateFormat[0]', INTERVAL 1 HOUR) and '$DateFormat[0]' 
and service in('1402,1408,1418')
and consent='firstconsent' and response ='OK' group by circle,service,consent order by consent
union
select count(ANI),circle,service ,consent 
from Inhouse_IVR.tbl_consent_log_tata
where date_time between DATE_SUB('$DateFormat[0]', INTERVAL 1 HOUR) and '$DateFormat[0]' 
and service in('1602,1002')
and consent='firstconsent' and response ='OK' group by circle,service,consent order by consent";
//union
//select count(ANI),circle,service ,consent 
//from Inhouse_IVR.tbl_consent_log_rel
//where date_time between DATE_SUB('$DateFormat[0]', INTERVAL 1 HOUR) and '$DateFormat[0]' 
//and service in()
//and consent='firstconsent' and response ='OK' group by circle,service,consent order by consent";
