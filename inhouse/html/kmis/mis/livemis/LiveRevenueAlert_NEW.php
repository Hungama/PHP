...
{
	$getMsisdn="select msisdn,circle,serviceName,alert,cli from master_db.tbl_sms_auto where serviceName='".$summarydata[2]."' and circle!='PAN' and alert='S'";
...
{
	$getPanMsisdn="select msisdn,circle,serviceName,alert,cli from master_db.tbl_sms_auto where serviceName='".$summaryPdata[2]."' and circle='PAN' and alert='S'";
	...
	//echo "<br>".$messageWrite; 
	//fwrite($mf1,$messageWrite);
	//fclose($mf1);
}
