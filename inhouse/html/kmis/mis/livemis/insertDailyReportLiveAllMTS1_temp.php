...
error_reporting(1);
//regenerate livemis of previous day start here 
if (date('H') == '3') {
    $PrvDateLiveMIS = "http://192.168.100.212/kmis/mis/livemis/MTS_LIVEKPI_NOCNS.php";
    file_get_contents($PrvDateLiveMIS);
    exit;
}
//end here
