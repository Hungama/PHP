...
//echo $DateFormat[0] = '2013-07-30 00:00:00';

if($_GET['time']) {
	echo $DateFormat[0] = $_GET['time'];
}

$service_array = array('TataDocomoMX','MTVTataDoCoMo','TataDoCoMo54646','TataDoCoMoFMJ','Reliance54646','MTVReliance','RelianceCM','MTVUninor','Uninor54646', 'RedFMUninor','TataIndicom54646','TataDoCoMoMXcdma','MTVTataIndicom','TataDoCoMoFMJcdma','RIATataDoCoMocdma','RIATataDoCoMo','RiaUninor','TataDocomoMXVMI', 'Aircel54646','RIATataDoCoMovmi','RedFMTataDoCoMo','UninorRT','REDFMTataDoCoMocdma','REDFMTataDoCoMovmi','UninorAstro','AAUninor','UninorSU','UninorComedy');
