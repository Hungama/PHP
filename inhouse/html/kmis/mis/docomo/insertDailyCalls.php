...
$call_tf = array();
$call_tf_query = "select 'CALLS_TF',circle, count(id),'endless' as service_name,date(call_date),status from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and dnis like '59090%' and dnis not like '590902%' and dnis not like '590905%' and operator in ('TATM') group by circle,status";
...
$call_tf = array();
$call_tf_query = "select 'CALLS_TF',circle, count(id),'endless' as service_name,date(call_date) from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and dnis like '59090%' and dnis not like '590902%' and dnis not like '590905%' and operator in ('TATM') group by circle";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
...
$call_tf = array();
$call_tf_query = "select 'CALLS_T_6',circle, count(id),'endless' as service_name,date(call_date),status from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and (dnis like '590902%' or dnis like '590905%') and operator in ('TATM') group by circle,status";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
...
$call_tf = array();
$call_tf_query = "select 'CALLS_T_6',circle, count(id),'endless' as service_name,date(call_date) from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and ( dnis like '590902%' or dnis like '590905%') and operator in ('TATM') group by circle";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
...
$call_tf = array();
$call_tf_query = "select 'CALLS_T_6',circle, count(id),'Docomo54646' as service_name,date(call_date),status from mis_db.tbl_54646_calllog where date(call_date)='$view_date1'  and  (dnis = '54646' or dnis like '546464%' or dnis like '546465%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%') and dnis not in ('5464669','5464668') and dnis not like '5464669%'  and dnis not like '%P%' and operator ='tatm' group by circle,status";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
        ...
        elseif (strtoupper($call_tf[1]) == 'HAR')
            $call_tf[1] = 'HAY';
        if ($call_tf[5] == 1)
            $callTStr1 = 'L_CALLS_T_6';
        elseif ($call_tf[5] != 1)
            $callTStr1 = 'N_CALLS_T_6';
        $insert_call_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,
...
$call_tf = array();
$call_tf_query = "select 'CALLS_T_1',circle, count(id),'Docomo54646' as service_name,date(call_date),dnis,status from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis in ('5464668') and operator ='tatm' group by circle,dnis,status";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
...
$call_tf = array();
$call_tf_query = "select 'CALLS_T_1',circle, count(id),'Docomo54646' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis in ('5464668') and operator ='tatm' group by circle,dnis";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
...
$call_tf = array();
$call_tf_query = "select 'CALLS_T_6',circle, count(id),'Docomo54646' as service_name,date(call_date),dnis,status from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis like '5464669%' and operator ='tatm' group by circle,dnis,status";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
...
$call_tf = array();
$call_tf_query = "select 'CALLS_T_6',circle, count(id),'Docomo54646' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis like '5464669%' and operator ='tatm' group by circle,dnis";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
...
//////////////////////End code to insert the data for call_tf for Tata Docomo GL ///////////////////////////////////////////////////////////////////
////////////////////////////start code to insert the data for call_tf for TataDoCoMoMND///////////////////////////////////////////////////////////////////
$call_tf = array();
$call_tf_query = "select 'CALLS_TF',circle, count(id),'TataDoCoMoMND' as service_name,date(call_date) from mis_db.tbl_mnd_calllog 
...
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
        ...
        elseif (strtoupper($call_tf[1]) == 'HAR')
            $call_tf[1] = 'HAY';
        $insert_call_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,
                total_sec) values ('$view_date1', '$call_tf[0]','$call_tf[1]','0','$call_tf[2]','','1013','NA','NA','NA')";
        $queryIns_call = mysql_query($insert_call_tf_data, $dbConn);
    }
}

$call_tf = array();
$call_tf_query = "select 'CALLS_TF',circle, count(id),'TataDoCoMoMND' as service_name,date(call_date),status from mis_db.tbl_mnd_calllog 
...
if ($numRows1 > 0) {
    while ($call_tf = mysql_fetch_array($call_tf_result)) {
        ...
        $insert_call_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,
                total_sec) values('$view_date1', '$callStr','$call_tf[1]','0','$call_tf[2]','','1013','NA','NA','NA')";
        $queryIns_call = mysql_query($insert_call_tf_data, $dbConn);
    }
}
//////////////////////////////End code to insert the data for call_tf for TataDoCoMoMND///////////////////////////////////////////////////////////////////
?>