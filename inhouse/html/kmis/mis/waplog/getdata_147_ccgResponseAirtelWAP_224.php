...
$serviceArray=array('1509074'=>'AirtelMND','1508786'=>'AirtelEU','1508709'=>'AirtelEU','1509109'=>'AirtelGL','1508450'=>'Airtel54646','1509125'=>'AirtelDevo','1508630'=>'AirtelDevo','1515680'=>'AirtelGL','1515679'=>'AirtelGL','1515678'=>'AirtelGL','1515677'=>'AirtelGL','1515676'=>'AirtelGL','1515675'=>'AirtelGL','1515684'=>'AirtelGL','1515683'=>'AirtelGL','1515682'=>'AirtelGL','1515681'=>'AirtelGL','1515674'=>'AirtelGL');
 ...
 $sql_waplog="INSERT INTO mis_db.tbl_browsing_wap (zoneid,datetime,msisdn,remoteaddress,useragent,chargingurlfired,response,planid,mode,service,hitip,referer,datatype)
VALUES ('".$zoneid_db."','".$datetime_db."','".$msisdn_db."','".$remoteaddress_db."','".mysql_real_escape_string($useragent_db)."','".trim($chargingurlfired_db)."','".$response_db."','".$planid_db."','".$mode_db."','".$service_name."','".$hitip_db."','".$referer_db."','ccgresponse')";
