<html>
    <head>
        ...
        <title>Hourly Waplog Report Affilaited Id Alert </title>
    </head>
    <body>
        <?php
        $prevdate = date("Y-m-d");
        ...
        require '/var/www/html/kmis/mis/waplog/contents_affiddata_hourly.php';
...
//Set the subject line
        $mail->Subject = ' Daily Waplog Report Affilaited Id Hourly Count Of date- ' . $prevdate;
