...
$serviceArray=array('AircelMC'=>'Aircel - Music Connect','AircelMU'=>'Aircel - Limitless Music','AircelStore'=>'Aircel Store', 'BSNL'=>'BSNL Store', 'TataDoCoMoADT'=>'Docomo Store', 'TataDoCoMoMND'=>'Tata DoCoMo - Pyaar Ke Panne','TataDoCoMoMX'=>'Tata DoCoMo - Endless Music','VodafoneMU'=>'Vodafone - Radio Unlimited'
	...
	'RIATataDoCoMo'=>'RIATataDoCoMo','TataDoCoMoADTYoga'=>'TataDoCoMoADTYoga','TataDoCoMoADTVideo'=>'TataDoCoMoADTVideo',
	'TataDoCoMoADTCurves'=>'TataDoCoMoADTCurves','TataDoCoMoADTFTV'=>'TataDoCoMoADTFTV','TataDoCoMoADTHANG'=>'TataDoCoMoADTHANG');
...
$vendorarray=array('1010'=>'Adiquity','1020'=>'Google','1030'=>'Reporo','1040'=>'Tyro','1050'=>'Vserve',
	...
	'26'=>'NewMedia','33'=>'NewMedia_Adiquity','34'=>'NewMedia_Google','35'=>'NewMedia_Reporo','36'=>'NewMedia_Tyro',
	'37'=>'NewMedia_Vserv','38'=>'NewMedia_Adtriva','39'=>'NewMedia_BuzzCity','40'=>'NewMedia_kratos','41'=>'NewMedia_Collectcent');


$gettotalcountdatasql=mysql_query("select count(1) as total,service,affiliateid from misdata.tbl_browsing_wap nolock 
where date(datetime)='".$prevdate."' and service not in('AirtelDevo','UninorMyMusic','UninorSU','WAP') 
and affiliateid!=0  and (length(affiliateid) = 4 or length(affiliateid) = 2) group by service,affiliateid order by service",$con);
...
//new added service//
$RIATataDoCoMo=array();
$TataDoCoMoADTYoga=array();
$TataDoCoMoADTVideo=array();
$TataDoCoMoADTCurves=array();
$TataDoCoMoADTFTV=array();
$TataDoCoMoADTHANG=array();
...
elseif($sname=='RIATataDoCoMo')
{
    $RIATataDoCoMo[$result['affiliateid']]=$result[total];
}
elseif($sname=='TataDoCoMoADTYoga')
{
    $TataDoCoMoADTYoga[$result['affiliateid']]=$result[total];
}
elseif($sname=='TataDoCoMoADTVideo')
{
    $TataDoCoMoADTVideo[$result['affiliateid']]=$result[total];
}
elseif($sname=='TataDoCoMoADTCurves')
{
    $TataDoCoMoADTCurves[$result['affiliateid']]=$result[total];
}
elseif($sname=='TataDoCoMoADTFTV')
{
    $TataDoCoMoADTFTV[$result['affiliateid']]=$result[total];
}
elseif($sname=='TataDoCoMoADTHANG')
{
    $TataDoCoMoADTHANG[$result['affiliateid']]=$result[total];
}
...
$message .= '<table border="1" cellspacing="0" cellpadding="2" style="font-family: Century Gothic, Arial">';
 $message .= "<tr><td colspan='4' align='center' >Waplog Report Affilaited Id Count</td></tr>";
 
$message .= '<tr><td  valign="middle" bgcolor="#FFFFFF" style="border-bottom: 1px solid #666; border-right: 1px solid #666; border-top: 1px solid #666;border-left: 1px solid #666"><strong>Service Name</strong> </td><td valign="middle" bgcolor="#FFFFFF" style="border-bottom: 1px solid #666; border-right: 1px solid #666; border-top: 1px solid #666;border-left: 1px solid #666"><strong>Affiliated Id</strong> </td><td valign="middle" bgcolor="#FFFFFF" style="border-bottom: 1px solid #666; border-right: 1px solid #666; border-top: 1px solid #666;border-left: 1px solid #666"><strong>Vendor Name</strong> </td><td valign="middle" bgcolor="#FFFFFF" style="border-bottom: 1px solid #666; border-right: 1px solid #666; border-top: 1px solid #666;border-left: 1px solid #666"><strong>Total Count</strong> </td></tr>';

$count=count($AircelMC);
if($count>1)
{
    $message .= "<tr style='background: #f2f2f2;'> <td ><strong>".$serviceArray['AircelMC']."</strong> </td><td colspan='6'><table style='border-color: #fffff;' border='0' width='100%' cellpadding='10'>";
...
// RIATataDoCoMo
$count=count($RIATataDoCoMo);
if($count>1)
{
    $message .= "<tr style='background: #ADD8E6;'> <td ><strong>".$serviceArray['RIATataDoCoMo']."</strong> </td><td colspan='6'><table style='border-color: #fffff;' border='0' width='100%' cellpadding='10'>";
    foreach($RIATataDoCoMo as $key=>$value)
    {
$message .= "<tr><td><strong>".$key."</strong> </td><td style='text-align:right'><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
...
foreach($RIATataDoCoMo as $key=>$value)
    {
$message .= "<tr style='background: #ADD8E6;'><td><strong>".$serviceArray['RIATataDoCoMo']."</strong></td><td><strong>".$key."</strong> </td><td><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
...
// TataDoCoMoADTYoga
$count=count($TataDoCoMoADTYoga);
if($count>1)
{
    $message .= "<tr style='background: #ADD8E6;'> <td ><strong>".$serviceArray['TataDoCoMoADTYoga']."</strong> </td><td colspan='6'><table style='border-color: #fffff;' border='0' width='100%' cellpadding='10'>";
    foreach($TataDoCoMoADTYoga as $key=>$value)
    {
$message .= "<tr><td><strong>".$key."</strong> </td><td style='text-align:right'><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
...
foreach($TataDoCoMoADTYoga as $key=>$value)
    {
$message .= "<tr style='background: #ADD8E6;'><td><strong>".$serviceArray['TataDoCoMoADTYoga']."</strong></td><td><strong>".$key."</strong> </td><td><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
        
    }
}

// TataDoCoMoADTVideo
$count=count($TataDoCoMoADTVideo);
if($count>1)
{
    $message .= "<tr style='background: #ADD8E6;'> <td ><strong>".$serviceArray['TataDoCoMoADTVideo']."</strong> </td><td colspan='6'><table style='border-color: #fffff;' border='0' width='100%' cellpadding='10'>";
    foreach($TataDoCoMoADTVideo as $key=>$value)
    {
$message .= "<tr><td><strong>".$key."</strong> </td><td style='text-align:right'><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
...
foreach($TataDoCoMoADTVideo as $key=>$value)
    {
$message .= "<tr style='background: #ADD8E6;'><td><strong>".$serviceArray['TataDoCoMoADTVideo']."</strong></td><td><strong>".$key."</strong> </td><td><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
        
    }
}

// TataDoCoMoADTCurves
$count=count($TataDoCoMoADTCurves);
if($count>1)
{
    $message .= "<tr style='background: #ADD8E6;'> <td ><strong>".$serviceArray['TataDoCoMoADTCurves']."</strong> </td><td colspan='6'><table style='border-color: #fffff;' border='0' width='100%' cellpadding='10'>";
    foreach($TataDoCoMoADTCurves as $key=>$value)
    {
$message .= "<tr><td><strong>".$key."</strong> </td><td style='text-align:right'><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
...
foreach($TataDoCoMoADTCurves as $key=>$value)
    {
$message .= "<tr style='background: #ADD8E6;'><td><strong>".$serviceArray['TataDoCoMoADTCurves']."</strong></td><td><strong>".$key."</strong> </td><td><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
...
// TataDoCoMoADTFTV
$count=count($TataDoCoMoADTFTV);
if($count>1)
{
    $message .= "<tr style='background: #ADD8E6;'> <td ><strong>".$serviceArray['TataDoCoMoADTFTV']."</strong> </td><td colspan='6'><table style='border-color: #fffff;' border='0' width='100%' cellpadding='10'>";
    foreach($TataDoCoMoADTFTV as $key=>$value)
    {
$message .= "<tr><td><strong>".$key."</strong> </td><td style='text-align:right'><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
...
foreach($TataDoCoMoADTFTV as $key=>$value)
    {
$message .= "<tr style='background: #ADD8E6;'><td><strong>".$serviceArray['TataDoCoMoADTFTV']."</strong></td><td><strong>".$key."</strong> </td><td><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
        
    }
}

// TataDoCoMoADTHANG
$count=count($TataDoCoMoADTHANG);
if($count>1)
{
    $message .= "<tr style='background: #ADD8E6;'> <td ><strong>".$serviceArray['TataDoCoMoADTHANG']."</strong> </td><td colspan='6'><table style='border-color: #fffff;' border='0' width='100%' cellpadding='10'>";
    foreach($TataDoCoMoADTHANG as $key=>$value)
    {
$message .= "<tr><td><strong>".$key."</strong> </td><td style='text-align:right'><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
...
foreach($TataDoCoMoADTHANG as $key=>$value)
    {
$message .= "<tr style='background: #ADD8E6;'><td><strong>".$serviceArray['TataDoCoMoADTHANG']."</strong></td><td><strong>".$key."</strong> </td><td><strong>".$vendorarray[$key]."</strong> </td><td style='text-align:right'><strong>".$value."</strong> </td></tr>";
