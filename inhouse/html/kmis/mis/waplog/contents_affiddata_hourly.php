...
$gettotalcountdatasql=mysql_query("select count(1) as total,service,affiliateid from mis_db.tbl_browsing_wap nolock where date(datetime)='$curdate' and service not in('AirtelDevo','UninorMyMusic','UninorSU','WAP','WAPAirtelLDR') and affiliateid!=0
and char_length(affiliateid) = 4 or  char_length(affiliateid) = 2 group by service,affiliateid order by service",$dbConn212);
...
$message .= '<table border="1" cellspacing="0" cellpadding="2" style="font-family: Century Gothic, Arial">';
 $message .= "<tr><td colspan='4' align='center' >Waplog Report Affilaited Id Count Hourly</td></tr>";
