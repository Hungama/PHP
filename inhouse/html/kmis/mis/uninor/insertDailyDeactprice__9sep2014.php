...
$get_deactivation_base = "select count(*),circle,status from Uninor_smspack.tbl_rich_alerts_sub where date(unsub_date)='$view_date1' 
group by circle";
$deactivation_base_query = mysql_query($get_deactivation_base, $dbConn) or die(mysql_error());
$numRows = mysql_num_rows($deactivation_base_query);
if ($numRows > 0) {
...
$get_deactivation_base = "select count(*),circle,status from Uninor_smspack.tbl_fashion_sub where date(unsub_date)='$view_date1' 
group by circle";
$deactivation_base_query = mysql_query($get_deactivation_base, $dbConn) or die(mysql_error());
$numRows = mysql_num_rows($deactivation_base_query);
if ($numRows > 0) {
