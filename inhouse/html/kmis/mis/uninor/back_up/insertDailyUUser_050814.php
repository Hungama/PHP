...
$uu_tf = array();
$uu_tf_query = "select 'UU_T',circle, count(distinct msisdn),'Uninor54646' as service_name,date(call_date) from mis_db.tbl_54646_calllog 
...
$uu_tf = array();
$uu_tf_query = "select 'UU_T_6',circle, count(distinct msisdn),'Uninor54646' as service_name,date(call_date) from mis_db.tbl_54646_calllog 
...
$uu_tf = array();
$uu_tf_query = "select 'UU_T_9',circle, count(distinct msisdn),'Uninor54646' as service_name,date(call_date) from mis_db.tbl_54646_calllog 
...
$uu_tf = array();
$uu_tf_query = "select 'UU_T_1',circle, count(distinct msisdn),'Uninor54646' as service_name,date(call_date) from mis_db.tbl_54646_calllog 
...
$uu_tf = array();
$uu_tf_query = "select 'UU_TF',circle, count(distinct msisdn),'UninorVAFilmy' as service_name,date(call_date) from mis_db.tbl_FilmiWords_calllog
