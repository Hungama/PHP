...
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and (item.dnis like '546460%' or item.dnis like '546461%' or item.dnis like '546462%' or item.dnis like '546463%'
...
from mis_db.tbl_54646_calllog item INNER JOIN(  SELECT msisdn  FROM mis_db.tbl_54646_calllog  where date(call_date) between '$last_7day_end' and '$last_7day_start'
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and (item.dnis like '%34P%' or dnis like '%47P%') and item.operator ='unim' group by item.circle,item.dnis";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
from mis_db.tbl_54646_calllog item INNER JOIN(  SELECT msisdn  FROM mis_db.tbl_54646_calllog  where date(call_date) between '$last_7day_end' and '$last_7day_start'
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and item.dnis='5464611' and item.operator ='unim' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and item.dnis='5464622' and item.operator ='unim' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
from mis_db.tbl_54646_calllog item INNER JOIN(  SELECT msisdn  FROM mis_db.tbl_54646_calllog  where date(call_date) between '$last_7day_end' and '$last_7day_start'
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and item.dnis like '5464630%' and item.operator ='unim' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
from mis_db.tbl_54646_calllog item INNER JOIN(  SELECT msisdn  FROM mis_db.tbl_54646_calllog  where date(call_date) between '$last_7day_end' and '$last_7day_start'
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and item.dnis IN ('5464628','5464626','5464669') and item.operator ='unim' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and item.dnis=55935 and item.operator ='unim' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and item.dnis in(546461) and item.operator ='unim' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1' and item.dnis like '52888%' and item.operator ='unim' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
from mis_db.tbl_54646_calllog item INNER JOIN(  SELECT msisdn  FROM mis_db.tbl_54646_calllog  where date(call_date) between '$last_7day_end' and '$last_7day_start'
)temp ON item.msisdn= temp.msisdn where date(item.call_date)='$view_date1'  and item.dnis like '5464627%' and item.operator ='unim' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
