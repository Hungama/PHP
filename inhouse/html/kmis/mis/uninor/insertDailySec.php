...
$sec_t = array();
$sec_t_query = "select 'SEC_T',circle, count(msisdn),'Uninor54646' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and (dnis like '54646' or dnis like '546464%' or dnis like '546465%' or dnis='5464646') and dnis not like '%P%' 
and operator in('unim') group by circle";
...
$sec_t = array();
$sec_t_query = "select 'SEC_T',circle, count(msisdn),'Uninor54646' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and (dnis like '54646' or dnis like '546464%' or dnis like '546465%' or dnis='5464646') and dnis not like '%P%' 
and operator in('unim') group by circle,status";
...
$sec_t = array();
$sec_t_query = "select 'SEC_T_6',circle, count(msisdn),'Uninor54646' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and  dnis like '546466%' and dnis!='5464669' and dnis not like '%P%' 
and operator in('unim') group by circle";
...
$sec_t = array();
$sec_t_query = "select 'SEC_T_6',circle, count(msisdn),'Uninor54646' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and  dnis like '546466%' and dnis!='5464669' and dnis not like '%P%' 
and operator in('unim') group by circle,status";
...
$sec_t = array();
$sec_t_query = "select 'SEC_T_9',circle, count(msisdn),'Uninor54646' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and  dnis like '546467%' and dnis not like '%P%' 
and operator in('unim') group by circle";
...
$sec_t = array();
$sec_t_query = "select 'SEC_T_9',circle, count(msisdn),'Uninor54646' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and  dnis like '546467%' and dnis not like '%P%'  
and operator in('unim') group by circle,status";
...
$sec_t = array();
$sec_t_query = "select 'SEC_T_1',circle, count(msisdn),'Uninor54646' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and  dnis like '546468%'  and dnis not like '%P%' 
and operator in('unim') group by circle";
...
$sec_t = array();
$sec_t_query = "select 'SEC_T_1',circle, count(msisdn),'Uninor54646' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1'  and  dnis like '546468%'  and dnis not like '%P%'  
and operator in('unim') group by circle,status";
...
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorKIJI' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_cricket_calllog where date(call_date)='$view_date1' and dnis like '52000%' and operator in('unim') group by circle,status";
...
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorRia' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis IN ('5464628', '66291428')  and operator in('unim') group by circle";
...
if ($numRows5 > 0) {
    $sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
    while ($sec_tf = mysql_fetch_array($sec_tf_result)) {
        $insert_sec_tf_data = "insert into mis_db.dailyReportUninor(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_tf[0]','$sec_tf[1]','0','$sec_tf[5]','','1413','NA','NA','NA')";
        $queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
    }
}

$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorRia' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis IN ('5464628', '66291428') and operator in('unim') group by circle,status";
...
////////////////////////////////////// start code to insert the data for SEC_TF  for UninorVABollyAlerts /////////////////////////////////////////////////////////
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVABollyAlerts' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_bollyalerts_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle";
...
if ($numRows5 > 0) {
    $sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
    while ($sec_tf = mysql_fetch_array($sec_tf_result)) {
        $insert_sec_tf_data = "insert into mis_db.dailyReportUninor(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_tf[0]','$sec_tf[1]','0','$sec_tf[5]','','1430','NA','NA','NA')";
        $queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
    }
}
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVABollyAlerts' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_bollyalerts_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle,status";
...
////////////////////////////////////// end code to insert the data for SEC_TF  for UninorVABollyAlerts /////////////////////////////////////////////////////////
////////////////////////////////////// start code to insert the data for SEC_TF  for UninorVAFilmy /////////////////////////////////////////////////////////
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVAFilmy' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_FilmiWords_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle";
...
if ($numRows5 > 0) {
    $sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
    while ($sec_tf = mysql_fetch_array($sec_tf_result)) {
        $insert_sec_tf_data = "insert into mis_db.dailyReportUninor(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_tf[0]','$sec_tf[1]','0','$sec_tf[5]','','1431','NA','NA','NA')";
        $queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
    }
}
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVAFilmy' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_FilmiWords_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle,status";
...
////////////////////////////////////// end code to insert the data for SEC_TF  for UninorVAFilmy /////////////////////////////////////////////////////////
////////////////////////////////////// start code to insert the data for SEC_TF  for UninorVABollyMasala /////////////////////////////////////////////////////////
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVABollyMasala' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_BollywoodMasala_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle";
...
if ($numRows5 > 0) {
    $sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
    while ($sec_tf = mysql_fetch_array($sec_tf_result)) {
        $insert_sec_tf_data = "insert into mis_db.dailyReportUninor(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_tf[0]','$sec_tf[1]','0','$sec_tf[5]','','1432','NA','NA','NA')";
        $queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
    }
}
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVABollyMasala' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_BollywoodMasala_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle,status";
...
////////////////////////////////////// end code to insert the data for SEC_TF  for UninorVABollyMasala /////////////////////////////////////////////////////////
////////////////////////////////////// start code to insert the data for SEC_TF  for UninorVAHealth /////////////////////////////////////////////////////////
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVAHealth' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_FilmiHeath_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle";
...
if ($numRows5 > 0) {
    $sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
    while ($sec_tf = mysql_fetch_array($sec_tf_result)) {
        $insert_sec_tf_data = "insert into mis_db.dailyReportUninor(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_tf[0]','$sec_tf[1]','0','$sec_tf[5]','','1433','NA','NA','NA')";
        $queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
    }
}
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVAHealth' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_FilmiHeath_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle,status";
...
////////////////////////////////////// end code to insert the data for SEC_TF  for UninorVAHealth /////////////////////////////////////////////////////////
////////////////////////////////////// start code to insert the data for SEC_TF  for UninorVAFashion /////////////////////////////////////////////////////////
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVAFashion' as service_name,date(call_date),sum(duration_in_sec)
from mis_db.tbl_CelebrityFashion_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle";
...
if ($numRows5 > 0) {
    $sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
    while ($sec_tf = mysql_fetch_array($sec_tf_result)) {
        $insert_sec_tf_data = "insert into mis_db.dailyReportUninor(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_tf[0]','$sec_tf[1]','0','$sec_tf[5]','','1434','NA','NA','NA')";
        $queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
    }
}
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorVAFashion' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_CelebrityFashion_calllog where date(call_date)='$view_date1' and operator in('unim') group by circle,status";
...
echo "Sec data end here";
////////////////////////////////////// end code to insert the data for SEC_TF  for UninorVAFashion /////////////////////////////////////////////////////////

///////////// start code to insert the data for SEC_TF  for UninorReg//////////////////////////////
$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorReg' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis like '5464606%' and dnis not like '%P%' and operator in('unim') group by circle";
...
if ($numRows5 > 0) {
    $sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
    while ($sec_tf = mysql_fetch_array($sec_tf_result)) {
        $insert_sec_tf_data = "insert into mis_db.dailyReportUninor(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_tf[0]','$sec_tf[1]','0','$sec_tf[5]','','1441','NA','NA','NA')";
        $queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
    }
}

$sec_tf = array();
$sec_tf_query = "select 'SEC_TF',circle, count(msisdn),'UninorReg' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and  dnis like '5464606%' and dnis not like '%P%' and operator in('unim') group by circle,status";
