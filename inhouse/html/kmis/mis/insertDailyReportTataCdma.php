...
$deleteprevioousdata="delete from mis_db.daily_report where date(report_date)='$view_date1' and service_id in(1601,1602,1603,1605,1608,1609)";
...
$get_activation_query="select count(msisdn),circle,chrg_amount,service_id,event_type from master_db.tbl_billing_success where DATE(date_time)='$view_date1' and service_id in(1601,1602,1603,1605,1609) and event_type in('RESUB','TOPUP') group by circle,service_id,chrg_amount,event_type"; //'SUB',
...
$get_activation_query="select count(msisdn),circle,chrg_amount,service_id,event_type from master_db.tbl_billing_success where DATE(date_time)='$view_date1' and service_id in(1601,1602,1603,1605,1609) and event_type in('SUB') group by circle,service_id,chrg_amount,event_type";
$query = mysql_query($get_activation_query, $dbConn) or die(mysql_error());
$numRows = mysql_num_rows($query);
...
$get_mode_activation_query="select count(msisdn),circle,service_id,mode from master_db.tbl_billing_success where DATE(date_time)='$view_date1' and service_id in(1601,1602,1603,1605,1609) and event_type in('SUB') group by circle,service_id,mode";
...
$get_pending_base="select count(ani),circle from indicom_radio.tbl_radio_subscription where status=11 and date(sub_date)<='$view_date1' group by circle";
...
$get_pending_base="select count(ani),circle from indicom_hungama.tbl_jbox_subscription where status=11 and date(sub_date)<='$view_date1' group by circle";
$pending_base_query = mysql_query($get_pending_base, $dbConn) or die(mysql_error());
...
$get_pending_base="select count(ani),circle from indicom_hungama.tbl_mtv_subscription where status=11 and date(sub_date)<='$view_date1' group by circle";
$pending_base_query = mysql_query($get_pending_base, $dbConn) or die(mysql_error());
...
$get_pending_base="select count(ani),circle from indicom_starclub.tbl_jbox_subscription where status=11 and date(sub_date)<='$view_date1' group by circle";
$pending_base_query = mysql_query($get_pending_base, $dbConn) or die(mysql_error());
...
$get_pending_base="select count(ani),circle from indicom_manchala.tbl_riya_subscription where status=11 and date(sub_date)<='$view_date1' group by circle";
$pending_base_query = mysql_query($get_pending_base, $dbConn) or die(mysql_error());
...
$get_active_base="select count(*),circle from indicom_hungama.tbl_mtv_subscription where status=1 and date(sub_date)<='$view_date1' group by circle";
$active_base_query = mysql_query($get_active_base, $dbConn) or die(mysql_error());
$numRows = mysql_num_rows($active_base_query);
if ($numRows > 0)
{
...
$get_deactivation_base="select count(*),circle from indicom_radio.tbl_radio_unsub where date(unsub_date)='$view_date1' group by circle";
...
$get_deactivation_base="select count(*),circle from indicom_hungama.tbl_jbox_unsub where date(unsub_date)='$view_date1' group by circle";
...
if ($numRows > 0)
{
	while(list($count,$circle) = mysql_fetch_array($deactivation_base_query))
	{
		$insert_data8="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('$view_date1', 'Deactivation_2','$circle','NA','$count','NA','NA','NA','NA',1602)";
...
$get_deactivation_base="select count(*),circle from indicom_hungama.tbl_mtv_unsub where date(unsub_date)='$view_date1' group by circle";
...
if ($numRows > 0)
{
	while(list($count,$circle) = mysql_fetch_array($deactivation_base_query))
	{
		...
		$insert_data7="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('$view_date1', 'Deactivation_2','$circle','NA','$count','NA','NA','NA','NA',1603)";
...
$get_deactivation_base="select count(*),circle from indicom_starclub.tbl_jbox_unsub where date(unsub_date)='$view_date1' group by circle";
...
{
	while(list($count,$circle) = mysql_fetch_array($deactivation_base_query))
	{			//updated by shashank 02-12-2011 insert_data10
		$insert_data10="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('$view_date1', 'Deactivation_2','$circle','NA','$count','NA','NA','NA','NA',1605)";
...
$get_deactivation_base="select count(*),circle,unsub_reason from indicom_manchala.tbl_riya_unsub where date(unsub_date)='$view_date1' and status=1 group by circle";
...
/*$get_deactivation_base="select count(*),circle from indicom_manchala.tbl_riya_unsub where date(unsub_date)='$view_date1' and status=11 group by circle";
...
if ($numRows > 0)
{
	while(list($count,$circle) = mysql_fetch_array($deactivation_base_query))
	{	
		$insert_data10="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('$view_date1', 'Deactivation_in','$circle','NA','$count','NA','NA','NA','NA',1609)";
		$queryIns = mysql_query($insert_data10, $dbConn);
	}
} */
...
$get_deactivation_base="select count(*),circle from indicom_manchala.tbl_riya_unsub where date(unsub_date)='$view_date1' and status in(1,11) group by circle";
...
if ($numRows > 0)
{
	while(list($count,$circle) = mysql_fetch_array($deactivation_base_query))
	{	
		$insert_data10="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('$view_date1', 'Deactivation_2','$circle','NA','$count','NA','NA','NA','NA',1609)";
		$queryIns = mysql_query($insert_data10, $dbConn);
	}
}
...
$get_deactivation_base="select count(*),circle,unsub_reason,unsub_reason from indicom_radio.tbl_radio_unsub where date(unsub_date)='$view_date1' group by circle,unsub_reason,unsub_reason";
...
$get_deactivation_base="select count(*),circle,unsub_reason,unsub_reason from indicom_hungama.tbl_jbox_unsub where date(unsub_date)='$view_date1' group by circle,unsub_reason,unsub_reason";
...
if ($numRows > 0)
{
	...
	{
		$deactivation_str1="Mode_Deactivation_".$unsub_reason;
					//updated by shashank 02-12-2011 insert_data12
...
$get_deactivation_base="select count(*),circle,unsub_reason,unsub_reason from indicom_hungama.tbl_mtv_unsub where date(unsub_date)='$view_date1' group by circle,unsub_reason,unsub_reason";
...
$get_deactivation_base="select count(*),circle,unsub_reason,unsub_reason from indicom_starclub.tbl_jbox_unsub where date(unsub_date)='$view_date1' group by circle,unsub_reason,unsub_reason";
...
$get_deactivation_base="select count(*),circle,unsub_reason,unsub_reason from indicom_manchala.tbl_riya_unsub where date(unsub_date)='$view_date1' and status in(11) group by circle,unsub_reason,unsub_reason";
...
if ($numRows > 0)
{
	while(list($count,$circle,$unsub_reason,$unsub_reason) = mysql_fetch_array($deactivation_base_query))
	{
		$deactivation_str1="Mode_Deactivation_in"; //$unsub_reason;
...
$call_tf=array();
$call_tf_query="select 'CALLS_TF',circle, count(id),'endless' as service_name,date(call_date) from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and dnis like '59090%' and operator in('TATC','tatc') group by circle";
...
if ($numRows12 > 0)
{
	...
	{
		if($call_t[5]==5464669) {
			if($call_t[6] == 1) $call_t[0] = "L_CALLS_T";
			elseif($call_t[6] != 1) $call_t[0] = "N_CALLS_T"; //	$call_t[0]='CALLS_T';
		} else {
			if($call_t[6] == 1) $call_t[0] = "L_CALLS_T_1";
			elseif($call_t[6] != 1) $call_t[0] = "N_CALLS_T_1"; //$call_t[0]='CALLS_T_1';
		}
		$insert_call_t_data1="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$call_t[0]','$call_t[1]','0','$call_t[2]','','1609','NA','NA','NA')";
		$queryInsCallT = mysql_query($insert_call_t_data1, $dbConn);
	}
...
if ($numRows12 > 0)
{
	...
	{
		if($call_t[6] == 1) $call_t[0] = "L_CALLS_T";
		elseif($call_t[6] != 1) $call_t[0] = "N_CALLS_T";
		$insert_call_t_data2="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$call_t[0]','$call_t[1]','0','$call_t[2]','','1608','NA','NA','NA')";
		$queryInsCallT = mysql_query($insert_call_t_data2, $dbConn);
	}
}
...
if ($numRows21 > 0)
{
	...
	{
		if($mous_t[6]==5464669) {
			if($mous_t[7] == 1) $mous_t[0] = "L_MOU_T";
			elseif($mous_t[7] != 1) $mous_t[0] = "N_MOU_T";		//$mous_t[0]='MOU_T';
		} else {
			if($mous_t[7] == 1) $mous_t[0] = "L_MOU_T_1";
			elseif($mous_t[7] != 1) $mous_t[0] = "N_MOU_T_1";		//$mous_t[0]='MOU_T_1';
		}
		$insert_mous_t_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$mous_t[0]','$mous_t[1]','0','$mous_t[5]','','1609','$mous_t[5]','NA','NA')";
		$queryIns_mousT = mysql_query($insert_mous_t_data, $dbConn);
	}
...
if ($numRows3 > 0)
{
	...
	while($pulse_tf = mysql_fetch_array($pulse_tf_result))
	{
		if($pulse_tf[5] == 1) $pulse_tf[0] = "L_PULSE_TF";
		elseif($pulse_tf[5] != 1) $pulse_tf[0] = "N_PULSE_TF";
		$insert_pulse_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$pulse_tf[0]','$pulse_tf[1]','0','$pulse_tf[2]','','1603','NA','$pulse_tf[2]','NA')";
		$queryIns_pulse = mysql_query($insert_pulse_tf_data, $dbConn);
	}
}
...
if ($numRows31 > 0)
{
	...
	while($pulse_t = mysql_fetch_array($pulse_t_result))
	{
		if($pulse_t[5] == 1) $pulse_t[0] = "L_PULSE_T";
		elseif($pulse_t[5] != 1) $pulse_t[0] = "N_PULSE_T";
		$insert_pulse_t_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$pulse_t[0]','$pulse_t[1]','0','$pulse_t[2]','','1602','NA','$pulse_t[2]','NA')";
		$queryIns_pulseT = mysql_query($insert_pulse_t_data, $dbConn);
	}
}
...
if ($numRows31 > 0)
{
	...
	while($pulse_t = mysql_fetch_array($pulse_t_result))
	{
		if($pulse_t[5]==5464669) {
			...
			elseif($pulse_t[6] != 1) $pulse_t[0] = "N_PULSE_T";		//$pulse_t[0]='PULSE_T';
		} else {
			if($pulse_t[6] == 1) $pulse_t[0] = "L_PULSE_T_1";
			elseif($pulse_t[6] != 1) $pulse_t[0] = "N_PULSE_T_1";		//$pulse_t[0]='PULSE_T_1';
		}
		$insert_pulse_t_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$pulse_t[0]','$pulse_t[1]','0','$pulse_t[2]','','1609','NA','$pulse_t[2]','NA')";
		$queryIns_pulseT = mysql_query($insert_pulse_t_data, $dbConn);
	}
...
$uu_tf=array();
$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'endless' as service_name,date(call_date) from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and dnis like '59090%' and operator in('TATC','tatc')  group by circle";
...
if ($numRows4 > 0)
{
	...
	{
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1601','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
}

$uu_tf=array();
$uu_tf_query="select * from (select 'UU_TF',circle, count(distinct msisdn),'endless' as service_name,date(call_date),status,'Non Active' as 'user_status' from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and dnis like '59090%' and operator in('TATC','tatc') and status in('-1','0','11') and status !=1 group by circle,status";
$uu_tf_query .=" union select 'UU_TF',circle, count(distinct msisdn),'endless' as service_name,date(call_date),status,'Active' as 'user_status' from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and dnis like '59090%' and operator in('TATC','tatc') and status not in('-1','0','11') and status =1 group by circle,status) c order by c.circle";
//$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'endless' as service_name,date(call_date),status from mis_db.tbl_radio_calllog where date(call_date)='$view_date1' and dnis like '59090%' and operator in('TATC','tatc')  group by circle,status";
...
if ($numRows4 > 0)
{
	...
	while($uu_tf = mysql_fetch_array($uu_tf_result))
	{
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1602','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
}

$uu_tf=array();
$uu_tf_query="select * from (select 'UU_TF',circle, count(distinct msisdn),'indicom54646' as service_name,date(call_date),status,'Non Active' as 'user_status' from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis like '546463%' or dnis like '546469%') and dnis not in('546461','5464626') and operator in('TATC') and status in('-1','0','11') and status !=1 group by circle,status";
$uu_tf_query .=" union select 'UU_TF',circle, count(distinct msisdn),'indicom54646' as service_name,date(call_date),status,'Active' as 'user_status' from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis like '546463%' or dnis like '546469%') and dnis not in('546461','5464626') and operator in('TATC') and status not in('-1','0','11') and status =1 group by circle,status) c order by c.circle";
//$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicom54646' as service_name,date(call_date),status from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis like '546463%' or dnis like '546469%') and dnis not in('546461','5464626') and operator in('TATC') group by circle,status";
...
$uu_tf=array();
$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicomRia' as service_name,date(call_date) from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis =5464626 and operator in('TATC') group by circle";
...
if ($numRows4 > 0)
{
	...
	while($uu_tf = mysql_fetch_array($uu_tf_result))
	{
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1609','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
}

$uu_tf=array();
$uu_tf_query="select * from (select 'UU_TF',circle, count(distinct msisdn),'indicomRia' as service_name,date(call_date),status,'Non Active' as 'user_status' from  mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis =5464626 and operator in('TATC') and status in('-1','0','11') and status !=1 group by circle,status";
$uu_tf_query .=" union select 'UU_TF',circle, count(distinct msisdn),'indicomRia' as service_name,date(call_date),status,'Active' as 'user_status' from  mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis =5464626 and operator in('TATC') and status not in('-1','0','11') and status =1 group by circle,status) c order by c.circle";

//$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicomRia' as service_name,date(call_date),status from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis =5464626 and operator in('TATC') group by circle,status";
...
$uu_tf=array();
$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicomCricket' as service_name,date(call_date) from mis_db.tbl_cricket_calllog where date(call_date)='$view_date1' and dnis in(54433) and operator in('TATC') group by circle";
...
if ($numRows4 > 0)
{
	...
	while($uu_tf = mysql_fetch_array($uu_tf_result))
	{
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1608','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
}

$uu_tf=array();
$uu_tf_query="select * from (select 'UU_TF',circle, count(distinct msisdn),'indicomCricket' as service_name,date(call_date),status,'Non Active' as 'user_status' from  mis_db.tbl_cricket_calllog where date(call_date)='$view_date1' and dnis in(54433) and operator in('TATC') and status in('-1','0','11') and status !=1 group by circle,status";
$uu_tf_query .=" union select 'UU_TF',circle, count(distinct msisdn),'indicomCricket' as service_name,date(call_date),status,'Active' as 'user_status' from mis_db.tbl_cricket_calllog where date(call_date)='$view_date1' and dnis in(54433) and operator in('TATC') and status not in('-1','0','11') and status =1 group by circle,status) c order by c.circle";

//$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicomCricket' as service_name,date(call_date),status from mis_db.tbl_cricket_calllog where date(call_date)='$view_date1' and dnis in(54433) and operator in('TATC') group by circle,status";
...
$uu_tf=array();
$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicomMTV' as service_name,date(call_date) from mis_db.tbl_mtv_calllog where date(call_date)='$view_date1' and dnis =546461 and operator in('TATC') group by circle";
...
if ($numRows4 > 0)
{
	...
	while($uu_tf = mysql_fetch_array($uu_tf_result))
	{
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1603','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
}

$uu_tf=array();
$uu_tf_query="select * from (select 'UU_TF',circle, count(distinct msisdn),'indicomMTV' as service_name,date(call_date),status,'Non Active' as 'user_status' from mis_db.tbl_mtv_calllog where date(call_date)='$view_date1' and dnis =546461 and operator in('TATC') and status in('-1','0','11') and status !=1 group by circle,status";
$uu_tf_query .=" union select 'UU_TF',circle, count(distinct msisdn),'indicomMTV' as service_name,date(call_date),status,'Active' as 'user_status' from mis_db.tbl_mtv_calllog where date(call_date)='$view_date1' and dnis =546461 and operator in('TATC') and status not in('-1','0','11') and status =1 group by circle,status) c order by c.circle";
//$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicomMTV' as service_name,date(call_date),status from mis_db.tbl_mtv_calllog where date(call_date)='$view_date1' and dnis =546461 and operator in('TATC') group by circle,status";
...
$uu_tf=array();
$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicomFMJ' as service_name,date(call_date) from mis_db.tbl_starclub_calllog where date(call_date)='$view_date1' and dnis =56666 and operator in('TATC') group by circle";
...
if ($numRows4 > 0)
{
	...
	while($uu_tf = mysql_fetch_array($uu_tf_result))
	{
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1605','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
}

$uu_tf=array();
$uu_tf_query="select * from (select 'UU_TF',circle, count(distinct msisdn),'indicomFMJ' as service_name,date(call_date),status,'Non Active' as 'user_status' from mis_db.tbl_starclub_calllog where date(call_date)='$view_date1' and dnis =56666 and operator in('TATC') and status in('-1','0','11') and status !=1 group by circle,status";
$uu_tf_query .=" union select 'UU_TF',circle, count(distinct msisdn),'indicomFMJ' as service_name,date(call_date),status,'Active' as 'user_status' from mis_db.tbl_starclub_calllog where date(call_date)='$view_date1' and dnis =56666 and operator in('TATC') and status not in('-1','0','11') and status =1 group by circle,status) c order by c.circle";
//$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'indicomFMJ' as service_name,date(call_date),status from mis_db.tbl_starclub_calllog where date(call_date)='$view_date1' and dnis =56666 and operator in('TATC') group by circle,status";
...
$uu_tf=array();
$uu_tf_query="select 'UU_T',circle, count(distinct msisdn),'Reliance54646' as service_name,date(call_date),dnis from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis in('5464669','5464668') and operator in('TATC') group by circle,dnis";
...
$uu_tf=array();
$uu_tf_query="select 'UU_T',circle, count(distinct msisdn),'Reliance54646' as service_name,date(call_date),dnis,status from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis in('5464669','5464668') and operator in('TATC') group by circle,dnis,status";
...
if ($numRows4 > 0)
{
	...
	while($uu_tf = mysql_fetch_array($uu_tf_result))
	{
		if($uu_tf[5]=='5464669') {
			...
			elseif($uu_tf[6] != 1) $uu_tf[0] = "N_UU_T";	//$uu_tf[0]='UU_T';
		} elseif($uu_tf[5]=='5464668') {
			if($uu_tf[6] == 1) $uu_tf[0] = "L_UU_T_1";
			elseif($uu_tf[6] != 1) $uu_tf[0] = "N_UU_T_1";		//$uu_tf[0]='UU_T_1';
		}
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1609','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
...
$uu_tf=array();
$uu_tf_query="select 'UU_T',circle, count(distinct msisdn),'RelianceCricket' as service_name,date(call_date) from mis_db.tbl_cricket_calllog where date(call_date)='$view_date1' and dnis in(54433,546468) and operator in('TATC') group by circle";
...
$uu_tf=array();
$uu_tf_query="select 'UU_T',circle, count(distinct msisdn),'RelianceCricket' as service_name,date(call_date),status from mis_db.tbl_cricket_calllog where date(call_date)='$view_date1' and dnis in(54433,546468) and operator in('TATC') group by circle,status";
...
if ($numRows6 > 0)
{
	...
	{
		if($sec_t[6]==5464669) {
			if($sec_t[7] == 1) $sec_t[0] = "L_SEC_T";
			elseif($sec_t[7] != 1) $sec_t[0] = "N_SEC_T";	//$sec_t[0]='SEC_T';
		} else {
			if($sec_t[7] == 1) $sec_t[0] = "L_SEC_T_1";
			elseif($sec_t[7] != 1) $sec_t[0] = "N_SEC_T_1";	//$sec_t[0]='SEC_T_1';
		}
		$insert_sec_t_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_t[0]','$sec_t[1]','0','$sec_t[5]','','1609','NA','NA','NA')";
		$queryIns_sec = mysql_query($insert_sec_t_data, $dbConn);
	}
...
$rbt_tf=array();
$rbt_query="select count(*),circle,req_type from indicom_radio.tbl_crbtrng_totalreqs where DATE(date_time)='$view_date1' and req_type in('CRBT','RNG') group by circle,req_type";
...
$get_migrate_date="select crbt_mode,count(1),circle from indicom_radio.tbl_crbtrng_reqs_log where date(date_time)='$view_date1' and req_type='crbt' and status=1 group by crbt_mode,circle";
...
mysql_close($dbConn);
header("location:http://119.82.69.212/kmis/services/hungamacare/createInhouseServiceMIS.php?date=".$view_date1);
