...
$view_date1='2012-08-04'
echo $view_date1;
// to insert the data for activation
// delete the prevoius record

$deleteprevioousdata="delete from mis_db.daily_report where date(report_date)='$view_date1' and service_id in(1601,1602,1603,1605,1608,1609,1611)";
...
$get_activation_query="select count(msisdn),circle,chrg_amount,service_id,event_type from master_db.tbl_billing_success where DATE(response_time)='$view_date1' and service_id in(1601,1602,1603,1605,1609,1610,1611) and event_type in('RESUB') group by circle,service_id,chrg_amount,event_type"; //'SUB',
...
$get_activation_query="select count(msisdn),circle,chrg_amount,service_id,event_type from master_db.tbl_billing_success where DATE(response_time)='$view_date1' and service_id in(1601,1602,1603,1605,1609,1610,1611) and event_type in('TOPUP') group by circle,service_id,chrg_amount,event_type"; //'SUB',
$query = mysql_query($get_activation_query, $dbConn) or die(mysql_error());
$numRows = mysql_num_rows($query);
...
$get_activation_query="select count(msisdn),circle,chrg_amount,service_id,event_type from master_db.tbl_billing_success where DATE(response_time)='$view_date1' and service_id in(1601,1602,1603,1605,1609,1610,1611) and event_type in('SUB') group by circle,service_id,chrg_amount,event_type";
$query = mysql_query($get_activation_query, $dbConn) or die(mysql_error());
$numRows = mysql_num_rows($query);
...
$get_mode_activation_query="select count(msisdn),circle,service_id,mode from master_db.tbl_billing_success where DATE(response_time)='$view_date1' and service_id in(1601,1602,1603,1605,1609,1610,1611) and event_type in('SUB') group by circle,service_id,mode";
...
$get_pending_base="select count(ani),circle from indicom_redfm.tbl_jbox_subscription where status=11 and date(sub_date)<='$view_date1' group by circle";
$pending_base_query = mysql_query($get_pending_base, $dbConn) or die(mysql_error());
...
$get_pending_base="select count(ani),circle from indicom_rasoi.tbl_rasoi_subscription where status=11 and date(sub_date)<='$view_date1' group by circle";
$pending_base_query = mysql_query($get_pending_base, $dbConn) or die(mysql_error());
...
$get_active_base="select count(*),circle from indicom_rasoi.tbl_rasoi_subscription where status=1 and date(sub_date)<='$view_date1' group by circle";
$active_base_query = mysql_query($get_active_base, $dbConn) or die(mysql_error());
$numRows = mysql_num_rows($active_base_query);
if ($numRows > 0)
{
...
$get_deactivation_base="select count(*),circle from indicom_redfm.tbl_jbox_unsub where date(unsub_date)='$view_date1' and status in(1,11) group by circle";
...
if ($numRows > 0)
{
	while(list($count,$circle) = mysql_fetch_array($deactivation_base_query))
	{	
		$insert_data10="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('$view_date1', 'Deactivation_2','$circle','NA','$count','NA','NA','NA','NA',1610)";
		$queryIns = mysql_query($insert_data10, $dbConn);
	}
}
...
$get_deactivation_base="select count(*),circle from indicom_rasoi.tbl_rasoi_unsub where date(unsub_date)='$view_date1' and status in(1,11) group by circle";
...
if ($numRows > 0)
{
	while(list($count,$circle) = mysql_fetch_array($deactivation_base_query))
	{	
		$insert_data10="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('$view_date1', 'Deactivation_2','$circle','NA','$count','NA','NA','NA','NA',1611)";
		$queryIns = mysql_query($insert_data10, $dbConn);
	}
}
...
$get_deactivation_base="select count(*),circle,unsub_reason,unsub_reason from indicom_redfm.tbl_jbox_unsub where date(unsub_date)='$view_date1' and status in(11) group by circle,unsub_reason,unsub_reason";
...
// start code to insert the Deactivation Base into the MIS database IndicomGL
$get_deactivation_base="select count(*),circle,unsub_reason,unsub_reason from indicom_rasoi.tbl_rasoi_unsub where date(unsub_date)='$view_date1' and status in(11) group by circle,unsub_reason,unsub_reason";
...
$uu_tf=array();
$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'IndicomRedFM' as service_name,date(call_date) from mis_db.tbl_redfm_calllog where date(call_date)='$view_date1' and dnis =55935 and operator in('TATC') group by circle";
...
if ($numRows4 > 0)
{
	...
	while($uu_tf = mysql_fetch_array($uu_tf_result))
	{
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1610','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
}
...
///////////////////////////////////////////////////////////start code to insert the data for Unique Users  for toll free for IndicomRedFM
$uu_tf=array();
$uu_tf_query="select 'UU_TF',circle, count(distinct msisdn),'IndicomGL' as service_name,date(call_date) from mis_db.tbl_rasoi_calllog where date(call_date)='$view_date1' and dnis like '55001%' and circle IN ('DEL') and operator in('TATC') group by circle";
...
if ($numRows4 > 0)
{
	...
	while($uu_tf = mysql_fetch_array($uu_tf_result))
	{
		$insert_uu_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$uu_tf[0]','$uu_tf[1]','0','$uu_tf[2]','','1611','NA','NA','NA')";
		$queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
	}
}
...
///////////////////////////////////////Start code to insert the data  Unique Users for toll for Cricket Mania //////////////////////////////
$uu_tf=array();
$uu_tf_query="select 'UU_T',circle, count(distinct msisdn),'IndicomGL' as service_name,date(call_date) from mis_db.tbl_rasoi_calllog where date(call_date)='$view_date1' and dnis like '55001%' and circle NOT IN ('DEL') and operator in('TATC') group by circle";
...
/////////////////////////////////////////End code to insert the data  Unique Users for toll for IndicomGL //////////////////////////////
