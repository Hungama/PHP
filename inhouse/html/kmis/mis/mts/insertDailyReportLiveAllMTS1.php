...
$get_activation_query .= " where response_time between DATE_SUB('$DateFormat[0]', INTERVAL 1 HOUR) and '$DateFormat[0]' and service_id in(1101,1102,1103,1111,1106, 1110,1116,1113) and event_type in('SUB','RESUB','TOPUP','EVENT','Event') group by circle,service_id,chrg_amount,event_type,plan_id";
...
//////////////////////////////////Start the code to activation Record mode wise //////////////////////////////////////////////////////////
 ...
 $get_mode_activation_query .=" where response_time between DATE_SUB('$DateFormat[0]', INTERVAL 1 HOUR) and '$DateFormat[0]' and service_id in(1101,1102,1103,1111,1106,1110,1116,1113) and event_type in('SUB','EVENT','Event') group by circle,service_id,event_type,mode order by event_type,plan_id";
