...
$sql_getmsisdnfilelist=mysql_query("select odb_filename,uploadtime,processedtime,servicetype,capsuleid,prcocess_status,status from master_db.tbl_obdrecording_log  where date(processedtime)>='2012-12-01' and  servicetype !='DIGI' and servicetype !='uninor_jyotish' order by batchid DESC");
