                ...
                <div id="center-column">
                    ...
                    <div class="table">
                        ...
                        <table class="listing form" cellpadding="0" cellspacing="0" style="width:100%">
                            ...
                            <?php
                            $query = "select sum(filesize) as totalcount,date(uploadtime) as uploadtime  from master_db.tbl_obdrecording_log where date(uploadtime)>=date(subdate(now(),30)) and servicetype='DIGI' group by date(uploadtime) order by uploadtime desc ";
