		  ...
		  <div class="select-bar">
		    <?php echo $_REQUEST[msg];?>
			 ...
			 <div class="table">
				...
				<tr class="bg">
						<td class="first"><strong>Please select capsule</strong></td>
						<td class="last">
                       <select name="obd_form_capsule" id="obd_form_capsule">
						<option value="">Select any one--</option>
						<option value="1">Capsule-1</option>
						<option value="2">Capsule-2</option>
				    	<option value="3">Capsule-3</option>
						<option value="4">Capsule-4</option>
						<option value="5">Capsule-5</option>
						<option value="6">Capsule-6</option>
						<option value="7">Rajnikanth Capsule</option>
						<option value="8">Newyear Capsule</option>
						<option value="9">Pongal Capsule</option>
						</select>
						</td>
					</tr>
