...
$sql_obdinfo="INSERT INTO master_db.tbl_obdrecording_log (uploadedby,ipaddress,odb_filename,circle,cli,startdate,enddate,filesize,channel,planid)
...
if($uploadedby=='client.digi' || $uploadedby=='admin')
{
	...
	if($numRows1 > 0)
	{
				...
				//$emailArray = array('satay.tiwari@hungama.com','vikrant.garg@hungama.com','shreya.tyagi@hungama.com','pranav.joshi@hungama.com','pratik.gupta@hungama.com');
				$emailArray = array('satay.tiwari@hungama.com');
