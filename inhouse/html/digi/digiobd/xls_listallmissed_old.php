...
if($StartDate != '')
{
	//$result =  mysql_query("select ANI,date_time,circle,operator from newseleb_hungama.tbl_max_bupa_details WHERE  date(date_time) = '$StartDate'");
	$result =  mysql_query("select ANI,date(date_time) as Date,circle as Circle,operator as Operator from newseleb_hungama.tbl_max_bupa_details WHERE  date(date_time) = '$StartDate'");
}
else
{
//$result = mysql_query("select ANI,date_time,circle,operator from newseleb_hungama.tbl_max_bupa_details order by date_time DESC");
$result = mysql_query("select ANI,date(date_time) as Date,circle as Circle,operator as Operator from newseleb_hungama.tbl_max_bupa_details order by date_time DESC");
}
