...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				<h1>Check MSISDN Information</h1>
				</div>
...
<form name="hul_check_msisdn">
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">Check MSISDN Missed Call Information</th>
					</tr>
					
					<tr class="bg">
						<td class="first"><strong>Enter MSISDN </strong></td>
						<td class="last"><input type="text" class="text" name="hul_gp_msisdn" id="hul_gp_msisdn" onkeyup="getMsisdnInfo(1)" />
						<input type="button" name="getinfo" value="getinfo" onclick="getMsisdnInfo(1)"/>
						</td>
					</tr>
