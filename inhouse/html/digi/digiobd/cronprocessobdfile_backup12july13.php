...
$checkfiletoprocess=mysql_query("select batchid,odb_filename,circle, startdate, enddate,channel,planid,servicetype,capsuleid,uploadtime from master_db.tbl_obdrecording_log where status IN ( 1, 0) and prcocess_status='free' and filesize<=10000 order by batchid ASC limit 1");
