                    ...
                    <div class="table">
                        ...
                        <table class="listing form" cellpadding="0" cellspacing="0" style="width:100%">
                            <tr>
                                ...
                                <th class="full" width="16.5%">Mode</th>
                            </tr>
                            <?php
                            //$query = "select odb_filename,circle,prcocess_status,channel,planid,servicetype from master_db.tbl_obdrecording_log limit 20";
                            $query = "select batchid,odb_filename,circle,status,cli,startdate,enddate,filesize,uploadtime,uploadedby,channel ";
                            ...
                            if ($result_row > 0) {
                                while ($details = mysql_fetch_array($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="last" width="16.5%"><?php echo $details['channel']; ?></td>
                                    </tr>
                                    <?php
                                }
                            }
