...
$getMsisdn="select Msisdn,amount,transactionid,id,operator_id,circle_id from master_db.tbl_recharged where status=0 order by id ASC limit 20";
...
$updateRecord="update master_db.tbl_recharged set status=1 where id=".$id;
	...
	error_log($rechargeStatus,3,$reponseLog1);	
