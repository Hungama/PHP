...
$getMsisdnId="select id from master_db.tbl_recharged nolock where status=0 order by id ASC limit 20";
...
$getMsisdn="select Msisdn,amount,transactionid,id,operator_id,circle_id from master_db.tbl_recharged where id in($allIds)";
