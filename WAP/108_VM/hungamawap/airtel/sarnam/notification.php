...
$msisdn = substr($msisdn, -10);
  //Get Circle here
    ...
    $insQry = "insert into $dwntable (msisdn,contentid,date_time,status,contenttype,circle,device_browser)
...
$getInfo="http://119.82.69.212/airtel/notification.php?msisdn=".$msisdn."&sid=1515&contentid=".$contentid."&contenttype=".$contenttype."&ua=".urlencode($UA);
...
$logData = $msisdn . "#" .$contentid."#".$contenttype."#".$response."#".$UA."#".$Remote_add."#".date('Y-m-d H:i:s') . "\n";
