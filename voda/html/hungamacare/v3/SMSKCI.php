...
$circle_info = array( 'pan' => 'ALL','BIH'=>'Bihar','APD'=>'Andhra Pradesh','CHN' => 'Chennai', 'GUJ' => 'Gujarat', 'KAR' => 'Karnataka', 'KER' => 'Kerala', 'KOL' => 'Kolkata', 'RAJ' => 'Rajasthan', 'TNU' => 'Tamil Nadu', 'UPW' => 'UP WEST', 'WBL' => 'WestBengal', 'DEL' => 'Delhi','MAH' => 'Maharashtra','UPE' => 'UP EAST');
...
<div class="row">
	<div class="col-md-8">
	<h6>Add New SMS<small>&nbsp;&nbsp;<?php  echo $f_array[$sid]; 
	//echo $Service_DESC[$sname_ks[$f_array[$sid]]['Name'];?></small></h6>
	</div>
    <!--div class="col-md-4">
