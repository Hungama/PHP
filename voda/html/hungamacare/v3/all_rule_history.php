                        ...
                        <TD>
                            ...
                            if ($processData['count'] == 0) {
                                ...
                                if ($action_name == 'sms') {
                                    ...
                                    ?>
                            <a href="http://10.43.248.137/hungamacare/v3/new_engagement/<?php echo $filePath ?>" target="_blank">
                                        <?php
                                    } else {
                                        $filePath = $filepath;
                                        ?>
                            <a href="http://192.168.100.212/kmis/services/hungamacare/VODAFONE_NEW_ENGAGEMENT/dndcheck/<?php echo $filePath ?>" target="_blank">
                                        <?php }
                                        ?>
                                        Download
                                    <?php } ?>
