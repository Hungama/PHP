    ...
    switch ($s_id) {
        case '1301':
          $subscription_db = "vodafone_radio";
            ...
            $dnis_str = "status in(1,7,8,6,11) ";
			break;
        case '1302':
            $subscription_db = "vodafone_hungama";
            $subscription_table = "tbl_jbox_subscription";
			$dnis_str = "status in(1,11)  and dnis not like '%P%'";
            break;
     
    }
///////////////////////////////////////////// Start Code For 0-5 days  ///////////////////////////////////////////////////////////////////////////////////////
    $query_0to5days = "select ANI,circle,status, SUB_DATE,DATEDIFF(now(),Sub_date ) as diff from " . $subscription_db . "." . $subscription_table . "  where " . $dnis_str . " GROUP BY  ANI HAVING diff>=0 and diff<=5";
...
///////////////////////////////////////////// Start Code For 5-10 days  ////////////////////////////////////////////////////////
    $query_5to10days = "select ANI,circle,status, SUB_DATE,DATEDIFF(now(),Sub_date ) as diff from " . $subscription_db . "." . $subscription_table . " where " . $dnis_str . " GROUP BY  ANI HAVING diff>=5 and diff<=10";
...
///////////////////////////////////////////// Start Code For 10-20 days  ////////////////////////////////////////////////////////
    $query_10to20days = "select ANI,circle,status, SUB_DATE,DATEDIFF(now(),Sub_date ) as diff from " . $subscription_db . "." . $subscription_table . " where " . $dnis_str . " GROUP BY  ANI HAVING diff>=10 and diff<=20";
...
///////////////////////////////////////////// Start Code For 20-30 days ////////////////////////////////////////////////
    $query_20to30days = "select ANI,circle,status, SUB_DATE,DATEDIFF(now(),Sub_date ) as diff from " . $subscription_db . "." . $subscription_table . " where " . $dnis_str . " GROUP BY  ANI HAVING diff>=20 and diff<=30";
...
///////////////////////////////////////////// Start Code For More than 30 days ////////////////////////////////////////////////
    $query_G30days = "select ANI,circle,status, SUB_DATE,DATEDIFF(now(),Sub_date ) as diff from " . $subscription_db . "." . $subscription_table . " where " . $dnis_str . " GROUP BY  ANI HAVING diff>=30";
