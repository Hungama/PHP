#!/bin/sh
#Shell Script for Engagement Data for all scenerio 
...
/usr/bin/php /var/www/html/hungamacare/v3/new_engagement/new_engagementlog_rtDwnld.php &
sleep 1m

/usr/bin/php /var/www/html/hungamacare/v3/new_engagement/new_engagementlog_nonRTDwnld.php &
echo "done"
