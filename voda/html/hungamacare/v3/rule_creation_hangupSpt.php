                    ...
                    <div class="tab-pane active" id="pills-basic">
                        <div class="tabbable">
                            <ul class="nav nav-pills">
								...
								<li class=""><a href="#hangup" onclick="viewUploadhistory('hangup')"  data-toggle="tab" data-act="history">HangUp SMS</a></li>
                            </ul>
                            <br/>
								...
								<div id="hangup" class="tab-pane">
                                    ...
                                    <form id="form-hangup" name="form-hangup" method="post" enctype="multipart/form-data">
										...
										<tr>
                                                <td align="left" width="16%" height="32"><span>Service Name</span></td>
                                                <td align="left" colspan="2">
                                                    <select name="service" id="service" data-width="auto" onchange="setSmsCliPromotional(this.value)">
                                                        <option value="0">Select Service</option>
                                                        <?php foreach ($serviceArray1 as $s_id => $s_val) {
                                                            ?>
                                                            <option value="<?php echo $s_id; ?>"><?php echo $s_val; ?></option>
										...
										<tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    <select name="type" data-width="auto" >
