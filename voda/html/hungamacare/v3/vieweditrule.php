...
asort($circle_info);
$sms_cli_array = Array('1301' => '55665');
...
$selectDisplayQuery = "SELECT id,rule_name,service_id,service_base,filter_base,scenerios,dnd_scrubbing,added_on,circle,status,
    date(last_processed_time) as last_processed_date,last_processed_time FROM master_db.tbl_rule_engagement where id='" . $rule_id . "'";
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    ...
                    echo $Service_DESC[$serviceArray[$rule_array['service_id']]]['Name']; ?> 
                </td>
            </tr>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input style="color:#2E3232" type="text" name="sms_edit_cli" id="sms_edit_cli" value="<?php echo $action_array['sms_cli']; ?>" placeholder="SMS Cli" class="form-control" readonly="readonly"/>
                                </div>          
                            </div>
                        </div>
...
<!--                    <select name="add_edit_cc[]" multiple="multiple" data-width="auto">-->
                    <select multiple="multiple" name="add_edit_cc[]" data-title="Select CC user" data-width="70%">
    ...
    function setEditSmsCli(type) { 
        ...
        if(type == 'promotional'){
            ...
            if(service == '1515'){
                ...
                document.forms["form-edit"]["sms_edit_cli"].value= "HMLIFE";
            }else if(service == '1517'){
                document.forms["form-edit"]["sms_edit_cli"].value= "HMEDUT";
            }else if(service == '1502'){
                document.forms["form-edit"]["sms_edit_cli"].value= "HMMUSC";
