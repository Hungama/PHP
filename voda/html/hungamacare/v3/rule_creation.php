...
$serviceArray1 = array('1301' => 'VodafoneMU', '1302' => 'Vodafone54646');
...
foreach ($serviceArray1 as $k => $v) {
    if (in_array($v, $services)) {
        if ($k != '') {
            // if ($Service_DESC[$v]['Operator'] == 'Airtel') {
...
<?php if($loginid=='salil.mahajan' || $loginid=='rahul.tripathi' || $loginid=='nitin.chauhan'){ ?><li class=""><a href="#hangup" onclick="viewhanguphistory('hangup')"  data-toggle="tab" data-act="history">HangUp SMS</a></li><?php }//||$loginid=='rahul.tripathi' ?>
                            </ul>
                            <br/>
                                    ...
                                    <form id="form-active" name="form-active" method="post" enctype="multipart/form-data">
                                        <table class="table table-bordered table-condensed">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    <select name="service" data-width="auto" onchange="setSmsCliPromotional(this.value)">
                                                        <option value="0">Select Service</option>
                                                        <?php foreach ($serviceArray1 as $s_id => $s_val) {
                                                            ?>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    <label class="radio">
                                                        <input type="radio" id="service_base_active" name="service_base" value="active" data-toggle="radio" checked />&nbsp; Active &nbsp;&nbsp;&nbsp;
                                                    </label>
                                                    <label class="radio">
                                                        <input type="radio" id="service_base_pending" name="service_base" value="pending" data-toggle="radio" checked />&nbsp; Pending &nbsp;&nbsp;&nbsp;
                                                    </label>
                                                    <label class="radio">
                                                        <input type="radio" id="service_base_both" name="service_base" value="both" data-toggle="radio" checked />&nbsp; Both
                                                    </label>	
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <label class="radio">
                                                        <input type="radio" id="dnd_scrubbing_yes" name="dnd_scrubbing" value="1" data-toggle="radio" checked   disabled/>&nbsp; Yes &nbsp;&nbsp;&nbsp;
                                                    </label><label class="radio">
                                                        <input type="radio" id="dnd_scrubbing_no" name="dnd_scrubbing" value="0" data-toggle="radio"  disabled />&nbsp; No &nbsp;&nbsp;&nbsp;
                                                    </label>
                                        ...
                                        <div id="fileFormat" class="well well-small">
                                            Please note: In each and every case DND should be Yes.
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <form id="form-action" name="form-action" method="post" enctype="multipart/form-data">
                                        <table class="table table-bordered table-condensed">
                                            ...
                                            <tr id="tr_sms_type">
                                                ...
                                                <td align="left" colspan="2">
                                                    <label class="radio">
                                                        <input type="radio"  name="sms_type" value="promotional" data-toggle="radio"  checked onchange="setSmsCli(this.value)" />&nbsp; Promotional &nbsp;&nbsp;&nbsp;
                                                    </label><label class="radio">
                                                        <input type="radio"  name="sms_type" value="engagement" data-toggle="radio"  onchange="setSmsCli(this.value)" />&nbsp; Engagement &nbsp;&nbsp;&nbsp;
                                                    </label>
                                                </td>
                                            ...
                                            <tr id="tr_add_cc">
                                                ...
                                                <td align="left" colspan="2">
<!--                                                    <select name="add_cc[]" multiple="multiple" data-width="25%">-->
                                                    <select multiple="multiple" name="add_cc[]" data-title="Select CC user" data-width="70%">
                                                        <!--                                                        <option value="0">Select CC user id</option>-->
                                                        <?php
                                                        $selectemailQuery = "SELECT distinct email FROM master_db.live_user_master nolock where ac_flag=1  order by email";
								...
								<!--- PAN FOR HANGUP SMS START HERE --->
								<div id="hangup" class="tab-pane">
                                 
                                    <form id="form-hangup" name="form-hangup" method="post" enctype="multipart/form-data">
                                        <table class="table table-bordered table-condensed">
										<tr>
                                                <td align="left" width="16%" height="32"><span>Service Name</span></td>
                                                <td align="left" colspan="2">
                                                    <select name="service" id="service" data-width="250px" onchange="setSmsCliPromotional(this.value)">
                                                        <option value="0">Select Service</option>
                                                        <?php foreach ($serviceArray1 as $s_id => $s_val) {
                                                            ?>
                                                            <option value="<?php echo $s_id; ?>"><?php echo $s_val; ?></option>
                                                ...
                                                <td align="left" colspan="2">
                                                    <select name="priority" data-width="250px" >
										...
										<tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    <select name="type" data-width="250px" >
                                            ...
                                            <tr>
                                                <td align="left" width="16%" height="32"><span>Circle</span></td>
                                                <td align="left" colspan="2">
                                                    <select name="circle1[]" id="circle1" multiple="multiple" data-width="250px">
                                                    ...
                                                    &nbsp;<a href="javascript:toggle('circle1')" id="all-circle1">[All]</a><a href="javascript:toggle('circle1')" id="none-circle1" style="display:none">[X]</a>
                                                </td>

                                            </tr>
											<tr>
											<td align="left" width="16%" height="32"><span>Message File</span></td>
											<td align="left" colspan="2">
        ...
        <script>
            function reloadPage()
         {
            ...
            function setSmsCli(type) { 
                var service=document.forms["form-active"]["service"].value;
                 
                 if(service == '1301'){
                        document.forms["form-action"]["sms_cli"].value= "55665";
                    }else if(service == '1302'){
                        document.forms["form-action"]["sms_cli"].value= "546461";
                    }
                }
            
            function setSmsCliPromotional(service) { 
                var smscli = new Array();
                smscli[1301] = "55665";
				smscli[1302] = "546461";
                var sms_cli_value = smscli[service];
                document.forms["form-action"]["sms_cli"].value=sms_cli_value;
                //document.forms["form-action"]["sms_cli"].value="601666";
            }
			...
			///////////action for callhang up sms start here
			
			     $("form#form-hangup").submit(function(){  
                ...
                if(isok)
                {
                    ...
                    //$('#loading').show();
                    var formData = new FormData($("form#form-hangup")[0]);
                    $.ajax({
                        url: 'hangupmessage.php',
                        type: 'POST',
                        data: formData,
                        async: false,
 ...
 $.ajax({
            ...
            function handleClick(action){ 
                ...
                if (action == 'sms') { 
                    ...
                    document.getElementById('tr_sms_type').style.display='table-row';
                    document.getElementById('error_box').style.display='none';
                    document.getElementById('alert_placeholder').style.display='none';
                    ...
                    document.getElementById('tr_sms_type').style.display='none';
                    document.getElementById('error_box').style.display='none';
                    document.getElementById('alert_placeholder').style.display='none';
                }
            }
            ...
            function viewhanguphistory(act)
            {
              document.getElementById('alert_placeholder').style.display='none';
                ...
                //$('#loading').show();  
                 $.fn.GethangupHistory(act);
            }
           
				$.fn.GethangupHistory = function(act) {
                $('#loading').show();
                $.ajax({
	     
                    url: 'viewhangupmessagelist_rahul.php',
                    data: 'act='+act,
                    type: 'get',
                    cache: false,
                    dataType: 'html',
