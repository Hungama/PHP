        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>Voda Switch Configuration<small>&nbsp;&nbsp;</small></h1>
                </div>
                <div class="tab-pane active" id="pills-basic">
                    <div class="tabbable">
                        <ul class="nav nav-pills">
                            <li class="active"><a href="#active" onclick="viewSMSUploadhistory('switch')" data-toggle="tab" data-act="activation">Switch</a></li>
                        </ul>
                            ...
                            <div id="active" class="tab-pane active">
                                <form id="form_uninor_switch" name="form_uninor_switch" method="post" enctype="multipart/form-data">
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            <td align="left" width="16%" height="32"><span>Switch&nbsp;</span></td>
                                            <td><select name="switch_info" id="switch_info">
                                                    <option value="0">Select Switch</option>
                                                    <option value="1">1st consent will be skipped with time slot</option>
                                                    <option value="2">2nd consent will be skipped with time slot</option>
                                                    <option value="3">1st and 2nd consent will be skipped with time slot</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
