...
$serviceArray1 = array('1301' => 'VodafoneMU');
//$circle_info = array('DEL' => 'Delhi', 'GUJ' => 'Gujarat', 'WBL' => 'WestBengal', 'BIH' => 'Bihar', 'RAJ' => 'Rajasthan', 'UPW' => 'UP WEST', 'MAH' => 'Maharashtra', 'APD' => 'Andhra Pradesh', 'UPE' => 'UP EAST', 'ASM' => 'Assam', 'TNU' => 'Tamil Nadu', 'KOL' => 'Kolkata', 'NES' => 'NE', 'CHN' => 'Chennai', 'ORI' => 'Orissa', 'KAR' => 'Karnataka', 'HAR' => 'Haryana', 'PUN' => 'Punjab', 'MUM' => 'Mumbai', 'MPD' => 'Madhya Pradesh', 'JNK' => 'Jammu-Kashmir', 'KER' => 'Kerala', 'HPD' => 'Himachal Pradesh', '' => 'Other', 'HAY' => 'Haryana');
...
foreach ($serviceArray1 as $k => $v) {
    if (in_array($v, $services)) {
        if ($k != '') {
            if ($Service_DESC[$v]['Operator'] == 'Vodafone') {
    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function setShortCode(service){
                $("#Scode").val("");
                if(service == '1301'){
                    document.getElementById('select_Scode').innerHTML = "<select name='Scode' id='Scode'><option value='55665'>55665</option></select>";
                }
                else
                {
                    $("#Scode").val("NA");
                            ...
                            <div id="active" class="tab-pane active">
                                <form id="tstest" name="tstest" method="post">
                                    <table class="table table-bordered table-condensed">
                                        <tr>
                                            ...
                                            <td>
                                                <select name='service' id="service" onchange="setShortCode(this.value);">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div id="select_Scode" name="select_Scode">
                                                    <select name="Scode" id="Scode" class="in">
                                        ...
                                        <tr>
                                            <td align="left" width="16%" height="32"><span>Switch Type&nbsp;</span></td>
                                            <td>
                                                <input type="radio" name="switchtype" value="1"  />1S&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name="switchtype" value="2" />&nbsp;&nbsp;2S&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name="switchtype" value="3" />&nbsp;&nbsp;Both&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name="switchtype" value="0" checked="checked"/>&nbsp;&nbsp;NOS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div align='left' class="tab-content">
                                    <div class="alert alert-info">
                                        <ul>
                                            <li>Switch Type- 1S : Skip 1st consent only</li>
                                            <li>Switch Type- 2S : Skip 2nd consent only</li>
                                            <li>Switch Type- Both : Skip both consent</li>
                                            <li>Switch Type- NOS : Not Skip any consent </li>
                                        </ul>
                                    </div>
                                </div> 
                            </div>
