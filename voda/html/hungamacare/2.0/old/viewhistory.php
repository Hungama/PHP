...
if(isset($_SESSION['authid']))
{
	...
	$get_query="select batch_id,file_name,added_on,service_type,channel,price_point,upload_for,total_file_count,service_id,status,success_count,failure_count,InRequest from ";
...
<?php
	...
	?>
		...
		<TD bgcolor="#FFFFFF" align="center"><?php echo $summarydata[10];?></TD>
		<TD bgcolor="#FFFFFF" align="center"><?php echo $summarydata[11];?></TD>
	 </TR>
<?php
