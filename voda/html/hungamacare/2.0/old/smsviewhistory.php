...
<?php
	while($summarydata = mysql_fetch_array($query)) 
	{
		...
		$fileUrl="http://119.82.69.212/kmis/services/hungamacare/bulkuploads/".$summarydata['service_id']."/".$summarydata['file_name'].".csv";
	...
	?>
		...
		<TD bgcolor="#FFFFFF" align="center"><?php echo $summarydata[3];?></TD>
		<TD bgcolor="#FFFFFF" align="center"><?php echo $summarydata[4];?></TD>
	 </TR>
<?php
