...
<TBODY>
   <TR>
       <td>Select Report :: <select name='reportName'>
		...
		<option value='callingLog.php?serviceName=voda54646'>Vodafone 54646</option>
		<option value='callingLog.php?serviceName=vodap'>Vodafone 54646 Pause</option>
		<option value='callingLog.php?serviceName=vodamtv'>Vodafone Mtv</option>	
		<option value='callingLog.php?serviceName=vodaredfm'>Vodafone RedFM</option>	
		<option value='callingLog.php?serviceName=vodavh1'>Vodafone VH1</option>
		<Select></td>
