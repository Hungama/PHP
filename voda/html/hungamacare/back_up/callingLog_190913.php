...
?>
	...
	<?php
		$var12="http://203.199.126.129/hungamacare/showReport.php?serviceName=".$serviceName;
...
<?php
	...
	{
		header("location:http://203.199.126.129/hungamacare/callingLog.php?error=1");
		exit;
	}
	...
	if($serviceName=='voda54646')								
		$mis_data_query .=" and dnis LIKE '54646%' and dnis != '546468' and dnis !='5464681' and dnis not like '%p%' and operator in ('VODM')";	// Vodafone 54646 - dnis NOT IN ('546461','54646935')
	if($serviceName=='vodamtv')								
		$mis_data_query .=" and dnis LIKE '54646%' and dnis !='5464681' and operator in ('VODM')";			// Merger: NOT IN ('54646935') Vodafone MTV: dnis in(546461)
	...
	if($serviceName=='vodap')								
        ...
        if($serviceName=='vodamnd')								
		$mis_data_query .=" and dnis LIKE '546468' and dnis not like '%p%' and operator in ('VODM')";	
        if($serviceName=='vodapoet')								
		$mis_data_query .=" and dnis LIKE '5464681'  and dnis not like '%p%' and operator in ('VODM')";	
