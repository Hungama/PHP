...
include("dbConnect.php");
	...
	$select_query="select file_name, added_on, service_type, channel, price_point, upload_for,batch_id,service_id,language from vodafone_hungama.bulk_upload_history where status=0 order by added_on desc limit 1";
