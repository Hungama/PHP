...
?>
	...
	<?php
		$var12="http://10.43.248.137/hungamacare/showReport.php?serviceName=".$serviceName;
...
<?php
	...
	{
		header("location:http://10.43.248.137/hungamacare/callingLog.php?error=1");
		exit;
	}
	...
	if($serviceName=='voda54646')								
		$mis_data_query .=" and dnis NOT IN ('546461') and operator in('vodm') ";			// Vodafone 54646 and dnis NOT IN ('546461','54646935') and operator in ('VODM')
	if($serviceName=='vodamtv')								
		$mis_data_query .=" and dnis in(546461) and operator in ('VODM')";			// Vodafone 54646
	if($serviceName=='vodaredfm')								
		$mis_data_query .=" and dnis in(54646935) and operator in ('VODM')";			// Vodafone 54646
