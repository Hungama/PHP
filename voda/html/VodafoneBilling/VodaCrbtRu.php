...
$logFile="RUCrbtResponse_".date("ymd").".txt";
...
if(strtoupper($result1)=='ACTIVE' || strtoupper($result1)=='DEACTIVE')
{
	...
	$selecTone .="_CLASS=DEFAULT&SELECTION_INFO=HUNGAMA&COSID=1";
...
elseif(strtoupper($result1)=='NEW_USER')
{
	...
	$activeAndSelect.="PROMO_ID=".$PROMO_ID."&SELECTED_BY=IVR_3P&CATEGORY_ID=3&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT&SELECTION_INFO=HUNGAMA&COSID=1";
