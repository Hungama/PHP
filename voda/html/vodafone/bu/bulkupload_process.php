...
$lang_id="01";
		...
		if($serviceId==1116) {
			...
			if(move_uploaded_file($_FILES['upfile']['tmp_name'], $path))
			{
				...
				$dbaccess='mts';
				$Uploadquery="insert into billing_intermediate_db.bulk_upload_history(batch_id, service_type, channel, price_point, file_name, added_by, added_on, upload_for,status,operator,total_file_count,service_id,amount,language) values('".$batchId."','".$subtype."', '".$channel."', '".$planId."', '".$makFileName."', '".$_SESSION['loginId']."', '".$thisTime."', '".$_POST['upfor']."',0,'".$dbaccess."','".$file_size."','".$serviceId."','".$getAmount."','".$lang."')";
