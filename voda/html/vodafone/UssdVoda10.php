...
$url  ="https://cgussd.vodafone.in:443/VodafoneConfirmation/RequestConfirmation?";
$url .="MSISDN=9930130510&Service=HNG_ENTRMNTPORTAL&Class=ENTRMNTPORTAL&Mode=USSD&Requestid=".$timestamp;
$url .="&Circle-Id=15&Loginid=HunGamA@&password=MsgHunGama&partner_id=16&Action=<String>";
$url .="&Timestamp=$timestamp&ussdString=1223&From<String>&param1<String>&param2<String>&param3<String>";
echo $url;
