...
?>
	...
	<!--
			<td><a href='http://10.2.73.156/kmis/services/hungamacare/callingLog.php?serviceName=<?=$serviceName;?>'>Callling Log</a></td>
	-->
	</tr>
	</table>
<?
...
from mis_db.daily_report where report_date='$view_date1'";
...
while($mis_array=mysql_fetch_array($mis_data))
{
	if(isset($mis_array[3]))
	{
		...
		//$service_name[0]='54646';
		// Add Service Name for Different Service Name 
		switch($service_name[1])
		{
			case '1501':
				$service_name[0]='EndlessMusic';
			break;
			case '1502':
				$service_name[0]='54646';
			break;
			case '1503':
				$service_name[0]='Airtel_mtv';
			break;
		}
