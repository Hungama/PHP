...
switch (strtolower($serviceName)) {
    ...
    case 'eu30':
        ...
        //$subscriptionProcedure = "RADIO_BULK";
...
$response_logPath = "/var/www/html/airtel/logs/airtelSub/" . $sid . "/responselog_" . date("Y-m-d") . ".txt";
...
if (checkmsisdn($msisdn) && $serviceName) {
    ...
    $response_str = "<?xml version='1.0' encoding='ISO-8859-1'?>\n<TUNNELING>\n<STATUS>" . $response . "</STATUS>\n<MSISDN>" . $msisdn . "</MSISDN>\n<LARGEACOUNT>58236</LARGEACOUNT>\n<APPLICATIONID>" . $sid . "</APPLICATIONID>\n<REQUESTID>" . $requestId . "</REQUESTID>\n<MESSAGE>\n<CONTENT>" . $response1 . "</CONTENT>\n<MENU>\n<ITEM>\n<INDEX></INDEX>\n<TEXT></TEXT>\n<ADDRESS></ADDRESS>\n<CODE></CODE>\n</ITEM>\n</MENU>\n</MESSAGE>\n</TUNNELING>\n";
    echo $response_str;
    $response_str = str_replace("\n","",$response_str);
    error_log($response_str, 3, $response_logPath);
