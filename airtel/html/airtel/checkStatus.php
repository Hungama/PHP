	...
	for($i=1;$i<=$abc;$i++)
	{
		switch($serviceArray[$i])
		{
			...
			case 'airtel_hungama.tbl_arm_subscription':
				...
				break;
			case 'airtel_smspack.TBL_ASTRO_SUBSCRIPTION':
				$serviceId='55001';
				$serviceName='Airtel Ur Zodic';
				break;
			case 'airtel_smspack.TBL_SEXEDU_SUBSCRIPTION':
				$serviceId='55001';
				$serviceName='Airtel Sex Education';
				break;
			case 'airtel_smspack.TBL_VASTU_SUBSCRIPTION':
				$serviceId='55001';
				$serviceName='Airtel Vastu';
				break;
		}
