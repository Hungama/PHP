...
if($reqtype == 0) {
	...
	{	
		case '1514':
		case '1517': $response="Welcome! Please type customer's 10 digit mobile no."."\n"."Reply";	
...
if((strlen($reqtype)>2) && ($serviceId==1514 || $serviceId==1517 || $serviceId==1513) && $retData) {	
	...
	if(!$planid) {
		...
		switch($serviceId) {			
			...
			break;
			case '1517': $message = "Job aur padai mein tarakki ke liye seekhiye Spoken English apne mobile par! Subscribe karne ke liye reply mein bhejiye YES. Rs.5/day. Aptech certified!";
