			...
			if($rows1[0]<=0) 
			{
                ...
                switch ($status1) {
                    ...
                    case '11':
                        ...
                        break;
                    case '0':
                        $response = "User ko pehle hi " . $sName1 . "refer kiya gaya hai.User response ka intezar hai";
                        break;
                    case '5':
                        $response =  $sName1 . " par is user ko pehle hi refer kiya gaya hai aur uski request process mein hai";
                        break;
                    default :
