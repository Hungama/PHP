...
if((strlen($reqtype)==10 || strlen($reqtype)==12) && $serviceId == '1514') $serviceId='1517';
...
if($serviceId==1 || $serviceId==1514 || $serviceId==1517) {
	...
	if($circle == "UPW" && ($serviceId == 1515)) $referCount=1;
}
$referUrl = "/var/www/html/airtel/referFriend.php"; 
//echo $referCount; echo $serviceId; die;

$frndMDN = $reqtype;
if($referCount && ($serviceId == 1517 || $serviceId == 1515 || $serviceId == 1514 || strlen($reqtype)==10 || strlen($reqtype)==12)) {			
