 ...
 <form name="frm" method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>" onSubmit="return checkfield()" enctype="multipart/form-data">
    <TABLE width="50%" align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1" class="txt">
	  ...
	  <TR height="30">
        ...
        <TD bgcolor="#FFFFFF">&nbsp;&nbsp;
			<INPUT TYPE="radio" NAME="upload_for" value="promotion" onclick="showTable('p');" checked> PROMOTIONAL
			<INPUT TYPE="radio" NAME="upload_for" value="engagement" onclick="showTable('e');"> ENGAGEMENT 
		</TD>
      </TR>
	  <!--<TR height="30" id="scrubbing">
        <TD bgcolor="#FFFFFF"><B>Scrubbing Status</B></TD>
        <TD bgcolor="#FFFFFF">&nbsp;&nbsp;
			<INPUT TYPE="radio" NAME="ss" value="bulk"> Scrubbing
			<INPUT TYPE="radio" NAME="ss" value="NONDND" checked> Non-Scrubbing 
		</TD>
      </TR> -->
	  <TR height="30">
