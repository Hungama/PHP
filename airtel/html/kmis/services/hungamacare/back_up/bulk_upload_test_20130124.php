...
<TABLE width="80%" align="center" border="0" cellpadding="0" cellspacing="0" class="txt">
      ...
      <TR height="30">
        <TD bgcolor="#FFFFFF">
			<a href='selectservice.php'><B><FONT COLOR="#FF0000">Home</FONT></B></a> || <B><a href="viewhistory.php?sid=<?php echo $_GET['service_info'];?>"><FONT COLOR="#FF0000">View Upload History</font></a></B>
		</TD>
