...
$get_option="select b.module_id, a.module_name from master_db.ivr_web_module_master a, master_db.ivr_web_user_module b where a.id=b.module_id and b.user_id='$_SESSION[usrId]'";
  ...
  <tbody><tr>
	...
	<SELECT NAME="modules" class="in" onChange="window.open(this.options[this.selectedIndex].value,'_top')">
        ...
        if(in_array("Customer Care", $arrPermissibleModule)) { ?>
            <OPTION VALUE="main.php?service_info=<?php echo $service_info;?>" <?php if($pfile=="main.php" || $pfile==""){ echo "selected"; }?>>Customer Care</OPTION>    
