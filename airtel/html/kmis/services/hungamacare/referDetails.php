...
<form name="tstest" action='referDetails.php' method='POST'>
...
<div align='left' width="70%"><a href='downloadRetCsv.php?date=<?php echo $viewDate."&max=".$max."&start=".$start; ?>'>Download data</a> | <a href='referDetails.php?timestamp=<?php echo $viewDate;?>'><font color="#FF0000">Home</font></a></div>
...
?>
	<tr align='center'>	
		...
		<td bgcolor="#FFFFFF" height="30px"><?php echo $chrg_amount;?></td>	
