...
<?php
$operator='airtel';
$query1="select count(*) from master_db.tbl_whlservice_list where operator='".$operator."'";
$queryresult1=mysql_query($query1);
$row1= mysql_fetch_row($queryresult1);

$query="select service_id, service_name from master_db.tbl_whlservice_list where operator='".$operator."'";
...
<td align='right' colspan='2'>
 <a href="status.php"><font color='red' size='2'>Show Status</font></a>
 </td>
 </tr>
 </table>
...
<!--<tr>
	<td align ='center' ><font size='2' >DNIS</font></td>
	<td>
		<select name="shortcode" id="dnis" onchange="ShowItem()">
