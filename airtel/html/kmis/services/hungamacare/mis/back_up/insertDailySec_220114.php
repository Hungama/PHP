...
like '546463%' or dnis like '546469%' ) and dnis not in('546461','546461000','5464612') and dnis not like '%P%' 
...
and dnis !='5464640' and dnis != '5464643' and dnis not like '%P%' group by circle";
...
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' 
and (dnis=54646 or dnis like '546465%' or dnis like '546464%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%') 
and dnis !='5464640' and dnis != '5464643' and dnis not like '%P%' group by circle,status";
