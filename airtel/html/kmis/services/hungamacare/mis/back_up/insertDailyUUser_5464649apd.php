...
and dnis !=5464649 and operator='airm' group by circle";
$uu_tf_query .=" Union select 'UU_T',circle, count(distinct msisdn),'Airtel54646' as service_name,date(call_date) from mis_db.tbl_54646_calllog 
