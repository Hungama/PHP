...
where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis like '546463%'
 or dnis like '546469%' or dnis like '5464646%' )
...
$call_tf=array();
$call_tf_query="select 'CALLS_TF',circle, count(id),'54646' as service_name,date(call_date),status from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis like '546463%' 
or dnis like '546469%' or dnis like '5464646%') and dnis not in('546461','546461000','5464612') 
...
//start code to insert the data for call_tf Airtel 54646
$call_tf=array();
$call_tf_query="select 'CALLS_TF',substr(dnis,9,3) as circle, count(id),'54646P' as service_name,date(call_date),dnis 
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis like '%34P%' and operator='airm' group by dnis";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
...
$call_tf=array();
$call_tf_query="select 'CALLS_TF',substr(dnis,9,3) as circle, count(id),'54646' as service_name,date(call_date),status,dnis 
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis like '%34P%' and operator='airm' group by status,dnis";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
...
values('$view_date1', '$call_tf[0]','$circle','0','$call_tf[2]','','1513','NA','NA','NA')";
		$queryIns_call = mysql_query($insert_call_tf_data, $dbConn);
	}
}
...
$call_tf=array();
$call_tf_query="select 'CALLS_T_6',circle, count(id),'AirtelDevo' as service_name,date(call_date) from mis_db.tbl_devotional_calllog 
...
$call_tf=array();
$call_tf_query="select 'CALLS_T_6',circle, count(id),'AirtelDevo' as service_name,date(call_date),status from mis_db.tbl_devotional_calllog 
where date(call_date)='$view_date1' and dnis = '510168' and operator='airm' group by circle";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
	...
	{
                if($call_tf[5]==1)
			$call_tf[0]='L_CALLS_T_6';
		elseif($call_tf[5]!=1)
			$call_tf[0]='N_CALLS_T_6';
...
$call_tf=array();
$call_tf_query="select 'CALLS_TF',circle, count(id),'AirtelEU' as service_name,date(call_date) from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis like '546469%' and operator='airm' and dnis != '5464694' group by circle";
$call_tf_query .=" Union select 'CALLS_TF',circle, count(id),'AirtelEU' as service_name,date(call_date) from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis = '5464694' and operator='airm' and circle in('kol','wbl') group by circle";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
...
$call_tf=array();
$call_tf_query="select 'CALLS_TF',circle, count(id),'AirtelEU' as service_name,date(call_date),status from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis like '546469%' and operator='airm' and dnis != '5464694' group by circle,status";
$call_tf_query .=" Union select 'CALLS_TF',circle, count(id),'AirtelEU' as service_name,date(call_date),status from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis = '5464694' and operator='airm' and circle in('kol','wbl') group by circle,status";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
...
and (dnis not like '%P%' or dnis !=5464640) and dnis != '5464643' and dnis !='5464649' and operator='airm' group by circle";
$call_tf_query .=" Union select 'CALLS_T',circle, count(id),'54646' as service_name,date(call_date) from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and dnis='5464649'  and circle='apd' and operator='airm' group by circle";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
...
and (dnis=54646 or dnis like '546465%' or dnis like '546464%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%' ) 
and (dnis not like '%P%' and dnis != 5464640) and dnis !='5464643'  and dnis !=5464649 and operator='airm'  group by circle,status";
$call_tf_query .=" Union select 'CALLS_T',circle, count(id),'54646' as service_name,date(call_date),status 
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis=5464649  and circle='apd'  and operator='airm'  group by circle,status";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
