...
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' 
and dnis ='55001963' and circle NOT IN ('DEL') and operator='airm' group by circle";
...
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis ='55001963' 
and circle NOT IN ('DEL') and operator='airm' group by circle,status";
