...
and (dnis not like '%P%'  and dnis !='5464640') and dnis != '5464643' and dnis !=5464649 and operator='airm' group by circle";
$mous_tf_query .=" Union select 'MOU_T',circle, count(id),'54646' as service_name,date(call_date),sum(duration_in_sec)/60 
as mous from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis=5464649  and circle='apd'  and operator='airm' group by circle";
$mous_tf_result = mysql_query($mous_tf_query, $dbConn) or die(mysql_error());
$numRows2 = mysql_num_rows($mous_tf_result);
if ($numRows2 > 0)
{
...
$mous_tf_query .=" Union select 'MOU_T',circle, count(id),'54646' as service_name,date(call_date),sum(duration_in_sec)/60 as mous,status 
