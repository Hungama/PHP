...
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis like '546463%' or dnis like '546469%' or dnis like '5464646%') 
...
and dnis not in('546461','546461000','5464612') and operator='airm' group by circle,status";
...
$pulse_tf_query .=" Union select 'PULSE_T',circle, count(id),'54646' as service_name,date(call_date),sum(ceiling(duration_in_sec/60)) as pulse from mis_db.tbl_54646_calllog 
...
$pulse_tf_query .=" Union select 'PULSE_T',circle, count(id),'54646' as service_name,date(call_date),sum(ceiling(duration_in_sec/60)) as pulse,status 
