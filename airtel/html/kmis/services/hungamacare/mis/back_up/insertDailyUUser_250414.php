...
//and dnis not in('546461','546461000','5464612','5464640') and operator='airm' and dnis not like '%P%' group by circle";
...
and dnis !='5464640' and dnis !='5464612' and dnis != '5464643' and dnis not like '%P%'
...
//and dnis != '5464640' and dnis != '5464612' and dnis not like '%P%' and operator='airm' and status in(-1,11,0) 
//AND MSISDN  NOT IN( select DISTINCT MSISDN from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' 
//and (dnis=54646 or dnis like '546465%' or dnis like '546464%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%' ) and dnis != '5464643'
//and dnis != '5464640' and dnis != '5464612' and dnis not like '%P%' and operator='airm' and status IN (1)) group by circle)";
//$uu_tf_query .= " UNION (select 'UU_TF',circle, count(distinct msisdn),'Airtel54646' as service_name,date(call_date),status,'Active' as 'user_status' 
//from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and (dnis=54646 or dnis like '546465%' or dnis like '546464%' or dnis like '546466%' or 
//dnis like '546467%' or dnis like '546468%' ) and dnis != '5464643' and dnis != '5464640' and dnis != '5464612'  and dnis not like '%P%' and operator='airm' and status=1 group by circle)";
$uu_tf_query = "(select 'UU_TF',circle, count(distinct msisdn),'Airtel54646' as service_name,date(call_date),status,'Non Active' as 'user_status' from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' 
and (dnis=54646 or dnis like '546465%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%' or dnis='5464646') and dnis != '5464643'
and dnis != '5464640' and dnis != '5464612' and dnis not like '%P%' and operator='airm' and status in(-1,11,0) 
AND MSISDN  NOT IN( select DISTINCT MSISDN from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' 
and (dnis=54646 or dnis like '546465%' or dnis like '546464%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%' or dnis='5464646') and dnis != '5464643'
and dnis != '5464640' and dnis != '5464612' and dnis not like '%P%' and operator='airm' and status IN (1)) group by circle)";
$uu_tf_query .= " UNION (select 'UU_TF',circle, count(distinct msisdn),'Airtel54646' as service_name,date(call_date),status,'Active' as 'user_status' 
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and (dnis=54646 or dnis like '546465%' or dnis like '546466%' or 
dnis like '546467%' or dnis like '546468%' or dnis='5464646') and dnis != '5464643' and dnis != '5464640' and dnis != '5464612'  and dnis not like '%P%' and operator='airm' and status=1 group by circle)";
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$uu_tf[0]','$pcircle','0','$uu_tf[2]','','1502P','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
$uu_tf = array();
$uu_tf_query = "select 'UU_T',substr(dnis,9,3) as circle, count(distinct msisdn),'pauseCode' as service_name,date(call_date) from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and dnis like '%47p%' and operator='airm' group by circle";
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1502P','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
$uu_tf = array();
$uu_tf_query = "select 'UU_TF',circle, count(distinct msisdn),'AirtelMtv' as service_name,date(call_date) from mis_db.tbl_mtv_calllog 
where date(call_date)='$view_date1' and dnis in(546461,546461000) and operator='airm' group by circle";
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1503','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1507','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
$uu_tf = array();
$uu_tf_query = "select 'UU_T',circle, count(distinct msisdn),'AirtelVH1' as service_name,date(call_date) from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and dnis=55841 and circle NOT IN ('DEL','NES','ASM') and operator='airm' group by circle";
...
$uu_tf = array();
$uu_tf_query = "select 'UU_T',circle, count(distinct msisdn),'AirtelGL' as service_name,date(call_date) from mis_db.tbl_ldr_calllog 
where date(call_date)='$view_date1' and dnis like '55001%' and circle NOT IN ('DEL') and operator='airm' group by circle";
...
from mis_db.tbl_ldr_calllog item INNER JOIN(SELECT msisdn  FROM mis_db.tbl_ldr_calllog where date(call_date) between '$last_7day_end' and '$last_7day_start'
...
$uu_tf = array();
$uu_tf_query = "select 'UU_TF',circle, count(distinct msisdn),'AirtelEDU' as service_name,date(call_date) from mis_db.tbl_edu_calllog 
where date(call_date)='$view_date1' and dnis like '53222345%' and operator='airm' group by circle";
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1514','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
from mis_db.tbl_edu_calllog item INNER JOIN(SELECT msisdn FROM mis_db.tbl_edu_calllog where date(call_date) between '$last_7day_end' and '$last_7day_start'
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1513','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
//////////////////////////////////////////// start code to insert the data for Unique Users  for AirtelMND ///////////////////////////////////////////
$uu_tf = array();
$uu_tf_query = "select 'UU_T',circle, count(distinct msisdn),'AirtelMND' as service_name,date(call_date) from mis_db.tbl_mnd_calllog 
where date(call_date)='$view_date1' and dnis = '5500196' and circle NOT IN ('DEL') and operator='airm' group by circle";
...
from mis_db.tbl_mnd_calllog item INNER JOIN(SELECT msisdn FROM mis_db.tbl_mnd_calllog where date(call_date) between '$last_7day_end' and '$last_7day_start'
...
$uu_tf = array();
$uu_tf_query = "select 'UU_TF',circle, count(distinct msisdn),'AirtelDevo' as service_name,date(call_date) from mis_db.tbl_devotional_calllog 
where date(call_date)='$view_date1' and dnis like '51050%' and operator='airm' group by circle";
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1515','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
$uu_tf = array();
$uu_tf_query = "select 'UU_T_6',circle, count(distinct msisdn),'AirtelDevo' as service_name,date(call_date) from mis_db.tbl_devotional_calllog 
where date(call_date)='$view_date1' and dnis = '510168' and operator='airm' group by circle";
...
$uu_tf = array();
$uu_tf_query = "(select 'UU_T_6',circle, count(distinct msisdn),'AirtelDevo' as service_name,date(call_date),status,'Non Active' as 'user_status' from mis_db.tbl_devotional_calllog where date(call_date)='$view_date1' and dnis = '510168' and operator='airm' and status in(-1,11,0) AND MSISDN  NOT IN( select DISTINCT MSISDN from mis_db.tbl_devotional_calllog where date(call_date)='$view_date1' and dnis = '510168' and operator='airm' and status IN (1)) group by circle)";
$uu_tf_query .= " UNION (select 'UU_T_6',circle, count(distinct msisdn),'AirtelDevo' as service_name,date(call_date),status,'Active' as 'user_status' from mis_db.tbl_devotional_calllog where date(call_date)='$view_date1' and dnis = '510168' and operator='airm' and status=1 group by circle)";
...
from mis_db.tbl_devotional_calllog item INNER JOIN(SELECT msisdn FROM mis_db.tbl_devotional_calllog where date(call_date) between '$last_7day_end' and '$last_7day_start'
and (dnis like '51050%' or dnis = '510168') and operator='airm' )temp ON item.msisdn= temp.msisdn 
where date(item.call_date)='$view_date1' 
and (dnis like '51050%' or dnis = '510168') and operator='airm' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
and (dnis like '51050%' or dnis = '510168') and operator='airm' )temp ON item.msisdn= temp.msisdn 
where date(item.call_date)='$view_date1' 
and (dnis like '51050%' or dnis = '510168') and operator='airm' and circle='$uu_total[1]'";
        $repeat_query_exe = mysql_query($repeat_query, $dbConn) or die(mysql_error());
        $uu_repeat = mysql_fetch_array($repeat_query_exe);
        if ($uu_repeat[0] == '') {
            $uu_repeat[0] = 0;
...
$uu_tf = array();
$uu_tf_query = "select 'UU_TF',circle, count(distinct msisdn),'AirtelSE' as service_name,date(call_date) from mis_db.tbl_SPKNG_calllog 
where date(call_date)='$view_date1' and dnis like '571811%' and operator='airm' group by circle";
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec)
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1517','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
from mis_db.tbl_SPKNG_calllog item INNER JOIN(SELECT msisdn FROM mis_db.tbl_SPKNG_calllog where date(call_date) between '$last_7day_end' and '$last_7day_start'
...
$uu_tf = array();
$uu_tf_query = "select 'UU_TF',circle, count(distinct msisdn),'AirtelPK' as service_name,date(call_date) from mis_db.tbl_radio_calllog 
where date(call_date)='$view_date1' and dnis like '5464613%' and operator='airm' group by circle";
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec)
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1520','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}
...
$uu_tf = array();
$uu_tf_query = "select 'UU_TF',circle, count(distinct msisdn),'AirtelEU' as service_name,date(call_date) from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis like '546469%'  and dnis != '5464694' and operator='airm' group by circle";
$uu_tf_query .=" Union select 'UU_TF',circle, count(distinct msisdn),'AirtelEU' as service_name,date(call_date) from mis_db.tbl_AMU_calllog 
...
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
        ...
        $insert_uu_tf_data = "insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$uu_tf[0]','$circle','0','$uu_tf[2]','','1501','NA','NA','NA')";
        $queryIns_uu = mysql_query($insert_uu_tf_data, $dbConn);
    }
}

$uu_tf = array();
$uu_tf_query = "(select 'UU_TF',circle, count(distinct msisdn),'AirtelEU' as service_name,date(call_date),status,'Non Active' as 'user_status' 
from mis_db.tbl_AMU_calllog where date(call_date)='$view_date1' and dnis like '546469%'  and dnis != '5464694' and operator='airm' and status in(-1,11,0) AND 
MSISDN  NOT IN( select DISTINCT MSISDN from mis_db.tbl_AMU_calllog where date(call_date)='$view_date1' and dnis like '546469%' and dnis != '5464694' and operator='airm' and 
status IN (1)) group by circle)";
$uu_tf_query .= " UNION (select 'UU_TF',circle, count(distinct msisdn),'AirtelEU' as service_name,date(call_date),status,'Active' as 'user_status' 
from mis_db.tbl_AMU_calllog where date(call_date)='$view_date1' and dnis like '546469%'  and dnis != '5464694' and operator='airm' and status=1 group by circle)";
$uu_tf_query .=" UNION (select 'UU_TF',circle, count(distinct msisdn),'AirtelEU' as service_name,date(call_date),status,'Active' as 'user_status' 
from mis_db.tbl_AMU_calllog where date(call_date)='$view_date1' and dnis = '5464694' and circle in('kol','wbl') and operator='airm' and status=1 group by circle)";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    while ($uu_tf = mysql_fetch_array($uu_tf_result)) {
...
from mis_db.tbl_AMU_calllog  item INNER JOIN(SELECT msisdn FROM mis_db.tbl_AMU_calllog  where date(call_date) between '$last_7day_end' and '$last_7day_start'
and (dnis like '546469%' or (dnis = '5464694' and circle in('kol','wbl'))) and dnis != '5464694' and operator='airm')temp ON item.msisdn= temp.msisdn 
where date(item.call_date)='$view_date1' 
and (dnis like '546469%' or (dnis = '5464694' and circle in('kol','wbl'))) and dnis != '5464694' and operator='airm' group by item.circle";
$uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
$numRows4 = mysql_num_rows($uu_tf_result);
if ($numRows4 > 0) {
    $uu_tf_result = mysql_query($uu_tf_query, $dbConn) or die(mysql_error());
...
and (dnis like '546469%' or (dnis = '5464694' and circle in('kol','wbl'))) and dnis != '5464694' and operator='airm')temp ON item.msisdn= temp.msisdn 
where date(item.call_date)='$view_date1' 
and (dnis like '546469%' or (dnis = '5464694' and circle in('kol','wbl'))) and dnis != '5464694' and operator='airm' and circle='$uu_total[1]'";
        $repeat_query_exe = mysql_query($repeat_query, $dbConn) or die(mysql_error());
        $uu_repeat = mysql_fetch_array($repeat_query_exe);
        if ($uu_repeat[0] == '') {
            $uu_repeat[0] = 0;
...
$uu_tf = array();
$uu_tf_query = "select 'UU_TF',circle, count(distinct msisdn),'AirtelCK' as service_name,date(call_date) from mis_db.tbl_edu_calllog 
where date(call_date)='$view_date1' and dnis like '5464614%' and operator='airm' and circle in ('CHN','TNU') group by circle";
