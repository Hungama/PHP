...
//where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis like '546463%' 
//or dnis like '546469%' or dnis like '5464646%') and dnis not in('546461','546461000','5464612','5464640') 
//and dnis not like '%P%' and operator='airm' group by circle,status";
$call_tf_query="select 'CALLS_TF',circle, count(id),'54646' as service_name,date(call_date),status from mis_db.tbl_54646_calllog 
where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis like '546463%' 
or dnis like '546469%') and dnis not in('546461','546461000','5464612','5464640') 
and dnis not like '%P%' and operator='airm' group by circle,status";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
...
and (dnis not like '%P%' and dnis !=5464640 and dnis !=5464612) and dnis != '5464643' and operator='airm' group by circle";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
...
and (dnis=54646 or dnis like '546465%' or dnis like '546464%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%' or dnis='5464646' ) 
and (dnis not like '%P%' and dnis != 5464640 and dnis != 5464612) and dnis !='5464643' and operator='airm'  group by circle,status";
$call_tf_result = mysql_query($call_tf_query, $dbConn) or die(mysql_error());
$numRows1 = mysql_num_rows($call_tf_result);
if ($numRows1 > 0)
{
