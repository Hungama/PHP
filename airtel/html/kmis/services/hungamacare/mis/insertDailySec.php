...
//and dnis not in('546461','546461000','5464612','5464640') and dnis not like '%P%' and operator='airm' group by circle";
$sec_tf_query="select 'SEC_TF',circle, count(msisdn),'endless' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' 
...
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and (dnis like '546460%' or dnis like '546461%' or dnis like '546462%' or dnis 
like '546463%' or dnis like '546469%' ) and dnis not in('546461','546461000','5464612','5464640') and dnis not like '%P%' 
...
$sec_tf=array();
$sec_tf_query="select 'SEC_TF',substr(dnis,9,3) as circle, count(msisdn),'PauseCode' as service_name,date(call_date),
sum(duration_in_sec) from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis like '%34P%' 
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T',substr(dnis,9,3) as circle, count(msisdn),'PauseCode' as service_name,date(call_date),
sum(duration_in_sec) from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis like '%47P%' 
and operator='airm' group by circle";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_3',circle, count(msisdn),'AirtelMPMC' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' 
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_3',circle, count(msisdn),'AirtelMPMC' as service_name,date(call_date),sum(duration_in_sec),status
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_3',circle, count(msisdn),'AirtelMAN' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_edu_calllog 
where date(call_date)='$view_date1' and dnis like '5464643' and operator='airm'  group by circle,status";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_3',circle, count(msisdn),'AirtelMAN' as service_name,date(call_date),sum(duration_in_sec),status from 
...
$sec_tf=array();
$sec_tf_query="select 'SEC_TF',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' 
and ((dnis like '5500196%' and circle IN ('DEL')) OR (dnis like '54646196' and circle!='KAR') or dnis like '5500169' or dnis like '54646169'or dnis like '55001699') and operator='airm' group by circle";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		...
		$insert_sec_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$sec_tf[0]','$circle','0','$sec_tf[5]','','1513','NA','NA','NA')";
		$queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
	}
}

$sec_tf=array();
$sec_tf_query="select 'SEC_TF',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and ((dnis like '5500196%' and circle IN ('DEL')) OR (dnis like '54646196' and circle!='KAR') or dnis like '5500169' or dnis like '54646169'or dnis like '55001699') and operator='airm' group by circle,status";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_TF',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis like '54646196' and circle='KAR'  and operator='airm' group by circle";
...
//////////////////////////////// start code to insert the data for SEC_TF & SEC_T_6 for AirtelDevo ////////////////////////////////////////////////////////
$sec_tf=array();
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_6',circle, count(msisdn),'AirtelDevo' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_devotional_calllog where date(call_date)='$view_date1' and dnis like '510168%' and operator='airm' group by circle";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_6',circle, count(msisdn),'AirtelDevo' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_devotional_calllog where date(call_date)='$view_date1' and dnis like '510168%' and operator='airm' group by circle,status";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		if($sec_tf[6]==1) $sec_tf[0]='L_SEC_T_6';
		if($sec_tf[6]!=1) $sec_tf[0]='N_SEC_T_6';
...
//////////////////////////////////////// end insert the data for SEC_TF & SEC_T_6 for AirtelDevo ///////////////////////////////////////////////////////////
...
$sec_tf=array();
$sec_tf_query="select 'SEC_TF',circle, count(msisdn),'AirtelEU' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis like '546469%' and dnis != '5464694' and operator='airm' group by circle";
$sec_tf_query .=" Union select 'SEC_TF',circle, count(msisdn),'AirtelEU' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis = '5464694' and circle in('kol','wbl') and operator='airm' group by circle";
$sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
$numRows5 = mysql_num_rows($sec_tf_result);
if ($numRows5 > 0)
{
...
$sec_tf=array();
$sec_tf_query="select 'SEC_TF',circle, count(msisdn),'AirtelEU' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis like '546469%' and dnis != '5464694' and operator='airm' group by circle,status";
$sec_tf_query .=" Union select 'SEC_TF',circle, count(msisdn),'AirtelEU' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_AMU_calllog 
where date(call_date)='$view_date1' and dnis = '5464694' and circle in('kol','wbl') and operator='airm' group by circle,status";
$sec_tf_result = mysql_query($sec_tf_query, $dbConn) or die(mysql_error());
$numRows5 = mysql_num_rows($sec_tf_result);
if ($numRows5 > 0)
{
...
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' 
and (dnis=54646 or dnis like '546465%' or dnis like '546464%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%' or dnis='5464646') 
and dnis !='5464640' and dnis !='5464612' and dnis != '5464643' and dnis not like '%P%' group by circle";
...
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' 
and (dnis=54646 or dnis like '546465%' or dnis like '546464%' or dnis like '546466%' or dnis like '546467%' or dnis like '546468%' or dnis='5464646') 
and dnis !='5464640' and dnis !='5464612' and dnis != '5464643' and dnis not like '%P%' group by circle,status";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T',circle, count(msisdn),'AirtelVH1' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_54646_calllog where date(call_date)='$view_date1' and dnis=55841 and circle NOT IN ('NES','DEL','ASM') and operator='airm' group by circle";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		...
		$insert_sec_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
values('$view_date1', '$sec_tf[0]','$circle','0.03','$sec_tf[5]','','1507','NA','NA','NA')";
		$queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
	}
}
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T',circle, count(msisdn),'AirtelGL' as service_name,date(call_date),sum(duration_in_sec) 
from mis_db.tbl_ldr_calllog where date(call_date)='$view_date1' and dnis like '55001%' and circle NOT IN ('DEL') and operator='airm' group by circle";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		...
		$insert_sec_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) 
                values('$view_date1', '$sec_tf[0]','$circle','0.02','$sec_tf[5]','','1511','NA','NA','NA')";
		$queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
	}
}
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec) from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis = '5500196' and circle NOT IN ('DEL') and operator='airm' group by circle";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		...
		$insert_sec_tf_data="insert into mis_db.daily_report(report_date,type,circle,charging_rate,total_count,mode_of_sub,service_id,mous,pulse,total_sec) values('$view_date1', '$sec_tf[0]','$circle','0.02','$sec_tf[5]','','1513','NA','NA','NA')";
		$queryIns_sec = mysql_query($insert_sec_tf_data, $dbConn);
	}
}

$sec_tf=array();
$sec_tf_query="select 'SEC_T',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec),status from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis = '5500196' and circle NOT IN ('DEL') and operator='airm' group by circle,status";
...
/////////////////////////////start code to insert the data for SEC_T_1 for AirtelMND/////////////////////////////////////////////////
$sec_tf=array();
$sec_tf_query="select 'SEC_T_1',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec)
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' 
and dnis ='55001961' and operator='airm' group by circle";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_1',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis ='55001961' 
 and operator='airm' group by circle,status";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		...
		if($sec_tf[6]!=1) $sec_tf[0]='N_SEC_T_1';
...
/////////////////////////////END code to insert the data for SEC_T_1 for AirtelMND/////////////////////////////////////////////////

/////////////////////////////start code to insert the data for SEC_T_3 for AirtelMND/////////////////////////////////////////////////
$sec_tf=array();
$sec_tf_query="select 'SEC_T_3',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec)
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' 
and dnis ='55001963' and operator='airm' group by circle";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_3',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis ='55001963'  and operator='airm' group by circle,status";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		if($sec_tf[6]==1) $sec_tf[0]='L_SEC_T_3';
		if($sec_tf[6]!=1) $sec_tf[0]='N_SEC_T_3';
...
/////////////////////////////END code to insert the data for SEC_T_3 for AirtelMND/////////////////////////////////////////////////

/////////////////////////////start code to insert the data for SEC_T_5 for AirtelMND/////////////////////////////////////////////////
$sec_tf=array();
$sec_tf_query="select 'SEC_T_5',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec)
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' 
and dnis ='55001965' and circle NOT IN ('DEL') and operator='airm' group by circle";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_5',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis ='55001965' 
and circle NOT IN ('DEL') and operator='airm' group by circle,status";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		if($sec_tf[6]==1) $sec_tf[0]='L_SEC_T_5';
		if($sec_tf[6]!=1) $sec_tf[0]='N_SEC_T_5';
...
/////////////////////////////END code to insert the data for SEC_T_5 for AirtelMND/////////////////////////////////////////////////
/////////////////////////////start code to insert the data for SEC_T_6 for AirtelMND/////////////////////////////////////////////////
$sec_tf=array();
$sec_tf_query="select 'SEC_T_6',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec)
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' 
and dnis ='55001966' and circle NOT IN ('DEL') and operator='airm' group by circle";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_6',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis ='55001966' 
and circle NOT IN ('DEL') and operator='airm' group by circle,status";
...
/////////////////////////////END code to insert the data for SEC_T_6 for AirtelMND/////////////////////////////////////////////////
/////////////////////////////start code to insert the data for SEC_T_9 for AirtelMND/////////////////////////////////////////////////
$sec_tf=array();
$sec_tf_query="select 'SEC_T_9',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec)
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' 
and dnis ='55001969' and circle NOT IN ('DEL') and operator='airm' group by circle";
...
$sec_tf=array();
$sec_tf_query="select 'SEC_T_9',circle, count(msisdn),'AirtelMND' as service_name,date(call_date),sum(duration_in_sec),status 
from mis_db.tbl_mnd_calllog where date(call_date)='$view_date1' and dnis ='55001969' 
and circle NOT IN ('DEL') and operator='airm' group by circle,status";
...
if ($numRows5 > 0)
{
	while($sec_tf = mysql_fetch_array($sec_tf_result))
	{
		if($sec_tf[6]==1) $sec_tf[0]='L_SEC_T_9';
		if($sec_tf[6]!=1) $sec_tf[0]='N_SEC_T_9';
