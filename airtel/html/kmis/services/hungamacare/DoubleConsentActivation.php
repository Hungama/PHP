...
<script language="javascript">
	...
	else if(document.getElementById('Scode').value=='0') {
                ...
                <select name='service' id="service" onchange="showHidemore()">			
				 <option value='0'>Select Service</option>
				   ...
				   <option value='1513'>Airtel-MND</option>
                    ...
                    <option value='15020'>Hungama Entertainment portal - 546460</option>
                    <option value='15022'>Luv Guru - 546462</option>
                    <option value='15023'>Music World - 546463</option>
                    <option value='15031'>MTV DJ Dial - 546461</option-->
                </select></td>
        </tr>
        <tr>
            <td bgcolor="#FFFFFF" height="30px">Short Code:</td>
            <td bgcolor="#FFFFFF" height="30px"><select name='Scode' id="Scode">
                    ...
                    <!--option value='546469'>546460</option>
                    <option value='546469'>546462</option>
                    <option value='546469'>546463</option-->
                </select></td>
        </tr>
