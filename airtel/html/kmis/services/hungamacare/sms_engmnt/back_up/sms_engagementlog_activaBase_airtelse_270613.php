...
$query = "select a.ani,b.circle,b.message from airtel_SPKENG.tbl_spkeng_subscription a,master_db.tbl_sms_engagement b 
    where (date(b.scheduledDate)=date(now()) or daily_msg=1)
    and a.status=1 and date(b.added_on) = CURDATE() and  a.circle=b.circle and b.service_id=1517 and b.type='active_base' and b.status=1 ";
