...
<div class='txt' align='right'><a href='showDirectActivationData.php'>Show Time-Slots</a>&nbsp;&nbsp;&nbsp;</div>
<form name="tstest" action='DirectActivation_test.php' method='POST' onSubmit="return validateData();">
