...
$serviceArray1 = array('1515' => 'AirtelDevo','1502' => 'Airtel54646');
...
<html lang="en">
    <head>
        ...
        <title><?php echo "AD CAMPAIGN"; ?></title>
        <?php
        echo CONST_CSS;
...
<!--                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    <?php
                                                    $selectQuery = "SELECT ad_name FROM Airtel_IVR.tbl_ad_nameMap WHERE status=1";
                                                    $querySel = mysql_query($selectQuery, $dbConn);
                                                    ?>
