            ...
            if ($msg != '') {
                if ($type == '35') {
                    ...
                    if ($rows['sms_type'] == 'engagement') {
                        echo $procedureCall = "CALL master_db.SENDSMS('8130335773','" . $msg . "','" . $rows['sms_cli'] . "',2,'51050','promo')";
                    } else {
                        echo $procedureCall = "CALL master_db.SENDSMS('8130335773','" . $msg . "','" . $rows['sms_cli'] . "',0,'51050','promo')";
                    }
