...
$nowtime = '06:55 PM';
echo $qry = "select rule_id,time_slot,action_name,sms_cli,sms_sequence from master_db.tbl_rule_engagement_action where status=1 and time_slot='" . $nowtime . "' and action_name='sms'";
