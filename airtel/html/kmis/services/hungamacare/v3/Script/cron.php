...
$processlog = "/var/www/html/kmis/services/hungamacare/v3/Script/logs/processlog_" . date('Ymd') . ".txt";
$querylog = "/var/www/html/kmis/services/hungamacare/v3/Script/querylog_" . date('Ymd') . ".txt";
$deleted_file1 = "/var/www/html/kmis/services/hungamacare/v3/Script/logs/processlog_" . date("Ymd", mktime(0, 0, 0, date("m"), date("d") - 2, date("Y"))) . ".txt";
unlink($deleted_file1);
$deleted_file2 = "/var/www/html/kmis/services/hungamacare/v3/Script/querylog_" . date("Ymd", mktime(0, 0, 0, date("m"), date("d") - 2, date("Y"))) . ".txt";
unlink($deleted_file2);
        ...
        if ($noofRulerows == 0) {
            ...
            if ($msg != '') {
                if ($type == '35') {
                    ...
                    //echo $procedureCall = "call master_db.SENDSMS_NEW(" . $ani . ",'" . $msg . "','" . $rows['sms_cli'] . "','airm','sms-promo',5)";
                    ...
                    echo $log_path = "/var/www/html/kmis/services/hungamacare/v3/logs/" . $service_id . "/" . $type . "/" . $rule_id . "_" . $date . ".log";
                    unlink($log_path);
                    ...
                    include("/var/www/html/kmis/services/hungamacare/v3/new_engagement/new_engagementSendSms.php");

                    include("/var/www/html/kmis/services/hungamacare/v3/new_engagement/new_engagementdata.php");

                    //include("/var/www/html/kmis/services/hungamacare/v3/new_engagement/createNewEngagementDwnFile.php");
                }
                $data = "ruleid#" . $rows['rule_id'] . "#timeslot#" . $rows['time_slot'] . "\r\n";
                error_log($data, 3, $processlog);
            } else {
                echo $insertquery2 = "insert into master_db.tbl_new_engagement_data(count,added_on,service_id,status,type,rule_id,msg_sent_status) 
