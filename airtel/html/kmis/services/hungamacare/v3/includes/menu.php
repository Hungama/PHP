          ...
          <ul class="nav navbar-nav">
            ...
            <?php
                if(in_array("revenue",$AR_PList)) {?>
					...
					<?php echo item("revenue","bulk_sms","../2.0/sms_engagement.php","SMS Engagement (Old)");?>
                   <?php echo item("revenue","bulk_sms","../v3/rule_creation.php","SMS Engagement");?>
                ...
                if(in_array("revenue",$AR_PList)) {?>
                   ...
                   <?php echo item("revenue","switch_cc","../2.0/switch_control.php","Switch Control");?>
                   <?php //echo item("revenue","sms_report","SMSKCI.Services.php","SMS KCI's");?>
				   <?php echo item("revenue","revenue","add_campaign.php","Ad Control(IVR)");?>
