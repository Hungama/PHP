            ...
            <tr id="tr_edit_add_cc">
                ...
                <td align="left">
                    <select name="add_edit_cc[]" multiple="multiple" data-width="auto">
                        ...
                        <?php echo $action_array['cc_user'];
                        $action_array['cc_user'] = explode(",", $action_array['cc_user']);print_r($action_array['cc_user']);
                        $cc_user_count = count($action_array['cc_user']);
