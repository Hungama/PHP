            ...
            <TABLE class="table table-condensed table-bordered">
                ...
                while ($processData = mysql_fetch_array($processQuery)) {
                    ...
                    <TR height = "30">
                        ...
                        <TD><?php echo $Service_DESC[$serviceArray[$service_id]]['Name']; ?></TD>
                            ...
                            if ($processData['count'] == 0) {
                                ...
                                if ($action_data_array['action_name'] == 'sms') {
                                    ...
                                    <a href="xls_new_engagement.php?service_id=<?php echo $service_id ?>&type=<?php echo $processData['type'] ?>&added_on=<?php echo $lastProcessDate ?>&rule_id=<?php echo $rule_id ?>">
                                        ...
                                        $fmt_process_date = date('Y-m-d', strtotime($added_on));
                                        if (strtotime($fmt_process_date) > strtotime('2014-02-11')) {
                                            ?>
                        <!--                                        <a href="http://119.82.69.212/kmis/services/hungamacare/Airtel_NEW_ENGMNT/dndcheck/<?php echo $rule_id . '_' . $format_process_date . '.csv' ?>" target="_blank">-->
                                            <a href="http://119.82.69.212/kmis/services/hungamacare/Airtel_NEW_ENGMNT/<?php echo $filepath ?>" target="_blank">
                                            <?php } else { ?>
                                                <a href="http://119.82.69.212/kmis/services/hungamacare/Airtel_NEW_ENGMNT/dndcheck/<?php echo $rule_id . '_' . $format_process_date . '.csv' ?>" target="_blank">  
                                                <?php }
                                            }
