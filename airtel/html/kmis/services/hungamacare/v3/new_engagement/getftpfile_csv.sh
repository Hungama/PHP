...
filename_org="$1_*"
filePath="/var/www/html/kmis/services/hungamacare/v3/new_engagement/119.82.69.215/output/$filename_org"
#filename="testbyspt20140129_"
filename="$1_"
#filename2="testbyspt20140129.txt"
filename2="/var/www/html/kmis/services/hungamacare/v3/new_engagement/dndcheck/$1.csv"
