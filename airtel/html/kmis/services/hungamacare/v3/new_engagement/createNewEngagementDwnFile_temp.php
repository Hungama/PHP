...
echo $rule_id = '20';$service_id='1513';$status='1';
...
echo $log_path_service = "/var/www/html/kmis/services/hungamacare/v3/logs/" . $service_id . "/";
...
echo $log_path_type = "/var/www/html/kmis/services/hungamacare/v3/logs/" . $service_id . "/" . $type . "/";
