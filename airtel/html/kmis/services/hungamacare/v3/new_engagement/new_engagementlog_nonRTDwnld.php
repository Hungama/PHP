...
and DATE(NOW()-INTERVAL 1 DAY) and a.ani=b.ani )  and b.status in(1,11)";
...
and DATE(NOW()-INTERVAL 1 DAY) and a.ani=b.ani )  and b.status in(1,11)";
    ...
    if ($result_row_3days > 0) {
        echo $delete_query = "delete from master_db.tbl_new_engagement_number where date(added_on) = date(now()) and type = '31' and service_id='" . $s_id . "'";
...
and DATE(NOW()-INTERVAL 1 DAY) and a.ani=b.ani) and b.status in(1,11)";
    ...
    if ($result_row_5days > 0) {
        echo $delete_query = "delete from master_db.tbl_new_engagement_number where date(added_on) = date(now()) and type = '32' and service_id='" . $s_id . "'";
        mysql_query($delete_query, $dbConn);
...
and DATE(NOW()-INTERVAL 1 DAY) and a.ani=b.ani)  and b.status in(1,11)";
    ...
    if ($result_row_7days > 0) {
        echo $delete_query = "delete from master_db.tbl_new_engagement_number where date(added_on) = date(now()) and type = '33' and service_id='" . $s_id . "'";
        mysql_query($delete_query, $dbConn);
...
and DATE(NOW()-INTERVAL 1 DAY) and a.ani=b.ani)  and b.status in(1,11)";
    ...
    if ($result_row_15days > 0) {
        echo $delete_query = "delete from master_db.tbl_new_engagement_number where date(added_on) = date(now()) and type = '34' and service_id='" . $s_id . "'";
        mysql_query($delete_query, $dbConn);
