...
$deleted_file1 = "/var/www/html/kmis/services/hungamacare/v3/Script/querySMSlog_" . date("Ymd", mktime(0, 0, 0, date("m"), date("d") - 2, date("Y"))) . ".txt";
unlink($deleted_file1);
$deleted_file2 = "/var/www/html/kmis/services/hungamacare/v3/Script/ALLSMSTargetd_" . date("Ymd", mktime(0, 0, 0, date("m"), date("d") - 2, date("Y"))) . ".txt";
        ...
        while ($smsRecord = mysql_fetch_row($result)) {
            ...
            if ($response == 'ND') {
                ...
                if ($sms_type == 'engagement') {
                    ...
                    echo $procedureCall = "CALL master_db.SENDSMS(" . $smsRecord[0] . ",\"$msg\",'" . $sms_cli . "',0,'51050','promo')";
                }
