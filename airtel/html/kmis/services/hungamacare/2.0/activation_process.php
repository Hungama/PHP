...
if ($con) { 
    foreach ($_POST['circle'] as $key => $circleValue) {
        ...
        elseif ($serviceId == 15156) {
            $serviceId = 1515;
            $serviceName = 'Airtel-DEVO-Noor-e-khuda';
        }
...
//                mysql_query($delQuery);
            ...
            if ($_POST['timestamp5'] && $_POST['timestamp51']) {
                ...
                if ($flag == 1) {
                    ...
                    mysql_query($InsertQuery3);
                    $logData = "Update#" . $serviceName . "#" . $circleValue . "#" . $_POST['Scode'] . "#" . $_POST['timestamp5'] . "#" . $_POST['timestamp51'] . "\n";
                    error_log($logData, 3, $logPath);
                }
            }
            if ($_POST['timestamp6'] && $_POST['timestamp61']) {
                ...
                if ($flag == 1) {
                    ...
                    mysql_query($InsertQuery3);
                    $logData = "Update#" . $serviceName . "#" . $circleValue . "#" . $_POST['Scode'] . "#" . $_POST['timestamp6'] . "#" . $_POST['timestamp61'] . "\n";
                    error_log($logData, 3, $logPath);
                }
            }
            if ($_POST['timestamp7'] && $_POST['timestamp71']) {
                ...
                if ($flag == 1) {
                    ...
                    mysql_query($InsertQuery3);
                    $logData = "Update#" . $serviceName . "#" . $circleValue . "#" . $_POST['Scode'] . "#" . $_POST['timestamp7'] . "#" . $_POST['timestamp71'] . "\n";
                    error_log($logData, 3, $logPath);
                }
            }
        } else {
