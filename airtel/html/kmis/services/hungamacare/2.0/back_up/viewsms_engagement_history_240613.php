...
//print_r ($services);
	...
	$get_query="select id,message,status,added_on,circle,scheduledDate,duration,category,service_id from ";
...
$servicelistarray=Array ('1001'=>'Tata DoCoMo - Endless Music','1009'=>'Tata DoCoMo - Miss Riya','1409'=>'Uninor - Miss Riya','1408'=>'Uninor - Sports Unlimited','1513'=>'Airtel - MND'); 
// $sname_ks = array_flip($serviceArray);
		...
		{
			echo '<TD>';
			if(!empty($summarydata['scheduledDate'])){echo date('j-M \'y',strtotime($summarydata['scheduledDate']));}
			echo '</TD>';
	}
