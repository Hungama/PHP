...
//print_r ($services);
$servicelistarray=Array ('AirtelMND'=>'Airtel - MND');
$serviceIdName=Array ('AirtelMND'=>'1513');
...
<div class="container">
	<div class="row">
		...
		<div class="tab-content">
			...
			<input name="duration" type="radio" id="duration" value="3 Days" checked onclick="javascript:viewUploadhistory('3 Days')">&nbsp;<span class="label label-important">3 Days</span>&nbsp;&nbsp;&nbsp;<input name="duration" type="radio" id="duration" value="7 Days" onclick="javascript:viewUploadhistory('7 Days')">&nbsp;<span class="label label-info">7 Days</span>&nbsp;&nbsp;&nbsp;
