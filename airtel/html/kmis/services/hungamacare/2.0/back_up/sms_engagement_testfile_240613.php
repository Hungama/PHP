			...
			<table class="table table-bordered table-condensed">
				...
				<?php } ?>
					...
					<tr>
						...
						<td><input type="radio" id="daily_msg" name="daily_msg" value="1"/> Active Daily Message
						<input type="radio" id="daily_msg" name="daily_msg" value="0"/> Deactive Daily Message</td>
			    </tr>
					<tr>
						<td align="left" width="16%" height="32">Message</td>
						<td>
...
document.getElementById('alert_placeholder').style.display='none';
 $('#loading').show();
    ...
    $.ajax({
        url: 'bulkupload_process_sms_engagement_testfile.php',
        type: 'POST',
        data: formData,
        async: false,
        success: function (data) {
