...
<?php
	...
	if($service_info == 1509)
		...
		error_log($logData,3,$logPath);
			...
			$planDataResult = mysql_query("SELECT Plan_id from master_db.tbl_plan_bank WHERE S_id='".$service_info_clubed."' and sname='".$service_info."'",$dbConn);
...
if (in_array("90", $planData) || in_array("91", $planData)) {
	...
	<TD><?php if(!empty($response_time)){echo date('j-M \'y g:i a',strtotime($response_time));} else {echo '-';}?></TD>
