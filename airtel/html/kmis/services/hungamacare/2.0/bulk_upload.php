...
foreach ($serviceArrayBulk as $k => $v) {
...
<div class="container">
	<div class="row">
		...
		<!-- added for 1518 service only start here--->
		  <TR height="30" id='languageDiv'>
		<TD bgcolor="#FFFFFF">Language</TD>
        <TD bgcolor="#FFFFFF"><select name="lang" id="lang" class="in">
			<option value="">Select Language</option>
			<?php $querylang = mysql_query("select * from master_db.tbl_language_master where langId!='29' order by lang_name",$dbConn);
	  ...
	  <TR height="30" id='ReligionDiv'>		
		<TD bgcolor="#FFFFFF">Religion</TD>
        <TD bgcolor="#FFFFFF"><select name="religion" id="religion" class="in">
			<option value="">Select Religion</option>
			<?php $queryRel = mysql_query("select religion from airtel_devo.tbl_religion_detail order by religion",$dbConn);
