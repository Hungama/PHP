...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function setServiceOption(lang) { 
                if(lang == '01'){
                    document.getElementById('ServiceDiv').innerHTML = "<select name='service' id='service'><option value='1503'>Airtel-MTV</option></select>"; 
                }else{
                    document.getElementById('ServiceDiv').innerHTML = "<select name='service' id='service'><option value='1507'>Airtel-VH1</option></select>";
                }
            }
    ...
    <body onload="viewUploadhistory('active');setServiceOption('01');">
                                ...
                                <form id="tstest" name="tstest" method="post">
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td><select name='language' id='language' onchange="setServiceOption(this.value);">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div id="ServiceDiv" name="ServiceDiv">
        ...
        <script type="text/javascript" language="javascript">
            function validateData() { 
                ...
                if(document.forms['tstest']["circle"].value=='' || document.forms['tstest']["circle"].value==0) {
                    document.getElementById('alert_placeholder').style.display='inline';
                    bootstrap_alert.warning('<?php echo 'Please select circle.'; ?>');
                    document.forms['tstest']["circle"].focus();
                    return false;
                }
                if(document.forms['tstest']["language"].value=='' || document.forms['tstest']["language"].value==0) {
                    document.getElementById('alert_placeholder').style.display='inline';
                    bootstrap_alert.warning('<?php echo 'Please select language.'; ?>');
                    document.forms['tstest']["language"].focus();
                    return false;
                }              
            ...
            $("form#tstest").submit(function(){
                ...
                { 
                    ...
                    $.ajax({
                        url: 'cross_sell_activation_process.php',
                        type: 'POST',
                        data: formData,
                        async: false,
            ...
            $("form#show").submit(function(){ 
                ...
                if(isok)
                {
                    ...
                    $.ajax({
                        url: 'cross_sell_show_process.php',
                        type: 'POST',
                        data: formData,
                        async: false,
                        success: function (data) {
