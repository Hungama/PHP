...
//print_r ($services);
	...
	$get_query .=" master_db.tbl_sms_engagement nolock where type='$uploadfor' and service_id=1517 order by id desc limit 20";
...
$servicelistarray=Array ('1517'=>'Airtel Spoken English'); 
