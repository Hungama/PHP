...
elseif ($_REQUEST['service_info'] == 15071)
    $serviceId = 1507;
elseif ($_REQUEST['service_info'] == 15221 || $_REQUEST['service_info'] == 15222)
    $serviceId = 1522;
...
<TABLE width="95%" align="center" bgcolor="#0369b3" border="0" cellpadding="1" cellspacing="1" class="table table-condensed table-bordered">
    ...
    $planDataResult = mysql_query("SELECT Plan_id from master_db.tbl_plan_bank WHERE S_id='" . $serviceId . "' and sname='" . $s_info . "'", $dbConn);
    ...
    switch ($_REQUEST['service_info']) {
        ...
        case '1523':
            ...
            break;
		case '1527':
            $query1 .= " airtel_rasoi.tbl_rasoi_unsubWAP ";
            break;
    }
