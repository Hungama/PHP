...
//print_r ($services);
$servicelistarray=Array ('AirtelSE'=>'Airtel Spoken English');
$serviceIdName=Array ('AirtelSE'=>'1517');
...
<body onload="javascript:viewUploadhistory('active_base')">
...
<!--				<li class="active"><a href="#active" onclick="javascript:viewUploadhistory('3 Days')" data-toggle="tab" data-act="No call since activation">No call since activation</a></li>-->
				<li class="active"><a href="#entire_active_base" onclick="javascript:viewUploadhistory('active_base')" data-toggle="tab" data-act="Entire Active base">Entire Active base</a></li>
	...
	<div id="entire_active_base" class="tab-pane active">
