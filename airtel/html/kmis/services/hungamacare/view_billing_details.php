...
<?php
	...
	$query1 .=" UNION select billing_ID,trans_id, event_type, date_time, amount,aval_amount,chrg_amount,MODE as mode from master_db.tbl_billing_success_backup where msisdn='$_GET[msisdn]' and service_id='".$service_id."' and plan_id IN (".implode(",",$planArray).")  ";
	...
	$query1 .=" and plan_id IN (".implode(",",$planArray).") ";
	$query1 .=") as record ";
	$query1 .=" order by date_time desc ";
	if($_REQUEST['service_info']==1502)
	{
		$query1.=" limit 1";
	}
