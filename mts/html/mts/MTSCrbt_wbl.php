...
$logPath ="/var/www/html/MTS/logs/MTS/crbt/crbt_log_wbl_".date("Ymd").".txt";
...
if($catId)
{
	$getQuery="select * from  mts_voicealert.tbl_voice_category where status=1 and obd_status=0 and IsDND=0 and cat_id=".$catId." and circle ='WBL'";
	...
	while($RecordRow = mysql_fetch_row($Record))
	{
		...
		$logData = $catId."#".$RecordRow[0]."#".$RecordRow[15]."#".$RecordRow[3]."#".date('Y-m-d H:i:s')."\n";
