...
if (($msisdn == "") || ($mode == "") || ($reqtype == "") || ($planid == "")) {
    ...
    switch ($seviceId) {
		...
		case '1125':
            ...
            if ($batchId)
                $subscriptionProcedure = "JOKEPORTAL_SUB_Bulk";
            else
        ...
        if ($rows1[0] <= 0) {
            if ($planid == 11 || $planid == 12 || $planid == 13 || $planid == 19) {
              ...
              //  $qry = "call " . $DB . "." . $subscriptionProcedure . "('" . $msisdn . "','" . $mode . "','" . $sc . "','" . $showId . "','" . $celebId . "','" . $startDate . "' ,'" . $startTime . "' ,'" . $endTime . "', " . $s_id . "," . $planid . ")";
                ...
                if ($catId1 || $catId2) {
				...
				else if($s_id==1102 || $s_id==1125 || $s_id==1110 || $s_id==1113 || $s_id==1116 || $s_id==1101 || $s_id==11011 || $s_id==1103) {
                    if($batchId)
					{
					...
					{
					echo $qry = "call " . $DB . "." . $subscriptionProcedure . " ('" . $msisdn . "','" . $langValue . "','" . $mode . "','" . $sc . "','" . $amount . "'," . $s_id . "," . $planid. "'," . $transid . "," . $ccgid;
					echo "<br>";
					}
                }
				else {
            ...
            if ($_REQUEST['rel'] && $s_id == '1111') {
                ...
                $countData = mysql_query("SELECT count(*) FROM dm_radio.tbl_religion_profile nolock WHERE ANI='" . $msisdn . "'");
