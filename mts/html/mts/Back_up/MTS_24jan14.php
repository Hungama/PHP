...
if (($msisdn == "") || ($mode == "") || ($reqtype == "") || ($planid == "")) {
	...
	$logString_process=$msisdn . "#" . $mode . "#" . $reqtype . "#" . $planid . "#" . $subchannel."#".$remoteAdd."#".$transid."#".$ccgid ."#".date('d-m-Y h:i:s')."\r\n";
	error_log($logString_process,3,$logPath_process);
...
//                }
			...
			$logString_process="Query process tbl_religion_profile start here-".$qry."#".date('d-m-Y h:i:s')."\r\n";
	error_log($logString_process,3,$logPath_process);
				...
				$logString_process="Query process tbl_religion_profile end here-".$qry."#".date('d-m-Y h:i:s')."\r\n";
	error_log($logString_process,3,$logPath_process);
            }
