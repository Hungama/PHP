...
function getRatingId($chrgamount, $type, $serviceId, $planAmount) {
	...
	switch($serviceId) {
		case '1111':if($type == 'sub') {
						switch($planAmount) {
							case '30':	
								if($chrgamount==30) $ratingId="93003008";
								else if($chrgamount==25) $ratingId="92503004";
								else if($chrgamount==20) $ratingId="92003008";
								else if($chrgamount==15) $ratingId="91503004";
								else if($chrgamount==11) $ratingId="91103002";
								else if($chrgamount==7) $ratingId="90703000";
								else if($chrgamount==5) $ratingId="90503004";
								else $ratingId="901253002";
							break;
							case '11':
								if($chrgamount==11) $ratingId="91103000";
								else if($chrgamount==7) $ratingId="90703000";
								else if($chrgamount==5) $ratingId="90503004";
								else $ratingId="901253002";
							break;
							default: if($chrgamount == '1.25') $ratingId="901253000";
								else $ratingId="Not Found";
							break;
						}
					} elseif($type == 'resub') {  
						switch($planAmount) {
							case '30': 
								if($chrgamount==30) $ratingId="93003009";
								else if($chrgamount==25) $ratingId="92503005";
								else if($chrgamount==20) $ratingId="92003009";
								else if($chrgamount==15) $ratingId="91503005";
								else if($chrgamount==11) $ratingId="91103003";
								else if($chrgamount==7) $ratingId="90703001";
								else if($chrgamount==5) $ratingId="90503005";
								else $ratingId="901253003";
							break;
							case '11':
								if($chrgamount==11) $ratingId="91103001";
								else if($chrgamount==7) $ratingId="90703001";
								else if($chrgamount==5) $ratingId="90503005";
								else $ratingId="901253003";
							break;
							default: if($chrgamount == '1.25') $ratingId="901253001";
								else $ratingId="Not Found";
							break;
						}
					}			
		...
		case '1110':
				if($type == 'sub') {
					switch($planAmount) {
						case '30':
							if($chrgamount==30) $ratingId="93002938";
							else if($chrgamount==20) $ratingId="92002943";
							else if($chrgamount==15) $ratingId="91502954";
							else if($chrgamount==10) $ratingId="91002953";
							else $ratingId="90502958";
						break;
						case '10':
							if($chrgamount==10) $ratingId="91002951";
							else $ratingId="90502958";
						break;
						default:
								$ratingId="Not Found";
					...
					switch($planAmount) {
						case '30':
								if($chrgamount==30) $ratingId="93002939";
								else if($chrgamount==20) $ratingId="92002944";
								else if($chrgamount==15) $ratingId="91502955";
								else if($chrgamount==10) $ratingId="91002954";
								else $ratingId="90502959";
						break;
						case '10':
							if($chrgamount==10) $ratingId="91002952";
							else $ratingId="90502959";
						break;
						default:
							$ratingId="Not Found";
		...
		case '1106':
				if($type == 'sub') {
					switch($planAmount) {
						case '15':
							if($chrgamount==15) $ratingId="91502957";
							elseif($chrgamount==12) $ratingId="91202904";
							elseif($chrgamount==10) $ratingId="91002956";
							elseif($chrgamount==7) $ratingId="90702929";
							elseif($chrgamount==5) $ratingId="90502961";
							elseif($chrgamount==2) $ratingId="90202908";
							else $ratingId="90102928";//chrgamt=1
						break;
						case 10:
							if($chrgamount==10) $ratingId="91002956";
							elseif($chrgamount==7) $ratingId="90702929";
							elseif($chrgamount==5) $ratingId="90502961";
							elseif($chrgamount==2) $ratingId="90202908";
							else $ratingId="90102928";//chrgamt=1
						break;
						case 5:
							if($chrgamount==5) $ratingId="90502961";
							elseif($chrgamount==2) $ratingId="90202908";
							else $ratingId="90102928";//chrgamt=1
						break;
						default:
					...
					switch($planAmount) {
						case 15:
							if($chrgamount==15) $ratingId="91502958";
							elseif($chrgamount==12) $ratingId="91202905";
							elseif($chrgamount==10) $ratingId="91002957";
							elseif($chrgamount==7) $ratingId="90702930";
							elseif($chrgamount==5) $ratingId="90502962";
							elseif($chrgamount==2) $ratingId="90202909";
							else $ratingId="90102929";//chrgamt=1
						break;
						case 10:
							if($chrgamount==10) $ratingId="91002957";
							elseif($chrgamount==7) $ratingId="90702930";
							elseif($chrgamount==5) $ratingId="90502962";
							elseif($chrgamount==2) $ratingId="90202909";
							else $ratingId="90102929";//chrgamt=1
						break;
						case 5:
							if($chrgamount==5) $ratingId="90502962";
							elseif($chrgamount==2) $ratingId="90202909";
							else $ratingId="90102929";//chrgamt=1
						break;
						default:
		...
		case '1101': 
			if($type == 'sub') {
				if($chrgamount == 30 || $chrgamount == 20 || $chrgamount == 10) $ratingId="9".$chrgamount."03006";
				elseif($chrgamount == 2) $ratingId="90".$chrgamount."03000";
				else { 
					if($chrgamount<10) { $ratingId="90".$chrgamount."03000"; } else { $ratingId="9".$chrgamount."03000";} 
				}
			} elseif($type == 'resub') {
				if($chrgamount == 30 || $chrgamount == 20 || $chrgamount == 10) $ratingId="9".$chrgamount."03007";
				elseif($chrgamount == 2) $ratingId="90".$chrgamount."03001";
				else {
					if($chrgamount<10) { $ratingId="90".$chrgamount."03001"; } else { $ratingId="9".$chrgamount."03001"; }
				}
			}
		break;
		case '1102': 
		...
		case '1103':
			if($type == 'sub') { 
				if($chrgamount%2 == 0) $ratingId="9".$chrgamount."03003";	
				else $ratingId ="9".$chrgamount."03002";
			} elseif($type == 'resub') {
				if($chrgamount%2 == 0) $ratingId="9".$chrgamount."03004";	
				else $ratingId ="9".$chrgamount."03003";
			}
		break;
	}
	return $ratingId;
...
$flag=0;
$tblList = array('1101' => array('mts_radio.tbl_radio_subscription', 'mts_radio.tbl_radio_unsub'),'1102'=>array('mts_hungama.tbl_jbox_subscription', 'mts_hungama.tbl_jbox_unsub'), '1103'=>array('mts_mtv.tbl_mtv_subscription','mts_mtv.tbl_mtv_unsub'),'1106'=>array('mts_starclub.tbl_jbox_subscription', 'mts_starclub.tbl_jbox_unsub'), '1110'=>array('mts_redfm.tbl_jbox_subscription','mts_redfm.tbl_jbox_unsub'), '1111'=>array('dm_radio.tbl_digi_subscription', 'dm_radio.tbl_digi_unsub'));

$total_service = sizeof($tblList);

$billingTbl = "master_db.tbl_billing_success";
$serviceData = mysql_query("select distinct(service_id) from ".$billingTbl." where msisdn='".$msisdn."' and event_type = 'SUB'");
$countData = mysql_num_rows($serviceData);

if(!$countData) {
	$serviceData = mysql_query("select distinct(service_id) from master_db.tbl_billing_success_backup where msisdn='".$msisdn."' and event_type = 'SUB'");
	$countData = mysql_num_rows($serviceData);
...
if($countData) { 
		...
		if($noDetail['status'] == 1) $status = "Active";
		elseif($noDetail['status'] == 0) $status = "Not Active";
		elseif($noDetail['status'] == 11) $status = "Pending";
