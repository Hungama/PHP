...
function getRatingId($chrgamount, $type, $serviceId, $planAmount) {
    ...
    switch ($serviceId) {
        ...
        case '1125':
             if ($type == 'sub') {
                if ($chrgamount == 30)
                    $ratingId = "9" . $chrgamount . "03010";
            } elseif ($type == 'resub') {
                if ($chrgamount == 30)
                    $ratingId = "9" . $chrgamount . "03011";
            }
            break;
        case '1126':
            if ($type == 'sub') {
                if ($chrgamount == 30)
                    $ratingId = "9" . $chrgamount . "03015";
            } elseif ($type == 'resub') {
                if ($chrgamount == 30)
                    $ratingId = "9" . $chrgamount . "03016";
            }
            break;
    }
    return $ratingId;
