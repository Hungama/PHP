<?php
$con = mysql_connect("10.130.14.106","team_user","Te@m_us@r987") or die(mysql_error());
$obdShed=date('H');
...
if($catId)
{
	$getQuery="select * from  mts_voicealert.tbl_voice_category where status=1 and obd_status=0 and cat_id=".$catId." and circle NOT in ('RAJ','WBL','KOL','KAR','APD')";
