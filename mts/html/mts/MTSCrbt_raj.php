...
$logPath ="/var/www/html/MTS/logs/MTS/crbt/crbt_log_raj_".date("Ymd").".txt";
...
if($catId)
{
	$getQuery="select * from  mts_voicealert.tbl_voice_category where status=1 and obd_status=0 and IsDND=0 and cat_id=".$catId." and circle ='RAJ' ";
