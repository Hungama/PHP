...
//'1101' => array('mts_radio.tbl_radio_subscription', 'mts_radio.tbl_radio_unsub')
$flag = 0;
...
*/
    $serviceData = mysql_query("select distinct(service_id),event_type from master_db.tbl_billing_success nolock where msisdn='" . $msisdn . "' and event_type in('SUB','EVENT','RESUB','SUB_RETRY') UNION select distinct(service_id),event_type from master_db.tbl_billing_success_backup nolock where msisdn='" . $msisdn . "' and event_type in('SUB','EVENT','RESUB','SUB_RETRY') ");
    $countData = mysql_num_rows($serviceData);
