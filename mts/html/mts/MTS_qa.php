...
if (($msisdn == "") || ($mode == "") || ($reqtype == "") || ($planid == "")) {
    ...
    switch ($seviceId) {
        ...
        case '1106':
            if ($planid == 11 || $planid == 12 || $planid == 13 || $planid == 19) {
                ...
                echo $showQuery = "SELECT show_id,celeb_id,show_date,start_time,end_time FROM mts_starclub.tbl_show_details nolock WHERE show_status=1";
    ...
    if ($reqtype == 1) {
        echo $amtquery = "select iAmount from master_db.tbl_plan_bank nolock where Plan_id='$planid' and S_id=$seviceId";
...
//                }
            ...
            if ($_REQUEST['rel'] && $s_id == '1111') {
				...
				$langValue = $langArray[strtoupper($lang)];
				echo $qry_relign_proc = "call " . $DB . "." . $DIGI_RELIGION_SELECTION . " ('" . $msisdn . "','" . $religionValue . "','" . $langValue . "')";
