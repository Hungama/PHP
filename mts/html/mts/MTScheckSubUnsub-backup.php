	...
	switch($serviceId) {
		...
		case '1101': 
			if($type == 'sub') {
				...
				elseif($chrgamount == 2) $ratingId="9".$chrgamount."03000";
				else $ratingId="9".$chrgamount."03000";
			} elseif($type == 'resub') {
				if($chrgamount == 30 || $chrgamount == 20 || $chrgamount == 10) $ratingId="9".$chrgamount."03007";
				elseif($chrgamount == 2) $ratingId="9".$chrgamount."03001";
				else $ratingId="9".$chrgamount."03001";
			}
		break;
		case '1102': 
			if($type == 'sub') {
...
$query = "select distinct(service_id) from ".$billibngTbl." where msisdn='".$msisdn."' and event_type = 'SUB'";
$serviceData = mysql_query($query);
$countData = mysql_fetch_row($serviceData);
