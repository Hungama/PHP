...
$fileDumpPath="/var/www/html/billing_api/log/processlog_".date("dmY").".txt";
...
//Mts Sport Unlimited end of the code
...
$file_process_status = $msisdn."#".$reqName."#".$RPid."#".$tranx_id."#".$starttime."#".date("Y-m-d H:i:s"). "\r\n";
error_log($file_process_status, 3, $fileDumpPath);	
