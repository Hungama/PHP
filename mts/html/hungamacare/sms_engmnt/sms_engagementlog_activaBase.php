...
$query = "select a.ani,b.circle,b.message from mts_radio.tbl_radio_subscription a,master_db.tbl_sms_engagement b where date(b.scheduledDate)=date(now())
    and a.status=1 and  a.circle=b.circle and b.service_id=1101 and b.type='active_base' and b.status=1 and b.ani in 
    ('8459506442','9667890489','9143844338','8693945793','8925332082','9142112398')";
