...
$query = "select a.msisdn,d.circle,d.message from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a,master_db.tbl_sms_engagement d 
            ...
            and a.msisdn=b.ani and b.status=1 and d.status=1 and d.type='0-10 Mous' and d.service_id=1101 and date(d.added_on) = CURDATE() and  b.circle=d.circle  group by a.msisdn having 
...
$query_1030MOU = "select a.msisdn,d.circle,d.message from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a,
            ...
            and date(d.added_on) = CURDATE() and b.circle=d.circle   group by a.msisdn having sum(duration_in_sec) between 600 and 1800 ";
...
$query_G30MOU = "select a.msisdn,d.circle,d.message from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a,
            ...
            and date(d.added_on) = CURDATE() and b.circle=d.circle  group by a.msisdn having sum(duration_in_sec) >1800 ";
