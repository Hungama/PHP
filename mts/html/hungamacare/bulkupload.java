...
public class bulkupload extends Thread {
	...
	public	String DSN="mts_hungama";
	public	String USR="billing";
	public	String PWD="billing";
	public	String IP="10.130.14.106";
...
//===================================================================
	public void run()
	{
		try
		  ...
		  String selectFile="select file_name, added_on, service_type, channel, price_point, upload_for,batch_id,service_id from billing_intermediate_db.bulk_upload_history where status=0 and service_id in(1102,1103) order by added_on desc";
			...
			try
				{
						...
						if(fileStatus==0)
						{
							String update_bulk_history="update billing_intermediate_db.bulk_upload_history set status=1 where batch_id="+BatchId+" and service_id="+ServiceId;
						...
						{
							case 1102:
								SubsProcedureName="mts_hungama.JBOX_SUB";
								Lang="01";
								Dnis="54646";
								SubscriptionTable="mts_hungama.tbl_jbox_subscription";
								UnSubscriptionProcedure="mts_hungama.JBOX_UNSUB";
								UnubscriptionTable="mts_hungama.tbl_jbox_unsub";
							break;
							case 1103:
								SubsProcedureName="mts_mtv.MTV_SUB";
								Lang="01";
								Dnis="54646";
								SubscriptionTable="mts_mtv.tbl_mtv_subscription";
								UnSubscriptionProcedure="mts_mtv.MTV_UNSUB";
								UnSubscriptionTable="mts_mtv.tbl_mtv_unsub";
							break;
						}
						String FileToRead="/var/www/html/hungamacare/bulkuploads/"+ServiceId+"/"+FileName;
