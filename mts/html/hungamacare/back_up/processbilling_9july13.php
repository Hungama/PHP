...
include("config/dbConnect.php");
	...
	$select_query="select file_name, added_on, service_type, channel, price_point, upload_for,batch_id,service_id,amount,language from billing_intermediate_db.bulk_upload_history where status=0 and service_id in(1101,1102,1103,1111,1106,1110,1116,1113,1124) limit 1";
