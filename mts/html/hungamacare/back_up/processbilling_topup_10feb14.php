...
include("config/dbConnect.php");
	...
	*/
	$select_query="select file_name, added_on, service_type, channel, price_point, upload_for,batch_id,service_id,amount,language 
	from billing_intermediate_db.bulk_upload_history where status=0 and upload_for in('topup_charging','event_active','event_unsub','autochurn_renewal') 
