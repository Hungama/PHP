...
{
	var sId = document.getElementById('service_info').value;
	if(radioname=='a')
	{
		...
		} else if(sId == '1102' || sId == '1110' || sId == '1116') {
			document.getElementById('newamountData').style.display = 'table-row';
		}
	}
	if(radioname=='d')
	{		
		...
		document.getElementById('pricetopup').style.display = 'none';
		if(sId == '1102' || sId == '1110' || sId == '1116') {
			document.getElementById('newamountData').style.display = 'none';
		} else if(sId == '1116') {
...
<TABLE width="80%" align="center" border="0" cellpadding="0" cellspacing="0" class="txt">
 ...
 <form name="frm" method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>" onSubmit="return checkfield()" enctype="multipart/form-data">
	...
	<TR height="30" id='price12'>
	  ...
	  <?php if($_REQUEST['service_info']==1102 || $_REQUEST['service_info']==1116 || $_REQUEST['service_info']==1110) { ?>	
	  <TR height="30" id="newamountData" >
        <TD bgcolor="#FFFFFF"><B>Amount</B></TD>
        <TD bgcolor="#FFFFFF">&nbsp;&nbsp<select name='newamount' id='newamount' class="in">
				<option value=''>--select--</option>
				<?php if($_REQUEST['service_info']==1102) { ?>
				<option value='5'>5</option>
				<option value='30'>30</option>
				<?php } ?>
				<?php if($_REQUEST['service_info']==1116 || $_REQUEST['service_info']==1110) { ?>
				<option value='5'>5</option>
				<?php } ?>
			</select>
