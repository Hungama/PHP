...
$get_activation_query="select count(msisdn),circle,chrg_amount,service_id,event_type,plan_id from master_db.tbl_billing_success nolock  where DATE(response_time)='$view_date1' and service_id in(1101,1102,1103,1111,1110,1116,1113) and event_type in('SUB','RESUB','TOPUP') group by circle,service_id,chrg_amount,event_type,plan_id";
...
//////////////////////////////////Start the code to activation Record mode wise ////////////////////////////////////////////////////////
 ...
 $get_mode_activation_query="select count(msisdn),circle,service_id,mode,plan_id from master_db.tbl_billing_success nolock  where DATE(response_time)='$view_date1' and service_id in(1101,1102,1103,1111,1110,1116,1113) and event_type in('SUB') group by circle,service_id,mode,plan_id";
...
/////////////////////////////////// Start the code to Renewal Record mode wise ////////////////////////////////////////////////////////
 ...
 $get_mode_renewal_query="select count(msisdn),circle,service_id,mode,plan_id from master_db.tbl_billing_success nolock  where DATE(response_time)='$view_date1' and service_id in(1101,1102,1103,1111,1110,1116,1113) and event_type='RESUB' group by circle,service_id,mode order by mode,plan_id";
...
$get_activation_query="select count(msisdn),circle,chrg_amount,service_id,event_type,plan_id from master_db.tbl_billing_success nolock  where DATE(response_time)='$view_date1' and service_id in(1106) and event_type in('SUB','RESUB','TOPUP') group by circle,service_id,chrg_amount,event_type,plan_id";
$query = mysql_query($get_activation_query, $dbConn) or die(mysql_error());
$numRows = mysql_num_rows($query);
if ($numRows > 0)
{
...
//////////////////////////////////Start the code to activation Record mode wise ///////////////////////////////////////////////////////////
 ...
 $get_mode_activation_query="select count(msisdn),circle,service_id,mode,plan_id from master_db.tbl_billing_success nolock  where DATE(response_time)='$view_date1' and service_id in(1106) and event_type in('SUB') group by circle,service_id,mode,plan_id";
...
/////////////////////////////////// Start the code to Renewal Record mode wise ///////////////////////////////////////////////////////
 ...
 $get_mode_renewal_query="select count(msisdn),circle,service_id,mode,plan_id from master_db.tbl_billing_success nolock  where DATE(response_time)='$view_date1' and service_id in(1106) and event_type='RESUB' group by circle,service_id,mode,plan_id order by mode";
...
$getActiveBase="select count(*),circle from misdata.tbl_base_active where service='MTSMPD' and status='Pending' and date(date)='$view_date1' group by circle";
$activeBaseQuery1 = mysql_query($getActiveBase, $LivdbConn) or die(mysql_error());
$numRowsRIA = mysql_num_rows($activeBaseQuery1);
if ($numRowsRIA > 0)
{
...
$getActiveBase="select count(*),circle from misdata.tbl_base_active where service='MTSMPD' and status='Active' and date(date)='$view_date1' group by circle";
$activeBaseQuery1 = mysql_query($getActiveBase, $LivdbConn) or die(mysql_error());
$numRowsRIA = mysql_num_rows($activeBaseQuery1);
if ($numRowsRIA > 0)
{
