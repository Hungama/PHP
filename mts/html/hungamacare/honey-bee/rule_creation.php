                    ...
                    <div class="tab-pane active" id="pills-basic">
                        <div class="tabbable">
                            <ul class="nav nav-pills">
                                ...
                                <li class=""><a href="#history" onclick="stopDisplayUploadhistory('history')"  data-toggle="tab" data-act="history">History</a></li>
								<li class=""><a href="#event" onclick="eventUploadhistory()"  data-toggle="tab" data-act="history">Priortize event </a></li>
                            </ul>
                            <br/>
...
<a href="demo_file.csv" target="_blank">Demo Formate</a>
</td>
...
<form id="form-event" name="form-event" method="post" enctype="multipart/form-data">
<table class="table table-bordered table-condensed">
<tr>
<td align="left" width="16%" height="32"><span>Service Name</span></td>
<td align="left" colspan="2">
<select name="service" data-width="auto" >
...
<td align="left" width="16%" height="32"><span>Action</span></td>
<td align="left" colspan="2">
<select name="event"   data-width="auto">                                                      
<option value="">Select Event</option>
<option value="pre_defined_time">Predefined</option>
<option value="trigger_time">Trigger Time</option>
</select>
</td>
</tr>
<tr>
<td align="left" width="16%" height="32"><span>Periortization</span></td>
<td align="left" colspan="2">
<select name="perevent"   data-width="auto">                                                      
<option value="">Select Periortization</option>
...
<div  class="alert alert-danger" id="grid-active" style="display:none"></div>


<div id="grid-event"></div>
</div>
<br/>
<div id="grid-activeresult"></div>
...
var isok = checkeventfield('form-event');
//var isok = true;
if(isok)
{
document.getElementById('alert_placeholder').style.display='none';
...
$.ajax({
url: 'event_creation_process.php',
type: 'POST',
data: formData,
async: false,
success: function (data) {
...
//endof the event code
function eventUploadhistory(added_by) { 
document.getElementById('alert_placeholder').style.display='none';
document.getElementById('history').style.display='none';
document.getElementById('grid-view_upload_history').style.display='block';
document.getElementById('grid-activeresult').style.display='none';
document.getElementById('grid-active').style.display='none';

$('#grid-view_upload_history').hide();
$('#grid-view_upload_history').html('');
$('#loading').show();
$.fn.GeteventUploadHistory(added_by);
};
 $.fn.GeteventUploadHistory = function(added_by) {
$('#loading').show();
$.ajax({

url: 'eventrule_engagement_history.php',
...
async: false,
success: function (data) {
alert('Rule has been updated successfully'+data);                            
reloadPage();
},
cache: false,
contentType: false,
...
var event=document.forms[type]["event"].value;
var perevent=document.forms[type]["perevent"].value;
...
if(perevent=='' )
{	
	alert('Please select periortization.');
	return false;
}
$('#loading').show();
                hideMessageBox();
...
{
bootstrap_alert.warning('<?php echo 'Please select the action base.' ?>');
}
...
$.fn.GetAllHistory();
            ...
            function showDeleteConfirm(id){
                var answer = confirm("Do you want to delete this rule ?");
                if(answer){ 
                }else{ 
                    return false;
                }
