...
$selectIDQuery = "SELECT max(id) FROM honeybee_sms_engagement.tbl_rule_engagement";
...
$selectDisplayQuery = "SELECT id,rule_name,service_id,service_base,filter_base,scenerios,dnd_scrubbing
                                FROM honeybee_sms_engagement.tbl_rule_engagement where id='$rule_id[0]'";
$queryDisplaySel = mysql_query($selectDisplayQuery, $dbConn);
$rule_array = mysql_fetch_array($queryDisplaySel);
$selectActionQuery = "SELECT action_name,sms_sequence,time_slot FROM honeybee_sms_engagement.tbl_rule_engagement_action 
...
<table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td align="left" colspan="2">
            <?php
            $selectFilterQuery = "SELECT description FROM honeybee_sms_engagement.tbl_filter_base where Fid=" . $rule_array['filter_base'] . "";
