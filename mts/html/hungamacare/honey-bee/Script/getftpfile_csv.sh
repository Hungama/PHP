...
filename_org="$1_*"
filePath="/var/www/html/hungamacare/honey-bee/Script/192.168.100.238/output/$filename_org"
#filename="testbyspt20140129_"
filename="$1_"
#filename2="testbyspt20140129.txt"
filename2="/var/www/html/hungamacare/honey-bee/new_engagement/dndcheck/$1.csv"
