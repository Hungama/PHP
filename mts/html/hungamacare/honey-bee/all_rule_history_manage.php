...
$get_query = "SELECT rule.id,rule.rule_name,rule.last_processed,rule.service_id,rule.circle,rule.scenerios,action.action_name,added_on
    FROM honeybee_sms_engagement.tbl_rule_engagement rule JOIN honeybee_sms_engagement.tbl_rule_engagement_action action
...
$get_rule_query = "SELECT distinct id,rule_name  FROM honeybee_sms_engagement.tbl_rule_engagement";
            ...
            <TABLE class="table table-condensed table-bordered">
                ...
                while ($summarydata = mysql_fetch_array($query)) {
                    ...
                    <TR height="30">
                        ...
                        <TD><?php
            echo $get_process_query = "select count from honeybee_sms_engagement.tbl_new_engagement_data nolock 
                        where service_id='$service_id' and type='$type' and date(added_on)=date('" . $added_on . "')";
