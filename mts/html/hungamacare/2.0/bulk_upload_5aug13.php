...
function checkfield(type) {
	...
	if (service_info==0) {
		...
		if(pricepoint=="" && (uploadfor=='active' || uploadfor=='renewal' || uploadfor=='topup' || uploadfor=='event_active')) {
	...
	<div class="row">
		...
		<div class="tabbable">
			<ul class="nav nav-pills">
				...
				<li class=""><a  href="#event_active" onclick="viewUploadhistory('event_active')" data-toggle="tab" data-act="Event-ACtivation">TopUp-Charging</a></li>
			</ul>
