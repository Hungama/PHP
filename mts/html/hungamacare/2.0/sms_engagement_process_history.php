...
if ($duration_array[1] != '') {
    $get_query .=" master_db.tbl_sms_engagement_data nolock where service_id='$service_info' and type='".$duration_array[0]."' and duration = '".$duration_array[1]."' order by id desc limit 20";
}else{
    ...
    <center><div width="85%" align="left" class="txt">
            ...
            <TABLE class="table table-condensed table-bordered">
                ...
                while ($summarydata = mysql_fetch_array($query)) {
                    ...
                    $servicelistarray = Array('1101' => 'MTS - muZic Unlimited');
// $sname_ks = array_flip($serviceArray);
                    ...
                    <TR height="30">
                        ...
                        $filePath = "/var/www/html/hungamacare/2.0/logs/sms_engmnt/" . $summarydata['service_id'] . "/" . $type_path . "/log_" . $mytime . ".log";
                        $lines = file($filePath);
                        ?>
