...
?>
        ...
        <TD>
            ...
            <button class="btn btn-danger" style="float:right; background-image: -moz-linear-gradient(center top , #006400, #006400);"  onclick="javascript:submitEditDeatil('<?php echo $id; ?>','<?php echo 'tryandbuy'; ?>')">Submit</button>
        </TD>
