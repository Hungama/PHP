...
{
$sql="update MTS_IVR.tbl_new_tnb_whitelisted_config set status='".$status."' WHERE id='".$batch_id."'";
}
else if($bulktype=='getbalance')
{
$sql="update billing_intermediate_db.getBal_upload_history set status='".$status."' WHERE id='".$batch_id."'";
}
