...
if($_POST['upfor'] == 'get_balance')
{
 ...
 if (move_uploaded_file($_FILES['upfile']['tmp_name'], $path)) {
        ...
        $Uploadquery = "insert into billing_intermediate_db.getBal_upload_history(batch_id,file_name,added_by,added_on,status) values('".$batchId."','" . $makFileName . "', '" . $uploadeby_mts . "', now(), 0)";
