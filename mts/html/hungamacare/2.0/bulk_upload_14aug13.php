...
if(pricepoint=="" && (uploadfor=='active' || uploadfor=='renewal' || uploadfor=='topup' || uploadfor=='topup_charging' || uploadfor=='event_active' )) {
...
//tonePlanData toneMode renewal  event
	...
	if(type == 'deactive') {
		...
		if(type=='topup_charging' || type=='event_active')
		{
