...
$uploadeby_mts=$_SESSION['loginId_mts'];
	...
	$get_query="select id,status,batch_id,channel,file_name,added_on,upload_for,total_file_count,service_id,price_point,success_count,failure_count,InRequest from billing_intermediate_db.bulk_upload_history where added_by='".$uploadeby_mts."' and upload_for='".$uploadfor."' order by added_on desc limit 20";
