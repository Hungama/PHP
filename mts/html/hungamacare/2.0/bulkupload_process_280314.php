...
$subtype=$_POST['auto_type'];
			...
			if(move_uploaded_file($_FILES['upfile']['tmp_name'], $path))
			{
				...
				$dbaccess='mts';
				$Uploadquery="insert into billing_intermediate_db.bulk_upload_history(batch_id, service_type, channel, price_point, file_name, added_by, added_on, upload_for,status,operator,total_file_count,service_id,amount,language,act_date,renew_date,smsFlag) values('".$batchId."','".$subtype."', '".$channel."', '".$planId."', '".$makFileName."', '".$uploadeby_mts."', '".$thisTime."', '".$upfor."',0,'".$dbaccess."','".$file_size."','".$serviceId."','".$getAmount."','".$lang."','".$act_date."','".$renew_date."','".$tnb_prerenewsms."')";
				$queryIns = mysql_query($Uploadquery, $dbConn);
