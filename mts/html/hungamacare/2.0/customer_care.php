...
<?php
//$serviceArray=array('MTS54646'=>'1102','MTSDevo'=>'1111','MTSFMJ'=>'1106','MTSComedy'=>'11011','MobisurMTS'=>'','MTSMND'=>'1113','MTVMTS'=>'1103','MTSMU'=>'1101','REDFMMTS'=>'1110','MTSVA'=>'1116');
			$listservices=$_SESSION["access_service"];
			//print_r($listservices);
			...
			foreach ($serviceArray as $k => $v)
							...
							/*if($k=='MTSAC') 
							{
							$mainservicearray[$v]='MTS - muZic2Cinema';
							} else {
...
$.fn.GetChargingDetails = function(str,service_info) {
		$.ajax({
					...
					//	url: 'view_subscription_details.php',
