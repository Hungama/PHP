...
//	$serviceId = $_GET['sid'];
	...
	$uploadvaluearray = array('active'=>'Activation','deactive'=>'Deactivation','topup'=>'Top-Up','renewal'=>'Renewal','topup_charging'=>'Top-Up','event_active'=>'Event Activation','event_unsub'=>'Event','autochurn_renewal'=>'AutoChurnRenewal','tryandbuy'=>'Try & Buy SPL');
	//$uploadedby='uni.bulk';
