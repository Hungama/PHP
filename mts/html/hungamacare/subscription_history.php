...
if (isset($_SESSION['authid'])) {
    ...
    $logPath = "log/deactivateLog/" . "deactivateLog_" . date("Y-m-d") . ".txt";
    $service_array = array('1102' => 'MTS - 54646', '1101' => 'MTS - muZic Unlimited', '1103' => 'MTS - MTV DJ Dial',
    ...
    <html>
        ...
        <body leftmargin="0" topmargin="0" link="#000000" alink="#000000" bgcolor="#ffffff" text="#000000" marginheight="0" marginwidth="0" vlink="#000000">
            ...
            if ($_POST['Submit'] == "Submit" && $_REQUEST['msisdn'] != "") {
                $msisdn = $_POST[msisdn];
                $seviceIdArray = array('1102', '1101', '1103', '1111', '1106', '1110', '1113', '1124', '1123', '1125', '1126', '1116');
                ?>
            <center><div width="85%" align="left" class="txt"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B><FONT COLOR="#FF0000">Subscription History</FONT></B></div><center><br/>
                        ...
                        echo "Pending";
                                    ...
                                    ?></TD>
                                        <TD bgcolor="#FFFFFF" align="center" class="blue">&nbsp;
                                            <?php if ($subStatus == 1) { ?>
                                                <a href="subscription_history.php?msisdn=<?php echo $msisdn; ?>&act=da&service_info=<?php echo $seviceId; ?>"><?php echo 'Deactivate'; ?></a>
                                                <?php
                                            } else {
                                                echo 'NA';
                                            }
...
//                        $Query1 = "call mts_starclub.JBOX_UNSUB('$_GET[msisdn]', 'CC')";
                    ...
                    error_log($Query1, 3, $logPath);
                    // echo $Query1;
                    $result = mysql_query($Query1, $userDbConn) or die(mysql_error());
