...
<div class="modal-body">
    <form id="form-edit" name="form-edit" method="post" enctype="multipart/form-data">
        <table class="table table-bordered table-condensed">
            ...
            -->
 <label class="radio">
       <input type="radio"  name="service_edit_base" value="active" data-toggle="radio" <?php echo ($rule_array['service_base'] == 'active') ? "checked" : ""; ?> />&nbsp; Active &nbsp;&nbsp;&nbsp;
                                                    </label><label class="radio">
       <input type="radio"  name="service_edit_base" value="pending" data-toggle="radio" <?php echo ($rule_array['service_base'] == 'pending') ? "checked" : ""; ?> />&nbsp; Pending &nbsp;&nbsp;&nbsp;
                                                    </label>
                                                    <label class="radio">
		<input type="radio"  name="service_edit_base" value="both" data-toggle="radio" <?php echo ($rule_array['service_base'] == 'both') ? "checked" : ""; ?> />&nbsp; Both
                                                    </label>
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <select name="filter_edit_base" data-width="auto" onchange="setEditScenarios(this.value)">
...
<!--                        <option value="0">Select Circle</option>-->
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <?php
                    $get_rule_query = "SELECT added_on FROM master_db.tbl_new_engagement_data where rule_id='" . $rule_id . "'";
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    ...
                    <?php
                    if (date('H:i:s') >= date('H:i:s', strtotime($action_array['time_slot']))) {
