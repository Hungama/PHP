...
//////////////////////////////////////////////// code start for No CRBT Download in 3 days from activation /////////////////////////////////////
    ...
    where  date(a.date_time) between DATE(NOW()-INTERVAL 3 DAY) and DATE(NOW()-INTERVAL 1 DAY) and  a.status=3 and b.status in(1,11)
...
//////////////////////////////////////////////// code start for No CRBT Download in 5 days from activation /////////////////////////////////////
    ...
    where  date(a.date_time) between DATE(NOW()-INTERVAL 5 DAY) and DATE(NOW()-INTERVAL 1 DAY) and  a.status=3 and b.status in(1,11)
...
//////////////////////////////////////////////// code start for No CRBT Download in 7 days from activation /////////////////////////////////////
    ...
    where  date(a.date_time) between DATE(NOW()-INTERVAL 7 DAY) and DATE(NOW()-INTERVAL 1 DAY) and  a.status=3 and b.status in(1,11)
...
//////////////////////////////////////////////// code start for No CRBT Download in 15 days from activation /////////////////////////////////////
    ...
    where  date(a.date_time) between DATE(NOW()-INTERVAL 15 DAY) and DATE(NOW()-INTERVAL 1 DAY) and  a.status=3 and b.status in(1,11)
