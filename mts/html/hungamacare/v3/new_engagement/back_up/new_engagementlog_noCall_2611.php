...
date(b.sub_date) = DATE(NOW()-INTERVAL 4 DAY) and b.status=1 ";
...
date(b.sub_date) = DATE(NOW()-INTERVAL 6 DAY) and b.status=1";
...
date(b.sub_date) = DATE(NOW()-INTERVAL 8 DAY) and b.status=1";
...
date(b.sub_date) = DATE(NOW()-INTERVAL 16 DAY) and b.status=1";
