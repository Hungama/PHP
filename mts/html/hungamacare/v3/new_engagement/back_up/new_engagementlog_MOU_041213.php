...
//////////////////////////////////////////////// code start for Less than 10 MOUS in last 10 days ////////////////////////////////////////////////////////
    echo $query = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
...
//////////////////////////////////////////////// code start for More than 10, But less than 30 MOUS  in last 10 days ////////////////////////////////////////////////////////
    echo $query_1030MOU = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a where a.dnis like '52222%' 
...
//////////////////////////////////////////////// code start for More than 30 MOUS in last 10 days /////////////////////////////////////
    echo $query_G30MOU = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a 
...
//////////////////////////////////////////////// code start for Usage less than 5 mins in last 1 day /////////////////////////////////////
    echo $query_L5 = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
...
//////////////////////////////////////////////// code start for Usage more than 20 mins in last 1 day /////////////////////////////////////
    echo $query_G20 = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
