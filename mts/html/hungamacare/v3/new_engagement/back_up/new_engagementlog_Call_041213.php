...
//////////////////////////////////////////////// code start for Called in last 1 day /////////////////////////////////////
    echo $query_1days = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
...
//////////////////////////////////////////////// code start for Called in last 3 days /////////////////////////////////////
    echo $query_3days = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
...
//////////////////////////////////////////////// code start for Called in last 5 days /////////////////////////////////////
    echo $query_5days = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
...
//////////////////////////////////////////////// code start for Called in last 7 days /////////////////////////////////////
    echo $query_7days = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
...
//////////////////////////////////////////////// code start for Called in last 15 days /////////////////////////////////////
    echo $query_15days = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
...
//////////////////////////////////////////////// code start for Called more than 2 times in last 1 day /////////////////////////////////////
    echo $query_G2times = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
            where a.dnis like '52222%' and a.operator in ('mtsm') and date(a.call_date) = DATE(NOW()-INTERVAL 1 DAY)
...
//////////////////////////////////////////////// code start for Called more than 4 times in last 1 day /////////////////////////////////////
    echo $query_G4times = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
            where a.dnis like '52222%' and a.operator in ('mtsm') and date(a.call_date) = DATE(NOW()-INTERVAL 1 DAY)
...
//////////////////////////////////////////////// code start for Called more than 6 times in last 1 day /////////////////////////////////////
    echo $query_G6times = "select distinct a.msisdn,b.circle from mts_radio.tbl_radio_subscription b ,mis_db.tbl_radio_calllog a
            where a.dnis like '52222%' and a.operator in ('mtsm') and date(a.call_date) = DATE(NOW()-INTERVAL 1 DAY)
