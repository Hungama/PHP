...
echo $query = "select distinct ANI,circle,message,added_on from master_db.tbl_new_engagement_log where type='36'
                and service_id=1101 and service_base='active' and rule_id= '130' and date(added_on) = '2014-01-08'";
$data = mysql_query($query, $dbConn);
//$log_path = "/var/www/html/hungamacare/v3/logs/" . $service_id . "/" . $type . "/" . $rule_id . "_" . $date . ".log";
$log_path = "/var/www/html/hungamacare/v3/logs/1101/36/130_" . $date . ".log";
unlink($log_path);
