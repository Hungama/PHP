...
$querySMSlog = "/var/www/html/hungamacare/v3/Script/querySMSlog_" . date(Ymd) . ".txt";
$querySMSlog1 = "/var/www/html/hungamacare/v3/Script/ALLSMSTargetd_" . date(Ymd) . ".txt";

$deleted_file = "/var/www/html/hungamacare/v3/Script/querySMSlog_" . date("Ymd", mktime(0, 0, 0, date("m"), date("d") - 2, date("Y"))) . ".txt";
unlink($deleted_file);
...
if ($msg != '') {
    ...
    $filepathdndcheck = '/var/www/html/hungamacare/v3/new_engagement/dndcheck/' . $rule_id . '_' . $curdate . '.txt';
    $filepathdndcheck_csv = '/var/www/html/hungamacare/v3/new_engagement/dndcheck/' . $rule_id . '_' . $curdate . '.csv';
    ...
    if ($dnd_scrubbing == 1) {
        sleep(10);
        unlink($filepathdndcheck_csv);
        require '/var/www/html/hungamacare/v3/new_engagement/dndCheck_ftp.php';
    }
    sleep(10);
    ...
    foreach ($lines as $line_num => $mobno) {
        ...
        if (!empty($mno)) {
            ...
            $procedureCall = "call master_db.SENDSMS_BULK_DND(" . $mno . ",\"$msg\",'" . $sms_cli . "','sms-promo','1')";
            ...
            if ($m == '1') {
                ...
                $procedureCall_Test = "CALL master_db.SENDSMS_BULK_DND('8587800665','" . $test_msg . "','" . $sms_cli . "','sms-promo','1')";
