                                            ...
                                            <tr id="tr_sms_time_slot">
                                                ...
                                                <td align="left" colspan="2">
                                                    <div class="input-append bootstrap-timepicker">
                                                        <input id="sms_time_slot" name ="sms_time_slot" class="input-small" type="text"/>
...
<!--                                                    <select name="email_sec">
        ...
        <script>
            ...
            function checkactionfield(type) {
                ...
                var sms_time_slot=document.forms[type]["sms_time_slot"].value; alert(sms_time_slot);
