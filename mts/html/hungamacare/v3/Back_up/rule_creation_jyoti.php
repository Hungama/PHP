                                        ...
                                        <input type="radio" id="service_base_both" name="service_base" value="both"/>&nbsp; Both-->
                                                                               <div class="col-md-3">
                                                                                    <label class="radio checked">
                                                                                        ...
                                                                                        <input type="radio" data-toggle="radio" value="active" name="service_base" checked >
                                                                                        Active
                                                                                    </label>
                                                                                    <label class="radio">
                                                                                        <span class="icons"><span class="first-icon fui-radio-unchecked"></span><span></span></span>
                                                                                        <input type="radio" data-toggle="radio" value="pending" name="service_base" >
                                                                                        Pending
                                                                                    </label>
                                                                                    <label class="radio">
                                                                                        <span class="icons"><span class="first-icon fui-radio-unchecked"></span><span></span></span>
                                                                                        <input type="radio" data-toggle="radio" value="both"  name="service_base" >
                                                                                        Both
                                                                                    </label>
                                                                                </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!--                                        <div class="col-md-3">
                                                                                    <label class="radio checked">
                                                                                        <span class="icons"><span class="first-icon fui-radio-unchecked"></span><span class="second-icon fui-radio-checked"></span></span>
                                                                                        <input type="radio" data-toggle="radio" value="1"  name="dnd_scrubbing" checked="checked">
                                                                                        Yes
                                                                                    </label>
                                                                                    <label class="radio">
                                                                                        <span class="icons"><span class="first-icon fui-radio-unchecked"></span><span class="second-icon fui-radio-checked"></span></span>
                                                                                        <input type="radio" data-toggle="radio" value="0"  name="dnd_scrubbing">
                                                                                        No
                                                                                    </label>
                                                                                </div>-->
                                    </td>
