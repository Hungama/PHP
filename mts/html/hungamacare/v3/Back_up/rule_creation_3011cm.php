...
<html lang="en">
    ...
    <body onload="javascript:viewUploadhistory('me');">
        <div class="container">
            ...
            <!--            <div class="row">
                            <div class="col-md-8">
                                <h6><a href="javascript:void(0)" onclick="reloadPage()">Add New Rule</a></h6>
                            </div>
                        </div>-->
        ...
        <script>
            ...
            function checkEditfield(type) { 
                ...
                var time_slot=document.forms[type]["sms_time_slot"].value;  
                var min=document.forms[type]["sms_min"].value;  
                var sec=document.forms[type]["sms_sec"].value; //alert(sms_sec);
                //                var email_time_slot=document.forms[type]["email_edit_time_slot"].value;  
                //                var email_min=document.forms[type]["email_edit_min"].value;  
                //                var email_sec=document.forms[type]["email_edit_sec"].value; 
            ...
            function handleClick(action){ 
                ...
                if (action == 'sms') { 
                    ...
                    //document.forms[type][time_slot].value='0';
            ...
            function checkactionfield(type) {
                ...
                var sms_time_slot=document.forms[type]["sms_time_slot"].value;//alert(time_slot);
                var sms_min=document.forms[type]["sms_min"].value;
                var sms_sec=document.forms[type]["sms_sec"].value;
                var email_time_slot=document.forms[type]["email_time_slot"].value;//alert(time_slot);
