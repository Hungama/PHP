                        ...
                        <TD>
                            ...
                            if ($processData['count'] == 0) {
                                ...
                                if ($action_data_array['action_name'] == 'sms') {
                                    ?>
                                    <a href="xls_new_engagement.php?service_id=<?php echo $service_id ?>&type=<?php echo $processData['type'] ?>&added_on=<?php echo $lastProcessDate ?>&rule_id=<?php echo $rule_id ?>&filepath=<?php echo $filepath ?>">
                                        <?php
                                    } else {
                                        //$curdate = date("d-m-Y");
