                ...
                <tr id="tr_edit_email_user">
                    ...
                    <td align="left" colspan="2">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" name="email_edit_user" value="<?php echo $action_array['email_user']; ?>" placeholder="Email" class="form-control" readonly="readonly"/>
                                </div>          
                            </div>
                        </div>
                    </td>
...
<!--            <tr id="tr_email_edit_time_slot" style="display:none">
                <td align="left" width="16%" height="32">Time Slot</td>                                     
                <td>
