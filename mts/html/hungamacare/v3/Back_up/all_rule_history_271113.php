...
if ($numofrows == 0) {
    ...
    <!--                        <center><div width="85%" align="left" class="txt">
            ...
            <!--            <div id="mydiv" style="position:absolute;right:150px;top:130px;width:83px;height:83px;">-->
            <!--                            <a href='http://119.82.69.212/kmis/services/hungamacare/pauseCodeReport.php' style="display block;width:83px;height:83px;"><b>View</b></a>-->
