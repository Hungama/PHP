        ...
        <div class="col-md-12">
            ...
            <TABLE class="table table-condensed table-bordered">
                ...
                while ($summarydata = mysql_fetch_array($query)) {
                    ...
                    $rule_id = $summarydata['id'];
                    $get_process_query = "select id,count,added_on from master_db.tbl_new_engagement_data nolock 
                        where service_id='$service_id' and type='$type' and rule_id='$rule_id'";
