                    ...
                    <td>
                        <select name="sms_edit_time_slot">
                            ...
                            <?php foreach ($sms_time_slot_array as $TS_id => $TS_val) {
                                ?>
                                <option value="<?php echo $TS_id; ?>" <?php echo ($timeDisplayArray[0] == $TS_id) ? 'selected="selected"' : ""; ?>><?php echo $TS_val; ?></option>
                            <?php } ?>
                        </select>
                        <select name="sms_edit_min">
                            ...
                            <?php foreach ($min_sec_array as $TS_id => $TS_val) {
                                ?>
                                <option value="<?php echo $TS_id; ?>" <?php echo ($timeDisplayArray[1] == $TS_id) ? 'selected="selected"' : ""; ?>><?php echo $TS_val; ?></option>
                            <?php } ?>
                        </select>
<!--                        <select name="sms_edit_sec">
                            ...
                            <?php foreach ($min_sec_array as $TS_id => $TS_val) {
                                ?>
                                <option value="<?php echo $TS_id; ?>" <?php echo ($timeDisplayArray[2] == $TS_id) ? 'selected="selected"' : ""; ?>><?php echo $TS_val; ?></option>
                            <?php } ?>
                        </select>-->
                    </td>
                </tr>
