...
$serviceArray1 = array('1101' => 'MTSMU','1102' => 'MTS54646');
$circle_info = array('KAR' => 'Karnataka', 'KER' => 'Kerala', 'KOL' => 'Kolkata', 'RAJ' => 'Rajasthan', 'TNU' => 'Tamil Nadu', 'WBL' => 'WestBengal', 'DEL' => 'Delhi', 'CHN' => 'Chennai');
asort($circle_info);
...
<html lang="en">
    <head>
        ...
        <title><?php echo "ADD CAMPAIGN"; ?></title>
        <?php
        echo CONST_CSS;
    ...
    <body onload="javascript:viewUploadhistory();">
        <div class="container">
            ...
            ?>
            <div class="row">
                <div class="col-md-12"><h4><?php echo "Ad Campaign"; ?></h4></div>
            </div>    
            <div class="row">
                <div class="col-md-12">
...
<!--                                            <tr>
                                                            ...
                                                            <form class="form-horizontal">
                                                                <fieldset>
                                                                    <div class="control-group">
                                                                        <label class="control-label" for="adstartendtime">Choose your ad start and end times:</label>
                                                                        <div class="controls">
                                                                            <div class="input-prepend input-group">
                                                                                <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                                                                <input type="text" style="width: 400px" name="adstartendtime" id="adstartendtime" class="form-control" value=""  class="span4"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </fieldset>
                                                            ...
                                                            <!--form class="form-horizontal"-->
                                                                <fieldset>
                                                                    <div class="control-group">
                                                                        <label class="control-label" for="adstartendtime">Choose your ad start and end times:</label>
                                                                        <div class="controls">
                                                                            <div class="input-prepend input-group"><!--08/01/2013 1:00 PM - 08/01/2013 1:30 PM-->
                                                                                <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                                                                <input type="text" style="width: 400px" name="adstartendtime" id="adstartendtime" class="form-control" value=""  class="span4"/>
																...
																<fieldset>
                                                                    <div class="control-group">
                                                                        <label class="control-label" for="adstartendtime2">Choose your ad start and end times:</label>
                                                                        <div class="controls">
                                                                            <div class="input-prepend input-group"><!--08/01/2013 1:00 PM - 08/01/2013 1:30 PM-->
                                                                                <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                                                                <input type="text" style="width: 400px" name="adstartendtime2" id="adstartendtime2" class="form-control" value=""  class="span4"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </fieldset>
																...
																<fieldset>
                                                                    <div class="control-group">
                                                                        <label class="control-label" for="adstartendtime3">Choose your ad start and end times:</label>
                                                                        <div class="controls">
                                                                            <div class="input-prepend input-group"><!--08/01/2013 1:00 PM - 08/01/2013 1:30 PM-->
                                                                                <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                                                                <input type="text" style="width: 400px" name="adstartendtime3" id="adstartendtime3" class="form-control" value=""  class="span4"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </fieldset>
																...
																<fieldset>
                                                                    <div class="control-group">
                                                                        <label class="control-label" for="adstartendtime4">Choose your ad start and end times:</label>
                                                                        <div class="controls">
                                                                            <div class="input-prepend input-group"><!--08/01/2013 1:00 PM - 08/01/2013 1:30 PM-->
                                                                                <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                                                                <input type="text" style="width: 400px" name="adstartendtime4" id="adstartendtime4" class="form-control" value=""  class="span4"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </fieldset>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2">
                                                    <?php
                                                    $selectQuery = "SELECT ad_name FROM MTS_IVR.tbl_ad_nameMap WHERE status=1";
                                                    $querySel = mysql_query($selectQuery, $dbConn);
                                                    ?>
        ...
        <script type="text/javascript">
			...
			/*
                $('#adstartendtime').daterangepicker({
                    timePicker: true,
				...
				$('#adstartendtime').daterangepicker({
				 ...
				 $('#adstartendtime2').daterangepicker({
                    timePicker: true,
                    timePickerIncrement: 30,
                    format: 'MM/DD/YYYY h:mm A'
                }, function(start, end, label) {
				 ...
				 $('#adstartendtime3').daterangepicker({
                    timePicker: true,
                    timePickerIncrement: 30,
                    format: 'MM/DD/YYYY h:mm A'
                }, function(start, end, label) {
				 ...
				 $('#adstartendtime4').daterangepicker({
                    timePicker: true,
                    timePickerIncrement: 30,
                    format: 'MM/DD/YYYY h:mm A'
                }, function(start, end, label) {
...
var adstartendtime = document.forms["tstest"]["adstartendtime"].value;
                ...
                else if(adstartendtime == '')
                {	
                    bootstrap_alert.warning('<?php echo 'Please select schedule time'; ?>');
                    return false;
