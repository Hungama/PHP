    ...
    while ($rows = mysql_fetch_array($checkrule)) {
        ...
        if ($noofRulerows == 0) {
            ...
            if ($msg != '') {
                ...
                echo $insertquery2 = "insert into master_db.tbl_new_engagement_data(count,added_on,service_id,status,type,rule_id) 
     values('0', now(), '$rule_array[service_id]', 10,'$rule_array[scenerios]','$rule_id')";
