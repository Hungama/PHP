...
$qry = "select rule_id,time_slot,action_name,sms_cli from master_db.tbl_rule_engagement_action where status=1 and time_slot='" . $nowtime . "'";
...
//close database connection
    ...
    while ($rows = mysql_fetch_array($checkrule)) {
        ...
        if ($rows['action_name'] == 'sms') {
            ...
            //include("/var/www/html/kmis/mis/uninor/insertDailyCalls.php");//mail
        }
