    ...
    <body onload="javascript:viewUploadhistory('me');">
       ...
       <input type="radio" id="service_base_pending" name="service_base" value="pending" data-toggle="radio" checked />&nbsp; Pending &nbsp;&nbsp;&nbsp;
		...
		<input type="radio" id="service_base_both" name="service_base" value="both" data-toggle="radio" checked />&nbsp; Both
											...
											<tr>
											  <td align="left" width="16%" height="32"><span>Add CC User</span></td>
                                                <td align="left" colspan="2">

<div class="col-md-3">
                <input name="tagsinput" id="tagsinput" class="tagsinput" value="" style="display: none;">
				<!--div id="tagsinput_tagsinput" class="tagsinput " style="height: 100%;"><span class="tag"><span>Clean&nbsp;&nbsp;</span>
...
<input type="text" name="accounts" size="20" class="typeahead-devs" placeholder="Please Enter Day Name">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle">
												<button class="btn btn-primary" id="submit-active" type="button" class="" >Submit</button>
        ...
        <script>
			...
			/********************Added for test radio button value***************************/
	$('#submit-active').on('click', function() {

		 var isok = checkfield('form-active');
		if(isok)
			{
			$.fn.SubmitForm('active');
			}
		else
	{
	return false;
